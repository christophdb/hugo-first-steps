    ...
    - name: content-1
      ...
      items:
          - headline: 'Удобный конструктор приложений без программирования'
            text: 'С помощью SeaTable Вы можете быстро и интуитивно создавать мощные приложения, основанные на данных, используя drag-and-drop - без каких-либо знаний программирования. Конструктор приложений "без кода" позволяет Вам самостоятельно создавать самые разнообразные решения, такие как CRM, управление проектами или специализированные бизнес-приложения, не написав ни строчки кода.'
