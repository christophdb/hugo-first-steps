...
* Единый вход (SSO) **повышает IT-безопасность** в вашей [ITSM]({{< relref "pages/industry-solutions/software-development" >}}) за счет централизованной аутентификации пользователей и упрощенного контроля доступа. 
