...
If you want to use SeaTable for stockpiling, just [register](https://seatable.io/en/registrierung/) for free. You can find the corresponding template [here](https://seatable.io/en/vorlage/xd246xzxtnuset-pxi0xsa/).
