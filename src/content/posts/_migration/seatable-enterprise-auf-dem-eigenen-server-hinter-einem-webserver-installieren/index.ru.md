...
Инструкции по стандартной установке объясняют структуру и функции файла docker-compose. Не стоит повторять это здесь. Используйте [эту ссылку](/ru/seatable-enterprise-edition-unter-ubuntu-20-04-lts-installieren/#Individualisierung_der_docker-composeyml?lang=auto) для перехода непосредственно к соответствующей части статьи о стандартной установке.
