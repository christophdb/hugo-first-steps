...
В настройках оповещения выберите _Отправить на _вариант _RSS-канал_. Это даст вам URL, с помощью которого вы сможете сохранять все новые записи в таблице SeaTable в будущем с помощью Integromat. Там вы сможете контролировать и структурировать сообщения очень удобно и четко.__
