...
Каждый сотрудник точно знает, у кого есть текущая задача и кто должен работать над ней следующим. Таким образом, вы избежите ожидания и путаницы. Как только автор написал свой черновик, он меняет статус статьи и передает ее следующему сотруднику для контроля качества. Если необходима координация между сотрудниками, это можно легко сделать с помощью [функции комментариев]({{< relref "help/base-editor/zeilen/die-kommentarfunktion-in-seatable" >}}) в SeaTable.
