...
Если вы хотите использовать цифровой журнал SeaTable, [просто зарегистрируйтесь]({{< relref "регистрация" >}}) и начните с бесплатного шаблона.

## Часто задаваемые вопросы

{{< faq >}}

Должен ли я документировать каждую поездку? |||
...
Что должно быть включено в бортовой журнал? |||
...
Что произойдет, если я потеряю свой журнал? |||
...
---
Что выгоднее - правило 1% или журнал учета? |||
...
В чем преимущества журнала учета? |||
