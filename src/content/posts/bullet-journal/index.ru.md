...
Если вы хотите использовать SeaTable для ведения своего дневника, просто [зарегистрируйтесь]({{< relref "pages/registration" >}}) бесплатно. Соответствующий шаблон с вдохновением и примерами записей вы найдете [здесь](https://seatable.io/ru/vorlage/petkiwi1stmm_1lh2xlejq/).
