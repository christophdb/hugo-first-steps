...
Попробуйте наш [бесплатный шаблон для планирования бюджета]({{< relref "templates/finance/budget-plan" >}}) и откройте для себя другие интересные сценарии использования, которые вы можете реализовать с помощью SeaTable.
