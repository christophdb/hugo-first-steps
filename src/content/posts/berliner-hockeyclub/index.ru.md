...
description: Будучи руководителем спортивного клуба, Вы должны контролировать и управлять множеством областей, будь то общая бухгалтерия, бронирование полей или управление задачами всех членов клуба. Берлинский хоккейный клуб использует SeaTable, чтобы перевести множество существующих на данный момент отдельных систем в единую систему и таким образом оцифровать свои процессы.
date: 2021-02-08
lastmod: '2023-07-11'
author: 'cdb'
...
tags:
    ...
    - 'Финансы'
seo:
    title: 'Берлинский хоккейный клуб переходит на цифровые технологии с помощью SeaTable'
    description: 'Хоккейный клуб Берлина использует SeaTable для цифровизации учёта, бронирования полей и управления участниками в одной системе.'
---
