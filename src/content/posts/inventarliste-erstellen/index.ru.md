---
title: 'Создание инвентаризационной ведомости – так вы сохраните контроль'
description: 'Вы проводите инвентаризацию каждый год или даже каждый месяц? Тогда вы пришли по адресу! В этой статье вы узнаете, как создать инвентаризационную ведомость, стандартизировать процесс и упростить инвентаризацию.'
date: 2024-02-23
lastmod: '2025-01-10'
author: 'kgr'
...
Импортируйте инвентаризационную ведомость в Excel или создайте собственный шаблон в Word. Узнайте, какие преимущества бесплатная база данных SeaTable имеет по сравнению с Excel и Word.
...
## В чем разница между инвентаризацией и инвентарной описью?

**Инвентарная опись** - это полный перечень имущества компании, то есть всех активов, которыми она владеет. **Инвентаризация** - это процесс, в ходе которого вы учитываете свои активы.

## Что считается запасами компании?

Активы (основные и оборотные средства) и обязательства вашей компании относятся к инвентарной описи и, соответственно, к инвентаризационной ведомости. Лучше всего перечислить как **нематериальные, так и материальные активы**. Долги перечисляются далее в инвентаризационной описи.
...
Во-первых, инвентаризация различается в зависимости от того, какие активы вы учитываете - материальные или нематериальные. При наличии физических запасов вы должны раз в год проводить **натурную инвентаризацию**, в ходе которой вы, например, пересчитываете, измеряете или взвешиваете все товары на вашем складе. При **документальной инвентаризации**, с другой стороны, вы учитываете нематериальные активы, которые можно отследить по бухгалтерским документам, таким как банковские выписки и счета-фактуры.

Кроме того, важно, **когда** вы составляете инвентарную опись:
...
- Именно поэтому существует также **перенесенная инвентаризация**. При такой форме инвентаризации вы можете проводить инвентаризацию гибко, в день, который вы выберете, то есть максимум за три месяца до или два месяца после отчетной даты. Однако, поскольку затем вам придется обновлять или пересчитывать запасы, используя поступления и выдачи из инвентаризационной ведомости, перенесенная инвентаризация является менее точной, чем инвентаризация на ключевую дату.
- В отличие от этого **непрерывная инвентаризация** является постоянным процессом, преимущество которого заключается в том, что усилия распределяются равномерно в течение года, и на дату составления баланса достаточно документальной инвентаризации. Тем не менее, раз в год необходимо проводить инвентаризацию всех активов, чтобы сравнить фактические запасы с книжными. Затем вы должны точно зафиксировать все поступления и выбытия в инвентаризационной ведомости, чтобы обновить данные о запасах для целей бухгалтерского учета.
...
Примером инвентаризационной ведомости может служить [база данных]({{< relref "posts/relationale-datenbank" >}}) с двумя связанными таблицами и различными столбцами. Полистайте и прокрутите эту образцовую инвентаризационную ведомость:
...
Независимо от выбранного варианта, вы также определяете в Word, какие заголовки столбцов нужны для инвентаризационной ведомости (например, идентификационный номер, предмет, тип, местоположение, количество и стоимость). Затем вы вводите данные об имуществе вручную. Это может выглядеть следующим образом:
...
Подумайте, **какая информация** вам нужна о вашем имуществе, **кто** участвует в инвентаризации и **скольким людям** нужен доступ к данным. **Как** вы хотите подготовить данные и **какие функции** для этого необходимы?
