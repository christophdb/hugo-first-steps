...
Кристиан Ливадару настолько доволен своим выбором, что теперь активно привлекает новых пользователей SeaTable. Он также видит потенциал в своей компании и планирует создать собственную CRM на основе одного из шаблонов SeaTable. В то время как он активно использует скрипты, SQL-запросы, API и [стороннюю интеграцию]({{< relref "pages/integrations" >}}) с n8n, среди прочего, он еще не пробовал возможности App Builder для своей компании.
