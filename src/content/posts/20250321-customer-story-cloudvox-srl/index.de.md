...
Cristian Livadaru ist mit seiner Wahl so zufrieden, dass er inzwischen aktiv neue SeaTable-Nutzer wirbt. Und auch in seinem Unternehmen sieht er noch Potential und plant aufbauend auf einem der SeaTable-Templates ein eigenes CRM zu bauen. Während er intensiv Skripte, SQL-Abfragen, die API und [Drittanbieter-Integration]({{< relref "pages/integrations" >}}) u. a. mit n8n nutzt, hat er die Möglichkeiten des App Builders bisher für sein Unternehmen noch nicht getestet.
