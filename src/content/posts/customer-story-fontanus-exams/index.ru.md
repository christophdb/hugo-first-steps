...
[Логотип Johannes Fontanus College как референс‑клиента SeaTable по цифровому управлению экзаменами]{{< customer-logo image="logo-jfc.jpg" firma="Johannes Fontanus College" branche="Учебное заведение" ort="Нидерланд" >}}
...
[Колледж Johannes Fontanus использует SeaTable для цифрового управления экзаменами и оптимизации процессов]{{< testimonial image="" alt="" name="Ko Smidt">}}
