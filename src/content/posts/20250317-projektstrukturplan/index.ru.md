...
Однако самым большим преимуществом SeaTable является широкий спектр возможностей визуализации. Будь то **календари**, **временные рамки**, **доски Канбан** или **организационные диаграммы** - здесь есть все, что душа пожелает, и даже больше: На отдельной **белой доске** вы можете свободно набросать структуру разбивки работ и создать карты ума, подобные тем, что есть в Miro. Или вы можете использовать новый плагин **Дерево**, чтобы показывать и скрывать различные уровни вашей структуры разбивки работ по своему усмотрению.

Шаблон структуры разбивки работ можно найти [здесь] ({{< relref "templates/projects/work-breakdown-structure" >}}). Прежде чем использовать его, вам необходимо бесплатно зарегистрироваться, указав свой адрес электронной почты.
...
Вам все еще нужен план проекта, который показывает хронологическую последовательность этапов или задач проекта? Тогда узнайте здесь [как создать классический план проекта]({{< relref "templates/projects/project-plan" >}}).
