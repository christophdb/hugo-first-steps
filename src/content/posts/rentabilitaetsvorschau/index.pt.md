...
## Porque é que a previsão de rentabilidade é tão importante?
...
### Exemplo de uma previsão de rentabilidade
...
Para acompanhar em permanência o volume de negócios e os custos da sua empresa e poder estimar os lucros ou as perdas, deve elaborar um plano financeiro. Para o efeito, utilize um software de base de dados potente, como o [SeaTable]({{< relref "/" >}}).
