...
Независимость от местоположения и устройств|||
...
Малоизвестный, но очень недорогой облачный сервис - [бескодовая база данных SeaTable](https://seatable.com/ru/), в которой вы можете хранить свои данные **в соответствии с требованиямиDSGVO** и при высочайших мерах безопасности **в немецких дата-центрах**. Выбирайте между

- [SeaTable Cloud](ru/cloud/) в качестве публичного облака
- [SeaTable Server](ru/on-premises/) для вашего частного облака
- [SeaTable Dedicated](ru/dedicated/) в качестве гибридного облака
