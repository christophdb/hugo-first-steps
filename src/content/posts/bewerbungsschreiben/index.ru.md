...
Если вы хотите использовать SeaTable для планирования приложений, просто [зарегистрируйтесь]({{< relref "pages/registration" >}}) бесплатно. Шаблон можно найти [здесь](https://seatable.io/ru/vorlage/cc0-xv_fq_yn3ipvbvfiaa/).
...
![Выберите подходящий шрифт, межстрочный интервал и размер шрифта.](https://seatable.io/wp-content/uploads/2024/04/markus-spiske-cZ-s645ZBHo-unsplash-e1713177473952.jpg)
...
Если вы хотите использовать SeaTable для обзора ваших приложений, просто [зарегистрируйтесь]({{< relref "pages/registration" >}}) бесплатно. Шаблон можно найти [здесь](https://seatable.io/ru/vorlage/cc0-xv_fq_yn3ipvbvfiaa/).
