...
{{< warning headline="Совет" text="Вы также можете использовать инструмент планирования для отслеживания ваших заявок. [Здесь]({{< relref "templates/everyday-life/application-cover-letter" >}}) вы узнаете, как с помощью этого инструмента можно одним нажатием кнопки генерировать различные письма-заявки на основе шаблона." />}}
