...
Если вы хотите использовать SeaTable для контент-анализа, просто [зарегистрируйтесь]({{< relref "pages/registration" >}}) бесплатно. Шаблон можно найти [здесь](https://seatable.io/ru/vorlage/jaw90r-mtsgxsep3vkfd4q/).
