...
SeaTable предлагает вам [шаблон]({{< relref "templates/everyday-life/bibliography" >}}), в котором вы можете найти примеры литературы и проследить процесс от ввода источников до вывода библиографии. Вы можете адаптировать шаблон под свои требования, вставить собственные источники и структуру, а также визуализировать их с помощью множества полезных инструментов.
