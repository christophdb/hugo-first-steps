...
Поэтому проверьте, правильно ли составлены ссылки, и при необходимости дополните их. Если вы хотите отложить эту задачу на потом, полезно внести ее в [список дел]({{< relref "templates/projects/to-do-liste" >}}), чтобы не забыть о ней.
