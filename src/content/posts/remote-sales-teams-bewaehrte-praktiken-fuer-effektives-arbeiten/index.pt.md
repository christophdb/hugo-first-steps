...
A [SeaTable](https://seatable.io/pt/) é outra das melhores aplicações de gestão de informação colaborativa da sua classe. A aplicação sem código tem soluções para [marketing]({{< relref "pages/industry-solutions/marketing" >}}), [vendas](https://seatable.io/pt/vertrieb/) e [gestão de projectos]({{< relref "pages/industry-solutions/project-management" >}}) que ajudam as equipas de vendas remotas a captar, estruturar e avaliar diferentes tipos de informação.
