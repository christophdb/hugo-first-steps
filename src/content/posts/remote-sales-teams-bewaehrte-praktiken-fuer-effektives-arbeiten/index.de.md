...
[SeaTable](https://seatable.io/) ist eine weitere erstklassige kollaborative Anwendung für das Informationsmanagement. Die No-Code-Anwendung verfügt über Lösungen für [Marketing]({{< relref "pages/industry-solutions/marketing" >}}), [Vertrieb](https://seatable.io/en/vertrieb/) und [Projektmanagement](https://seatable.io/en/projektmanagement/), die Remote Sales Teams bei der Erfassung, Strukturierung und Auswertung verschiedener Arten von Informationen unterstützen.
