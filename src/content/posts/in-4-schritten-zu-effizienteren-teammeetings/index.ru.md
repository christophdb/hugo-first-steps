...
6. На встрече не ставятся [задачи]({{< relref "posts/aufgabenverwaltung" >}}) и не принимаются решения.
...
[Нажмите здесь, чтобы перейти к шаблону для командных совещаний]({{< relref "templates/projects/team-meetings" >}})
...
![Управление командными совещаниями с помощью SeaTable](Overview-Teammeeting.png)
...
![Собственные взгляды позволяют добиться большего порядка](Ansichten.png)
...
![В календаре вы можете увидеть все встречи](Calendar.png)
...
![Представления календаря](Calendar-1.png)
...
[Протестируйте наш шаблон]({{< relref "templates/projects/team-meetings" >}}) сегодня и [зарегистрируйтесь]({{< relref "pages/registration" >}}) совершенно бесплатно.
