...
color: '#93aae5'
seo:
    title: 'План контента в соцсетях: просто организуйте и планируйте'
    description: 'Узнайте, как создать план для соцсетей, чтобы эффективно управлять, планировать и анализировать контент в одном инструменте'
---
...
6. Какие каналы социальных сетей вы используете?

![Возможные платформы для вашего контент-плана социальных сетей](Social-Media-Plan_card.jpg)

Тогда самое время выбрать инструмент, который лучше всего подойдет для вашего проекта. Ниже вы можете подробнее ознакомиться с возможными [инструментами и шаблонами для вашего плана социальных медиа]({{< relref "templates/marketing/social-media-plan" >}}).
