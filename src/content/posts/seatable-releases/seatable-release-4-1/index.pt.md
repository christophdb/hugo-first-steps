...
Já utiliza processos automatizados nas suas bases para poupar tempo e cliques? Então vai gostar do facto de termos aperfeiçoado as opções e melhorado o desempenho das [automatizações]({{< relref "help/base-editor/automationen/uebersicht-ueber-automationen" >}}). Os utilizadores intensivos do SeaTable ficarão particularmente satisfeitos com o aumento do limite de execução. A [gestão de ficheiros]({{< relref "help/base-editor/dateien/das-dateimanagement-einer-base" >}}) introduzida na versão 4.0 oferece-lhe agora mais duas funcionalidades que simplificam o trabalho com ficheiros.
...
Até agora, era necessário voltar à página [inicial]({{< relref "help/erste-schritte/einfuehrung-grundlagen/die-startseite-von-seatable" >}}) sempre que se pretendia terminar a sessão ou alterar as definições pessoais. Isto torna-se muito mais prático com a seguinte melhoria da interface do utilizador: agora podes aceder às tuas [definições pessoais]({{< relref "help/startseite/persoenliche-einstellungen" >}}) em todas as Bases e mesmo em todas as Aplicações Universais através da **imagem do** teu **avatar** no canto superior direito. Se é administrador de uma equipa, pode ficar duplamente feliz: porque [a administração da equipa]({{< relref "help/teamverwaltung/abonnement/die-funktionen-der-teamverwaltung-in-der-uebersicht" >}}) está agora também a apenas dois cliques de distância em todo o SeaTable.

Na página inicial, anteriormente só era possível criar [pastas]({{< relref "help/startseite/bases/einen-ordner-anlegen" >}}) em grupos e na área "As minhas bases". No entanto, na área**"Partilhadas comigo**", não tinha a possibilidade de agrupar as bases partilhadas consigo em pastas por tópicos. Para maior clareza, adicionámos agora esta opção.

Muitas vezes, não é óbvio para os outros utilizadores o que pensou ao estruturar uma base ou tabela. Também pode querer registar **notas** sobre uma coluna, tabela ou base. Até agora, era possível fazê-lo na [descrição de uma coluna]({{< relref "help/base-editor/spalten/hinzufuegen-einer-spaltenbeschreibung" >}}) ou na [descrição]({{< relref "help/base-editor/weitere-optionen/wie-man-einer-base-eine-beschreibung-hinzufuegt" >}}) de uma base. Faltava ainda a possibilidade de explicar os conteúdos, estruturas e processos de uma tabela através de um texto conciso. No futuro, será possível fornecer a cada tabela uma [descrição da tabela]({{< relref "help/base-editor/tabellen/eine-tabellenbeschreibung-hinzufuegen" >}}).
