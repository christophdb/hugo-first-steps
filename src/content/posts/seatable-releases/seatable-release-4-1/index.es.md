...
description: 'Con SeaTable 4.1 automatiza aún más procesos (también por enlaces), gestiona archivos con papelera y buscador, define permisos detallados en apps y crea vistas predeterminadas. Muchas mejoras de interfaz y optimizaciones para equipos de cualquier tamaño: más claro, eficiente y adaptable.'
date: 2023-08-23
lastmod: '2023-08-23'
author: 'kgr'
...
categories:
    - 'product-features'
seo:
    title: 'SeaTable 4.1: Automatizaciones y apps renovadas'
    description: 'Nuevas funciones: automatización ampliada, papelera, búsqueda de archivos, permisos mejorados y flujo más intuitivo en SeaTable 4.1.'
---
...
Para todos aquellos a los que les gusta iniciar procesos con un clic del ratón, hay motivos para alegrarse: La nueva acción de [botón]({{< relref "help/base-editor/spaltentypen/die-schaltflaeche" >}}) "Enviar notificación" está disponible desde SeaTable 4.1. Esta acción complementa a la anteriormente disponible "Enviar correo electrónico". Dado que SeaTable ofrece ahora **nueve** acciones de botón, también hemos hecho más clara la ventana de selección:

![Nueva acción de botón "Enviar notificación](New-button-action-send-notification.png)

Por último, pero no por ello menos importante, hemos corregido de nuevo algunos **errores** en SeaTable 4.1 - entre otros, que los valores con el siguiente signo % en columnas de texto y de selección única no se interpretaban como porcentajes sino como números. Esto podía dar lugar a resultados no deseados en algunas [fórmulas]({{< relref "help/base-editor/spaltentypen/die-formel-spalte" >}}). Por favor, compruebe si esta corrección afecta a sus fórmulas.
