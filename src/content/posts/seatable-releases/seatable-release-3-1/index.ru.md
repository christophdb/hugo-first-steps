...
description: 'Новый плагин Page Design распечатывает шаблоны с динамическими полями, хранит версии, вставляет заголовки. Big Data Backend убирает лимит строк, хранит данные слоями для командной работы и архива. Папки для views, оптимизация для бизнеса и крупных проектов – теперь всё под контролем.'
date: 2022-08-26
lastmod: '2022-08-26'
author: 'rdb'
...
categories:
    - 'product-features'
seo:
    title: 'SeaTable 3.1: Page Design и Big Data Backend'
    description: 'Печать листов, динамические поля, хранение миллионов строк – 3.1 переводит SeaTable на корпоративный масштаб.'
---
...
![Функция печати списков в плагине SeaTable's Page Design](SeaTable-3.1-List-Print.gif)
...
![Заголовок страницы в плагине SeaTable's Page Design](SeaTable-3.1-Page-Header.png)
...
![Бэкенд больших данных в действии](SeaTable-3.1-Base-Stats-with-Big-Data.png)
...
![Представление больших данных в SeaTable 3.1](SeaTable-3.1-Filter-with-Big-Data.png)
...
![Папка просмотра, недавно появившаяся в SeaTable 3.1](SeaTable-3.1-View-folders.png)
