...
description: 'Анимации и быстрый поиск делают работу веселее. Валюты на выбор, импорт Excel с распознаванием типов, пакетная замена значений и удобный Markdown-редактор ускоряют рутину. Мелкие исправления и умные новшества делают версию 1.7 надёжной базой для команд.'
date: 2021-02-07
lastmod: '2021-02-07'
author: 'rdb'
...
categories:
    - 'product-features'
seo:
    title: 'SeaTable 1.7: интерфейс, Excel, валюта'
    description: 'Анимации в UI, любые валюты, быстрый ввод дат, умный Excel-импорт, массовая замена — SeaTable 1.7 для гибкой работы с данными.'
---
