...
![Dialog „Base von Template erstellen“ mit Auswahl eines SeaTable-Templates](create-from-template.png)
...
![Assistent zur bedingten Zeilenformatierung mit Regeln und Farbauswahl](row-color-non-modal.png)
...
![Tabellenansicht mit farbig markierten Zeilen basierend auf bedingter Formatierung](row-color.png)
...
![Druckeinstellungen einer Ansicht mit Optionen für Layout, Skalierung und Seitenränder](print-settings.png)
...
![Kompakte Zeilendetailansicht mit Druckvorschau für einzelne Datensätze](compact-row-detail.png)
...
![Spalteneinstellungen für den Spaltentyp „Automatische Nummer“ mit Formatoptionen](auto-number.png)
