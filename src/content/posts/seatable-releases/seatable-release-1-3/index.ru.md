...
![Диалог «Создать базу из шаблона» с выбором шаблона SeaTable ](create-from-template.png)
...
![Мастер условного форматирования строк с правилами и выбором цвета](row-color-non-modal.png)
...
![Представление таблицы с цветными строками по правилам условного форматирования](row-color.png)
...
![Настройки печати представления с параметрами макета, масштаба и полей](print-settings.png)
...
![Компактный вид деталей строки с предварительным просмотром печати отдельной записи](compact-row-detail.png)
...
![Настройки столбца типа «Автоматический номер» с вариантами формата серийных номеров](auto-number.png)
