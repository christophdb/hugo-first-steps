...
![Janela «Criar base a partir de template» com seleção de um template SeaTable](create-from-template.png)
...
![Assistente de formatação condicional de linhas com regras e seleção de cores](row-color-non-modal.png)
...
![Vista de tabela com linhas coloridas com base em formatação condicional](row-color.png)
...
![Definições de impressão de uma vista com opções de layout, escala e margens](print-settings.png)
...
![Vista compacta de detalhes da linha com pré-visualização de impressão para registos individuais](compact-row-detail.png)
...
![Definições de coluna para tipo «Número automático» com opções de formato de série](auto-number.png)
