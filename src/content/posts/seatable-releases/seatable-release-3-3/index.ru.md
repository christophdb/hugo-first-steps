...
description: 'Гибкий редактор форм с перетаскиванием, обязательные поля одним кликом, статические блоки и аннотации. Отправьте HTML-письмо сразу из SeaTable. Импортируйте/экспортируйте сотни тысяч строк для Big Data, используйте проверки чисел и поиск дублей – релиз с мощными удобствами для крупных данных.'
date: 2022-12-13
lastmod: '2022-12-15'
author: 'rdb'
...
categories:
    - 'product-features'
seo:
    title: 'SeaTable 3.3: формы-блоки и HTML-почта'
    description: 'Новый редактор форм-блоков, HTML-рассылки, массовый импорт Big Data и проверка числовых полей – всё это в 3.3!'
---
