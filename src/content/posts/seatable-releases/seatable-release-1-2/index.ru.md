...
![Главная страница SeaTable с цветными и редактируемыми значками баз](baseColorAndIcon-711x501.jpg)
...
![Обзор снимков базы со списком сохранённых версий и возможностью восстановления](Snapshots.png)
...
![Меню представлений с опцией «Дублировать представление» для копирования настроек вида](duplicate_view.png)
...
![Диалог общего доступа к представлению с настройками доступа к отфильтрованным данным](share_view.png)
...
![Контекстное меню с включённой функцией «Заблокировать строку» и красным треугольником в номере строки](lock_row.png)
...
![Диалог разрешений столбца с выбором, кто может менять ячейки и настройки столбца](column_permission.png)
