...
![Página de inicio de SeaTable con iconos de bases coloreados y editables](baseColorAndIcon-711x501.jpg)
...
![Vista de snapshots de una base con lista de versiones guardadas y opción de restaurar](Snapshots.png)
...
![Menú de vistas con opción «Duplicar vista» para copiar vistas de tabla existentes](duplicate_view.png)
...
![Diálogo de compartir vista con opciones para acceso compartido a datos filtrados](share_view.png)
...
![Menú contextual con función «Bloquear fila» activada y triángulo rojo en el número de fila](lock_row.png)
...
![Diálogo de permisos de columna con selección de quién puede editar celdas y configuración](column_permission.png)
