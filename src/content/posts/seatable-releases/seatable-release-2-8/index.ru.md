...
description: 'Цвет шапки теперь выбирается свободно, активные пользователи отображаются онлайн, описания помогают заполнить столбцы. Новый редактор (таблицы, изображения, навигация), автоматическая синхронизация наборов данных. Поддержка медианы, гибкие символы валюты, нюансы для командной работы и аналитики.'
date: 2022-04-04
lastmod: '2022-06-27'
author: 'rdb'
...
categories:
    - 'product-features'
seo:
    title: 'SeaTable 2.8: больше цвета, комфорта, автоматизации'
    description: 'Цветная шапка, живые редакторы, описания столбцов, улучшенный редактор и автовыравнивание – в SeaTable 2.8!'
---
