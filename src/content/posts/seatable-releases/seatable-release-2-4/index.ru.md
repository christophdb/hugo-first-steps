...
description: 'Закрепляемый список views, вывод нужной информации в связях, автоподсветка дубликатов и расчет долей в строках, создание PDF одной кнопкой, предпросмотр TIFF. Новые опции сравнения и вывода, десятки доработок делают работу с таблицами удобнее для любой команды.'
date: 2021-10-19
lastmod: '2023-07-11'
author: 'rdb'
...
categories:
    - 'product-features'
seo:
    title: 'SeaTable 2.4: меню views, гибкие связи'
    description: 'Панель навигации по views, выбор столбца для Линка, подсветка дублей, расчет процентов, PDF-кнопка: SeaTable 2.4 — еще быстрее!'
---
