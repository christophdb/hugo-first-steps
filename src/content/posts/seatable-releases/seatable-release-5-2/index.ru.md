...
seo:
    ...
    description: 'В SeaTable 5.2: групповые фильтры (AND/OR), кросс-форматирование, новый Whiteboard, улучшенный App Builder, обновления API и оптимизация работы с данными.'
---
