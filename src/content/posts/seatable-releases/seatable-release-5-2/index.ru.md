...
![Группы фильтров в SeaTable 5.2](Fitlergroups.png)
...
![Улучшено условное форматирование в SeaTable 5.2](ConditionalFormatting.png)
...
![Новая настройка столбцов, доступных только для чтения, на странице одной записи](ROcolumns-SingleRecordPage.png)
...
Помимо контроля авторизации, новая версия содержит два улучшения, повышающих удобство работы: поля типа [URL]({{< relref "help/base-editor/text-spalten/die-url-spalte" >}}) и [e-mail]({{< relref "help/base-editor/text-spalten/die-e-mail-spalte-und-ihre-verwendung" >}}) теперь кликабельны. Благодаря этому вызов веб-сайта или написание электронного письма стало еще быстрее. (Файлы в колонках файлов стали кликабельными в версии 5.3.) Вы можете установить режим заливки для элементов изображения на странице. Доступны три режима: Настроить, Залить и Растянуть.
...
![Новый тип диаграммы "Основная таблица"](BasicTable.png)
...
![Внутренняя перелинковка в SeaTable 5.1 и 5.2](InternalLinking-SeaTable-5.2-vs.-SeaTable-5.1.png)
...
В SeaTable 5.2 у [флажков]({{< relref "help/base-editor/auswahl-spalten/anlegen-einer-checkbox-spalte" >}}) появилось больше вариантов стиля и еще больше вариантов цвета. Если вам не нравится зеленая галочка, теперь вы можете выбрать один из 69 других вариантов.

В [плагине календаря]({{< relref "help/base-editor/plugins/anleitung-zum-kalender-plugin" >}}) новые записи теперь можно создавать двойным щелчком мыши или с помощью новой кнопки "+".
