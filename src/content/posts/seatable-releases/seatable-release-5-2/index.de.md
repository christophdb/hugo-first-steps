...
“Neues” Whiteboard-Plugin – gibt’s das Whiteboard-Plugin nicht schon seit [SeaTable 5.0](/seatable-release-5-0)? Das ist richtig, aber auch die Aussage “neues Whiteboard-Plugin” ist richtig. Das neue Plugin **Whiteboard (tldraw)** steht dem bisherigen Plugin in Sachen Gestaltungsmöglichkeiten in nichts nach, bietet darüber hinaus aber auch eine optimale **Unterstützung der Online-Kollaboration**. Sie können alleine, zu zweit oder im Team am Whiteboard arbeiten – alle Änderungen werden in Echtzeit aktualisiert und sind bei allen anderen Benutzern unmittelbar sichtbar.
