...
Eine Zeile sperren – mit einer Automatisierungsregel oder manuell über das Zeilen-Kontextmenü war dies bereits seit Längerem für Enterprise-Nutzer möglich. Nun erhält auch die [Schaltflächen-Spalte]({{< relref "help/base-editor/schaltflaechen/die-schaltflaeche" >}}) „Zeile sperren“ als neue Aktion. Nutzen Sie diese in Kombination mit den anderen sieben Aktionen, um komplexe Abläufe einfach per Mausklick zu erledigen. Darüber hinaus haben wir die Aktion „Zeile bearbeiten“ um dynamische Datumswerte ergänzt und die Anzeige von Auswahloptionen dort verbessert.
