...
Bloquear uma linha - com uma regra de automatização ou manualmente através do menu de contexto da linha, o que já é possível para os utilizadores empresariais há algum tempo. Agora, a [coluna de botões]({{< relref "help/base-editor/schaltflaechen/die-schaltflaeche" >}}) também tem "Bloquear linha" como uma nova ação. Utilize-a em combinação com as outras sete acções para concluir processos complexos com um simples clique do rato. Além disso, adicionámos valores de data dinâmicos à ação "Editar linha" e melhorámos a apresentação das opções de seleção.
