...
Если рассматривать отдельные типы страниц, то больше всего улучшений приходится на [индивидуальную страницу]({{< relref "help/app-builder/seitentypen-in-universellen-apps/individuelle-seiten-in-universellen-apps" >}}) и [страницу для отдельных записей данных](https://seatable.io/ru/docs/seitentypen-in-universellen-apps/seiten-vom-typ-einzelner-datensatz-in-universellen-apps/). Однако другие типы страниц также могут рассчитывать на постепенные улучшения.
