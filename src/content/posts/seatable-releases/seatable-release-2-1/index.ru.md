...
description: 'Гибкие права на уровне таблиц, новые типы обработки между строками/таблицами (сумма, разница, копирование), более удобные чекбоксы, ограничение на создание select-опций. Улучшен импорт Excel, выход из групп, новый фильтр по дате и масштабируемый вывод на печать.'
date: 2021-07-06
lastmod: '2023-07-11'
author: 'rdb'
...
categories:
    - 'product-features'
seo:
    title: 'SeaTable 2.1: права, обработка, UX'
    description: 'Контроль по таблицам, обработка между строками, ограничение для select-опций, быстрые чекбоксы — SeaTable 2.1 точечно усиливает работу с данными.'
---
