...
Ранее с помощью моментальных снимков нельзя было восстановить строки, перемещенные в хранилище больших [данных]({{< relref "help/base-editor/big-data/zeilen-ins-big-data-backend-verschieben" >}}). Чтобы предотвратить нежелательную потерю данных, теперь при [восстановлении моментальных снимков](https://seatable.io/ru/docs/historie-und-versionen/wiederherstellung-eines-snapshots/) можно также восстановить хранилище больших данных предыдущей версии.
