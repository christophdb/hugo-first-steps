...
description: 'Создавайте снапшоты, проверяйте дубли, дублируйте страницы и приостанавливайте приложения. Новые параметры дизайна и линковки, функция iserror(), периодика автоматизаций, приватные виды становятся публичными, сортировка по рангу — всё для контроля над данными и эффективной работы.'
date: 2023-11-22
lastmod: '2023-11-22'
author: 'kgr'
...
categories:
    - 'product-features'
seo:
    title: 'SeaTable 4.2: версии, дубль-чек, процессы'
    description: 'Управление версиями универс. приложений, стоп-дубликаты, клон-страницы, пауза приложений — SeaTable 4.2 раскрывает новые формулы и автоматизацию.'
---
