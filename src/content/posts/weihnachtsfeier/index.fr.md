...
Essayez simplement le [modèle](https://seatable.io/fr/modele/fewxqfzbsxocskxl7hikqq/) de SeaTable en vous inscrivant gratuitement [ici](https://seatable.io/fr/enregistrement/). Vous pouvez bien sûr remplir les tableaux avec vos propres données et les adapter à vos besoins à volonté.
