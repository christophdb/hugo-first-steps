...
Просто попробуйте [шаблон](https://seatable.io/ru/vorlage/fewxqfzbsxocskxl7hikqq/) SeaTable, бесплатно зарегистрировавшись [здесь]({{< relref "pages/registration" >}}). Конечно, вы можете заполнить таблицы собственными данными и настроить их под свои нужды.
