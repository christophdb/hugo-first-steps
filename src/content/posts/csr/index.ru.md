...
![КСО: Экологически чистый парк перед высотными зданиями](images/solar-4478105_1280-711x474.jpg)
...
![Три руки лежат вокруг вылепленного из бумаги глобуса](images/earth-day-environment-eco-concept-space-text-711x474.jpg)
...
![График пирамиды КСО от Арчи Б. Кэрролла](images/CSR-Pyramide.png)
...
![Люди встают в круг и вытягивают руки к центру](images/diverse-people-doing-fist-bump-park-711x474.jpg)
...
![КСО: Два дерева и ветряк на трех кубах.](images/windmill-5591464_1280-711x498.jpg)
...
Бесплатный [шаблон](https://seatable.io/ru/vorlage/dzs1hkplqmurvmuwzhv0fa/) от SeaTable идеально подходит для постановки конкретных целей и отслеживания прогресса. Вы можете ввести свои цели в шаблон, разделить их на категории и распределить по отделам. В дополнение к предстоящим мероприятиям вы также можете назначить приоритеты и указать дату достижения цели.
...
Чтобы использовать SeaTable, достаточно бесплатно [зарегистрироваться](https://seatable.io/ru/registrierung/). Затем вы можете добавить [шаблон](https://seatable.io/ru/vorlage/dzs1hkplqmurvmuwzhv0fa/) в свою базу и добавить свои собственные данные.
