...
Чтобы использовать SeaTable, достаточно бесплатно [зарегистрироваться]({{< relref "pages/registration" >}}). Затем вы можете добавить [шаблон](https://seatable.io/ru/vorlage/dzs1hkplqmurvmuwzhv0fa/) в свою базу и добавить свои собственные данные.
