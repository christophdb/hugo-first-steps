---
title: '6 processus marketing à automatiser – SeaTable'
description: 'Automatisez les tâches répétitives : découvrez 6 processus marketing essentiels à automatiser. Du suivi clients à la diffusion de contenus, ces workflows pratiques associant SeaTable et une plateforme d’automatisation vous font gagner en efficacité et en clarté.'
date: 2021-09-24
categories:
    - 'best-practice'
tags: 
...
En marketing aussi, il est utile de connaître sa [concurrence]({{< relref "posts/wettbewerbsanalyse" >}}) et de se tenir régulièrement informé des nouvelles et des mises à jour avec lesquelles elle apparaît dans les médias. Pour ce faire, créez une [alerte Google](https://www.google.de/alerts) pour tous les termes de recherche pertinents. Vous pouvez ainsi surveiller le nom de votre propre entreprise, celui de votre concurrent ou même des produits spécifiques. Les informations peuvent être limitées à certains pays ou régions et ainsi être adaptées à vos besoins.

Dans les paramètres de l'alerte, sélectionnez l'option _Flux RSS_ sous _Envoyer à_. Ceci vous donne une URL avec laquelle vous pouvez sauvegarder à l'avenir toutes les nouvelles entrées dans une table SeaTable à l'aide d'une plate-forme d'automatisation. Vous pouvez alors contrôler et structurer les messages de manière très confortable et claire.
...
Ensuite, enregistrez le contact dans un outil d'automatisation des courriels tel que [Brevo](https://www.brevo.com/) pour envoyer automatiquement les courriels importants au client. Ensuite, nous enregistrons le contact avec toutes les informations supplémentaires, comme le nombre d'employés et le nom de l'entreprise, dans SeaTable afin de constituer une liste complète de clients potentiels. Enfin, vous pouvez créer le contact dans Dubb pour envoyer à ce client un message vidéo individuel supplémentaire.
...
En marketing, on essaie d'entrer en contact avec les clients par le biais d'enquêtes et de connaître leur humeur ou leur opinion. Le problème est que les clients n'ont généralement ni le temps ni l'envie de répondre à une telle [enquête]({{< relref "posts/umfrage-online" >}}) et ne participent tout simplement pas. Par conséquent, le client se voit souvent offrir une récompense ou une incitation à participer à l'enquête. Ce processus peut être entièrement automatisé.

L'automatisation commence par une enquête que vous créez dans [JotForm](https://www.jotform.com/). Comme dans le flux de travail précédent, vous pouvez utiliser d'autres outils d'enquête pris en charge par la plate-forme d'automatisation concernée au lieu de JotForm. Vous enregistrez le résultat de l'enquête dans SeaTable pour une analyse ultérieure. Attendez ensuite 5 minutes et récompensez le client en lui offrant, par exemple, le renouvellement de son abonnement d'essai ou un crédit de 5 € sur sa prochaine facture dans [Chargebee](https://www.chargebee.com/). Si vous n'utilisez pas Chargebee pour gérer les abonnements de vos clients, vérifiez si votre [CRM]({{< relref "posts/no-code-crm" >}}) ou système de facturation est déjà pris en charge par la plate-forme d'automatisation. Sinon, soyez créatif et envoyez par exemple un lien de téléchargement vers un livre électronique ou un code de bon d'achat Shopify. Vous pouvez également créer un tableau de codes de bons d'achat dans SeaTable et en envoyer un à vos clients en guise de remerciement.
...
Grâce à cette dernière automatisation, vous tirez un meilleur parti de vos réunions avec les prospects et les clients. Chaque fois que quelqu'un prend un rendez-vous avec vous via [Calendly](https://calendly.com/), une automatisation vous aide à préparer cette rencontre. Calendly envoie automatiquement des invitations à des rendez-vous à vous et à votre partenaire de réunion. Ce que Calendly ne prend pas en charge, ce sont les notes de rendez-vous et l'envoi d'informations importantes à l'avance. Vous copiez donc chaque nouveau rendez-vous dans une table SeaTable à l'aide d'une plate-forme d'automatisation. Vous y trouverez un aperçu de quand et avec qui vous parlerez de tel ou tel sujet. En même temps, SeaTable vous offre un nombre illimité de colonnes supplémentaires pour enregistrer les notes de réunion, les tâches à accomplir et les résultats. En outre, la plate-forme d'automatisation peut envoyer à l'avance un e-mail contenant des informations supplémentaires à l'interlocuteur. Elle peut même distinguer quel type de rendez-vous a été pris et envoyer des e-mails différents. Il est également possible d'envoyer automatiquement un courriel de remerciement personnel après la conversation. En vous adressant personnellement à votre interlocuteur dans l'e-mail et en faisant par exemple référence à la date du rendez-vous, personne ne pourra avoir l'idée que cet e-mail est envoyé automatiquement.

## Conclusion : Work smarter, not harder

Ce ne sont là que six exemples de processus marketing qui peuvent être facilement automatisés à l'aide d'une plate-forme d'automatisation. Même si la mise en place de ces flux de travail prend un peu de temps, vous l'économiserez en quelques opérations seulement. En même temps, vous bénéficierez d'une stabilité et d'une fiabilité accrues de vos processus, qui seront moins laissés au hasard. Essayez et automatisez vos processus marketing !
