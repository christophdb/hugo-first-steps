...
![Менеджер паролей](images/Screenshot-2023-10-31-132220.png)

Используйте менеджер паролей для документирования своего цифрового имущества.

Если вы хотите использовать менеджер паролей SeaTable для своего цифрового имущества, вы можете [посмотреть шаблон здесь]({{< relref "templates/everyday-life/password-manager" >}}). Если вы заинтересовались, просто [зарегистрируйтесь](https://seatable.io/ru/registrierung/) бесплатно и создайте обзор с вашими собственными данными.
