...
Sie möchten direkt mit dieser kostenlosen Vorlage für Ihre To do Liste arbeiten? [Dann klicken Sie hier >>]({{< relref "templates/projects/to-do-liste" >}})
...
Bei SeaTable können Sie mit der [kostenfreien Version]({{< relref "pages/registration" >}}) und dem [interaktiven Template]({{< relref "templates/projects/to-do-liste" >}}) sofort beginnen. Weitere Features sind in der Plus-Version für 7 € pro User und Monat, der Enterprise-Version für 14 € pro User und Monat oder einer dedizierten Cloud-Lösung erhältlich.
