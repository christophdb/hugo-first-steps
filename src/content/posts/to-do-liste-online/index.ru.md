...
Хотите работать непосредственно с этим бесплатным шаблоном для списка дел? [Тогда нажмите здесь >>]({{< relref "templates/projects/to-do-liste" >}})
...
С помощью SeaTable вы можете сразу же начать работу с [бесплатной версией]({{< relref "pages/registration" >}}) и [интерактивным шаблоном]({{< relref "templates/projects/to-do-liste" >}}). Дополнительные функции доступны в версии Plus за 7 евро за пользователя в месяц, в версии Enterprise за 14 евро за пользователя в месяц или в специализированном облачном решении.
