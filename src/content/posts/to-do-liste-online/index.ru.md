...
И дома, и в профессиональном [управлении проектами]({{< relref "pages/industry-solutions/project-management" >}}) важно отслеживать все предстоящие задачи и работать над ними по очереди. Первый шаг - записать конкретные **задачи** в список дел. Затем вы определяете **подзадачи** или общие **категории**, определяете **обязанности** и устанавливаете **сроки**.
...
Основная цель [Projoodle](https://www.projoodle.com/de) - облегчить совместную работу с друзьями. Подобно отправке [ссылки на Doodle]({{< relref "posts/umfrage-erstellen" >}}) для назначения встреч, управление задачами должно работать и без входа в систему. Проект Projoodle был создан именно с этой целью.
...
Еще одна интересная функция - возможность загружать [файлы]({{< relref "help/base-editor/dateien/die-datei-spalte" >}}) и [изображения]({{< relref "help/base-editor/dateien/die-bild-spalte" >}}) и прикреплять их к задачам. Вы также можете добавить любую информацию, например дату, приоритет и подзадачи в дополнительных колонках.
