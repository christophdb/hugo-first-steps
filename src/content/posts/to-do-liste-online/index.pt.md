---
title: 'Criar uma lista de tarefas online com uma aplicação'
...
SeaTable tem, de longe, a **gama mais vasta de funções** de todas as aplicações que analisámos e impressiona pela sua grande **flexibilidade**. Tem tudo o que precisa para a sua lista de tarefas numa única aplicação. Graças às muitas **funções de colaboração** (comentários, registos de dados partilhados, trabalho sincronizado em tempo real, etc.), pode não só trabalhar nas suas próprias listas, mas também colaborar com sucesso numa equipa.

Com SeaTable, pode começar imediatamente com a [versão gratuita]({{< relref "pages/registration" >}}) e o [modelo interativo]({{< relref "templates/projects/to-do-list" >}}). Estão disponíveis funcionalidades adicionais na versão Plus por 7 euros por utilizador e por mês, na versão Enterprise por 14 euros por utilizador e por mês ou numa solução dedicada na nuvem.

{{< template-box id="6381c036ff2649739c80" >}}

{{< warning headline="RGPD e soberania dos dados" >}}

Os servidores SeaTable Cloud estão localizados na Alemanha, o que torna a plataforma adequada para o trabalho em conformidade com o RGPD com dados pessoais sensíveis. Também tem a opção de instalar [SeaTable on-premises]({{< relref "pages/product/seatable-server" >}}) nos seus próprios servidores.
...
## Conclusão: Utilize uma lista de tarefas digital
