...
Both at home and in professional [project management](https://seatable.io/en/projektmanagement/), it is important to keep track of all upcoming tasks and work through them one by one. First of all, record your specific **tasks** in a to-do list. You then define any **subtasks** or overarching **categories**, determine **responsibilities** and set **deadlines**.
...
Would you like to work directly with this free template for your to-do list? [Then click here >>](https://seatable.io/en/vorlage/bpvzkh-vrpwr4xylid6zeq/)
...
SeaTable is an online database that allows you to organize tasks, information, processes and ideas easily and clearly. You benefit from a classic list view or can use alternative display formats such as the [Kanban board](https://seatable.io/en/docs/plugins/anleitung-zum-kanban-plugin/), the [calendar](https://seatable.io/en/docs/plugins/anleitung-zum-kalender-plugin/) or a [Gantt chart](https://seatable.io/en/docs/plugins/anleitung-zum-timeline-plugin/).

Another interesting feature is that you can upload [files](https://seatable.io/en/docs/dateien-und-bilder/die-datei-spalte/) and [images](https://seatable.io/en/docs/dateien-und-bilder/die-bild-spalte/) and attach them to tasks. You can also add as much information as you like, such as a date, a priority and subtasks in additional columns.
