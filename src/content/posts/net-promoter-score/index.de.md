...
### Den Net Promoter Score berechnen
...
![NPS Skala](nps-score-seatable.png)
...
![Kundenzufriedenheit mit dem Net Promoter Score messen](customer-survey.jpg)
...
### Gibt es Benchmarks, an denen man sich orientieren kann?
...
## NPS-Umfragen durchführen und auswerten
...
### Qualitative Daten und Score-Berechnung
...
### Regelmäßig und zum richtigen Zeitpunkt fragen
...
![Net promoter Score zum richtigen Zeitpunkt erheben](customer-experience.jpg)

### NPS als Teil einer ganzheitlichen Umfrage erheben
...
## Mit welchen Methoden lässt sich der NPS kombinieren, um ein ganzheitliches Bild zu erhalten?
...
{{< faq "Gibt es eine NPS Benchmark für Deutschland?" >}}
...
{{< faq "Was ist ein guter NPS-Wert?" >}}
...
{{< faq "Was sagt der NPS über Kundenzufriedenheit aus?" >}}
