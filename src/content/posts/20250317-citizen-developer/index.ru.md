...
Гражданский разработчик может выступать либо как индивидуальный **эксперт** в своей области, либо как член **задачной группы**. В небольшой компании или стартапе, не имеющем собственной [ИТ-службы]({{< relref "pages/industry-solutions/software-development" >}}), гражданский разработчик – это прежде всего тот, кто самостоятельно и с небольшим бюджетом разрабатывает практические ИТ-решения.
