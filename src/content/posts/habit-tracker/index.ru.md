...
Если вы хотите использовать SeaTable для отслеживания своих привычек, просто [зарегистрируйтесь]({{< relref "pages/registration" >}}) бесплатно. Соответствующий шаблон с большим количеством вдохновения и примеров привычек вы найдете [здесь](https://seatable.io/ru/vorlage/petkiwi1stmm_1lh2xlejq/).
