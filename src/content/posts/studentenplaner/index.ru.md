...
Чтобы использовать все возможности своего студенческого планировщика, вы можете использовать [вид календаря]({{< relref "help/base-editor/ansichten" >}}). Для этого просто добавьте плагин календаря, и вы увидите, что все ваши сроки четко распределены в вашем личном календаре.
