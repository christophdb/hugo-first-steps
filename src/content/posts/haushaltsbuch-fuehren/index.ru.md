...
Покупки, аренда и коммунальные услуги, страхование автомобиля или репетиторство для сына - с помощью SeaTable вы сможете отслеживать все свои расходы. С помощью [колонок с одним выбором]({{< relref "help/base-editor/auswahl-spalten/anlegen-einer-einfachauswahl-spalte" >}}) вы можете **классифицировать**, **фильтровать** и **группировать** свои расходы по отдельности. Чтобы навести хронологический порядок в вашей бюджетной книге, просто **отсортируйте** расходы по [дате]({{< relref "help/base-editor/numerische-spalten/die-datum-spalte" >}}). В двух дополнительных таблицах вы можете перечислить свои ежемесячные **доходы** и рассчитать профицит **бюджета**.
