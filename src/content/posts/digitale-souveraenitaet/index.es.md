...
La tendencia del almacenamiento local a la [nube]({{< relref "posts/cloud-computing" >}}) también está garantizando que cada vez más datos se encuentren en centros de datos y, por tanto, **en manos de empresas tecnológicas estadounidenses** como Microsoft, Apple, Google y Amazon. Los asistentes de IA, actualmente en auge (por ejemplo, ChatGPT, Copilot) también están reenviando solicitudes a sus empresas matrices. Como los datos en estos casos no sólo salen de su empresa, sino a menudo también de la Unión Europea, esto puede violar el GDPR. **El flujo global de datos** hace más difícil comprender dónde se almacenan los datos en un momento dado y qué leyes de protección de datos se aplican. Esto hace que a las empresas les resulte cada vez más difícil garantizar la protección de los datos de acuerdo con las normativas nacionales e internacionales.
