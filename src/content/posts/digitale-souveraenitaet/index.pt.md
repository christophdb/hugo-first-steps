...
![Soberania digital](digitale-souveraenitaet.jpg)
...
A tendência do armazenamento local para a [nuvem]({{< relref "posts/cloud-computing" >}}) também está a garantir que cada vez mais dados estejam localizados em centros de dados e, portanto, **nas mãos de empresas de tecnologia dos EUA**, como a Microsoft, a Apple, a Google e a Amazon. Os [assistentes de IA]({{< relref "posts/kuenstliche-intelligenz" >}}) atualmente em expansão (por exemplo, ChatGPT, Copilot) também estão a encaminhar pedidos para as suas empresas-mãe. Como os dados nestes casos não só saem da sua empresa, mas muitas vezes também da União Europeia, isto pode violar o RGPD. **O fluxo global de dados** torna mais difícil compreender onde os dados são armazenados num determinado momento e quais as leis de proteção de dados aplicáveis. Isto torna cada vez mais difícil para as empresas garantir a proteção de dados em conformidade com os regulamentos nacionais e internacionais.
...
![O aeroporto como exemplo de segurança informática para infra-estruturas críticas](flughafen-sicherheit.jpg)
...
## Tecnologias para uma maior soberania digital
...
{{< faq "Qual é a relação entre a residência de dados e a soberania dos dados? " >}}
