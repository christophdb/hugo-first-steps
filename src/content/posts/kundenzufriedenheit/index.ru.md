...
description: 'Удовлетворенные клиенты возвращаются и рекомендуют компанию другим. С помощью опросов NPS и онлайн-анкет можно собирать обратную связь. SeaTable позволяет структурировать данные, выявлять слабые места и приоритизировать задачи, чтобы постоянно повышать качество обслуживания и клиентский опыт.'
date: 2021-03-05
lastmod: '2023-06-28'
author: 'cdb'
...
seo:
    title: 'Измерение и улучшение удовлетворенности клиентов'
    description: 'Узнайте, как измерять, анализировать и повышать удовлетворенность клиентов с помощью цифровых инструментов SeaTable.'
categories:
    - 'best-practice'
tags:
...
Последующий расчет Net Promoter Score прост. Сначала ответившие клиенты делятся на две категории: _промоутеры_, которых иногда называют фанатами, и _детракторы_, которых часто называют критиками. Промоутеры - это те, кто ответил 10 или 9 баллов, а недоброжелатели - те, кто поставил от 0 до 6 баллов. Люди с 7 или 8 баллами называются пассивами.
...
Какой бы метод вы ни выбрали, убедитесь, что используете инструмент, позволяющий хранить и управлять всеми отзывами. Например, SeaTable может помочь вам собрать нужные отзывы клиентов. Просто создайте нужный вам опрос с помощью нашей веб-формы. В [этой статье]({{< relref "templates/marketing/customer-feedback" >}}) мы более подробно объясним весь процесс создания такой формы и последующей оценки. Если вы хотите сразу же приступить к работе, загляните сюда.
