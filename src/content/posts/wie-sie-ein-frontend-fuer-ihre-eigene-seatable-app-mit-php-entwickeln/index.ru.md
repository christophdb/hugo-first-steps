...
description: 'Пошаговое руководство для разработчиков: как с помощью SeaTable API, PHP, фреймворка Slim и шаблонизатора Twig создать удобный пользовательский интерфейс к базе данных.'
date: 2022-09-27
categories:
    - 'product-features'
tags:
...
color: '#fcbc68'
seo:
    title: 'Собственный фронтенд SeaTable на PHP: инструкция'
    description: 'Научитесь создавать индивидуальный frontend для приложений SeaTable с помощью PHP, Slim и Twig.'
---
...
- Далее мы используем SeaTable PHP API для заполнения этих статических веб-страниц содержимым из SeaTable. Для этого я буду использовать [PHP-фреймворк Slim](https://www.slimframework.com/) и [систему шаблонов Twig](https://twig.symfony.com/).
