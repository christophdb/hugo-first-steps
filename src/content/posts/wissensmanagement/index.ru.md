...
description: 'Знания – один из самых важных ресурсов в любой компании. Но что нужно сделать, чтобы знания ваших сотрудников стали доступны другим сотрудникам вашей компании? Ответ: функционирующая система управления знаниями! Узнайте здесь, как успешно управлять знаниями в своей компании и на что следует обратить внимание при выборе подходящей системы управления знаниями.'
date: 2024-08-09
categories:
    - 'best-practice'
tags:
...
Оптимизация работы со знаниями в компании – вот что такое управление знаниями (также известное как _knowledge management_). Главная цель – создать **базу знаний**, которая должна сделать процессы в компании более эффективными и инновационными.
...
Приятная рабочая атмосфера помогает вам накапливать знания и обмениваться ими. Чтобы управление знаниями было максимально эффективным, явные и неявные знания должны идти рука об руку. Поэтому создайте в своей компании **культуру**, в которой сотрудники будут мотивированы делиться друг с другом своими скрытыми сокровищами знаний и активно передавать их.

## Две стратегии в управлении знаниями

Как сделать знания одного сотрудника доступными для всех остальных? Существует две **стратегии** циркуляции знаний, чтобы вся организация могла воспользоваться неявными знаниями отдельных сотрудников.
...
### Стратегия «от людей к людям»

Этот вариант используется, когда знания слишком сложны для понимания всеми. Тогда требуются **эксперты**, которые могут лично передать свои знания конкретным коллегам, а также ответить на вопросы. Поэтому, если в вашей компании есть эксперты, они должны быть быстро и легко доступны в случае возникновения проблем.
...
- **Развитие знаний:** генерирование знаний внутри компании и их предоставление в явном виде в цифровых системах.
...
Сэкономьте своим сотрудникам много работы, предложив клиентам помочь себе самим. Пример такого справочного раздела вы найдете [здесь]({{< relref "help" >}}). Тем не менее всегда бывают ситуации, когда клиентам нужна личная помощь. Для таких случаев вам следует вести [систему тикетов]({{< relref "posts/20250521-ticketing-system" >}}), с помощью которой вы сможете структурированно обрабатывать запросы.

[ИТ-служба поддержки]({{< relref "templates/it-engineering/it-helpdesk" >}}) – пример хорошо управляемой системы управления знаниями. С одной стороны, это снижает нагрузку на сотрудников службы поддержки, а с другой – избавляет ваших клиентов от долгого ожидания.
...
- **Риски безопасности**: В наши дни конфиденциальная информация обычно хранится на центральном [сервере]({{< relref "posts/it-infrastruktur" >}}) или в [облаке]({{< relref "posts/cloud-computing" >}}). Однако разрешения на доступ и соответствующие рекомендации по защите данных также таят в себе риски.
...
Примеры: [Seafile](https://www.seafile.com/en/home/), Nextcloud, iCloud, Google Drive, OneDrive, Dropbox

{{< /accordion >}}

{{< accordion "Системы управления взаимоотношениями с клиентами" >}}

Примеры: [Pipedrive, Salesforce]({{< relref "posts/no-code-crm" >}})

{{< /accordion >}}

{{< accordion "Системы управления проектами" >}}

Примеры: [Asana]({{< relref "pages/landing-pages/alternatives/asana-alternative" >}}), Jira

{{< /accordion >}}

{{< accordion "Системы управления персоналом" >}}

Примеры: [Personio]({{< relref "pages/landing-pages/alternatives/personio-alternative" >}}), DATEV
...
- Как быстро сотрудники смогут найти нужные записи в программе?
...
Вы можете использовать SeaTable в облаке, которое размещается в немецких центрах обработки данных в соответствии с GDPR, или установить его [локально]({{< relref "pages/product/seatable-server" >}}) на собственных серверах. В любом случае ваши данные будут в безопасности! Кроме того, во многих местах SeaTable вы можете с помощью прав доступа точно определять, кто может просматривать и редактировать те или иные данные.
