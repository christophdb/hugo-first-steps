...
Для обмена знаниями можно использовать различные известные методы, например, [семинары]({{< relref "posts/workshop-planen" >}}), извлечение уроков, [командные встречи](https://seatable.io/ru/in-4-schritten-zu-effizienteren-teammeetings/), наставничество, [введение в должность](https://seatable.io/ru/onboarding/) или внутренние информационные бюллетени.
