...
![Gestão digital de produtos com gestão digital de tarefas](Kanban-Tasks.gif)
...
![Para que a gestão do seu produto digital se mantenha a tempo](Timeline.png)
...
![A gestão digital de produtos também inclui números de vendas mensais](Store-Sales.png)
...
![O plugin do mapa fornece uma representação visual dos pontos de venda individuais](Map-Plugin-711x341.jpg)  
...
![A gestão digital de produtos também inclui estatísticas de todos os tipos](Stats.png)
...
As estatísticas na parte inferior esquerda mostram os números das vendas mensais das lojas com um gráfico de barras empilhadas, que também mostra a soma dos meses na altura do bar. Para obter outra perspectiva sobre as vendas mensais, ![Estatísticas flexíveis para a gestão de produtos digitais](flexible-statistics.png) criámos outro gráfico de barras na parte inferior esquerda, mostrando todos os números de vendas mensais por ramo com linhas estreitas.
