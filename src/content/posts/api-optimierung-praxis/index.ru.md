...
![Workflow n8n для оптимизации API, уменьшающий вызовы SeaTable API по выходным](n8n-limit-schedule.png 'Это условие IF в n8n, например, приостанавливает выполнение на выходных.')
...
![Табличный вид SeaTable с колонками‑поиска для сокращения дополнительных вызовов API](use-link-formula-columns.png 'Получайте нужную информацию через lookup в основной таблице, чтобы избежать повторных вызовов API')
