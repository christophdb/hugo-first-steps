...
Для этого SeaTable предлагает вам множество возможностей для сбора всех данных о клиентах в одном месте экономически эффективным, прибыльным и интуитивно понятным способом. Подразделения и сотрудники, имеющие к вам отношение, могут сразу же начать работать вместе как единая команда. Например, вы можете быстро назначить права на чтение и/или запись для отделов [продаж](https://seatable.io/ru/vertrieb/), [маркетинга]({{< relref "pages/industry-solutions/marketing" >}}), закупок или обслуживания клиентов.
...
[К шаблону "Управление предложениями CRM"]({{< relref "templates/sales/crm-offer-management" >}})  
