...
sections:
    ...
    - name: content-25
      ...
      items:
          - headline: Эффективная организация данных
            ...
            image_alt: 'Табличный вид SeaTable с разными типами столбцов для эффективной организации данных'
          - headline: Разнообразные представления
            ...
            image_alt: 'Разные представления SeaTable, такие как таблица, календарь, Kanban и галерея, в одном обзоре'
          ...
          - headline: Бесплатные шаблоны
            ...
            image_alt: 'Набор шаблонов SeaTable как альтернатива Excel для разных отделов'
          - headline: Функция фильтрации и сортировки
            ...
            image_alt: 'Таблица SeaTable с функциями фильтрации и сортировки для точечного анализа данных'
    ...
    - name: 'content-23'
      ...
      image_alt: 'Интерфейс SeaTable на нескольких устройствах для мобильного доступа и гибкого использования данных'
    ...
    - name: 'content-3'
      ...
      items:
          - headline: SeaTable Cloud
            ...
            image_alt: 'Облачный шаблон SeaTable для проектного плана как альтернатива Excel для современной планировки'
          - headline: SeaTable Server
            ...
            image_alt: 'Шаблон плана мероприятий SeaTable Server для локального управления данными как альтернатива Excel'
