...
sections:
    - name: hero-5
      ...
      text: Планируйте и контролируйте свои проекты эффективно с помощью SeaTable. Работайте в команде в режиме реального времени и **используйте рабочие процессы на базе искусственного интеллекта** для оптимизации и автоматизации ваших процессов. SeaTable предлагает вам все преимущества современных инструментов управления проектами, которые вам нужны для совместной организации проектов. 
      classes:
          - bg-gray-200
    ...
    - name: "content-4"
      weight: 4
      title: SeaTable — идеальное решение для управления проектами
      subtitle: Преимущества SeaTable
      text: "Как руководителю проекта, вам необходимо всегда иметь полное представление, чтобы эффективно управлять сложными проектами. Однако традиционные инструменты управления проектами часто достигают своих пределов, особенно при использовании гибких (agile) методик. SeaTable предлагает вам выдающийся опыт с современными функциями искусственного интеллекта и следующими преимуществами:"
      items:
      - icon: edit
        headline: Гибкость и адаптивность под ваши нужды с мощью ИИ
        text: "Создавайте индивидуальные решения с поддержкой ИИ с помощью SeaTable, точно соответствующие вашим требованиям. Хотите внедрить agile-методы, использовать ИИ для отчетов о статусе или контролировать процесс с помощью диаграмм Ганта — SeaTable дает вам свободу реализовать собственное представление об эффективном управлении проектами."

      - icon: up-right-and-down-left-from-center
        headline: Интуитивный интерфейс и интеллектуальная визуализация данных
        text: "Благодаря интуитивному дизайну и интерфейсу, основанному на ИИ, вы можете быстро и эффективно организовать ваш проектный процесс. Все данные четко структурированы в таблицах и легко отображаются в календарях, органиграммах, ИИ-генерируемой статистике, а также на Kanban-досках и временных шкалах."

      - icon: location-dot
        headline: Обзор в реальном времени и командное взаимодействие
        text: "Благодаря улучшенным функциям совместной работы и интеллектуальным уведомлениям ваши процессы связаны между собой, и каждый знает, что нужно делать. В SeaTable вы всегда в курсе — будь то распределение задач на основе ИИ, отслеживание прогресса или совместное редактирование документов."

      - icon: heart
        headline: Автоматизация рутинных процессов с помощью ИИ
        text: Автоматизируйте повторяющиеся [рабочие процессы]({{< relref "pages/industry-solutions/individual" >}}) в SeaTable с использованием умной логики ИИ. Это значительно сокращает ручную работу и снижает риск человеческих ошибок. Через API SeaTable или платформы автоматизации можно интегрировать все любимые инструменты.

      - icon: globe
        headline: Масштабируемость, защита данных и суверенитет ИИ
        text: "Ваша команда растет или проект расширяется? SeaTable растет вместе с вами. Как бы ни усложнялся проект, благодаря нашим пакетам в облаке вы можете масштабироваться без ограничений, при этом ваши данные и запросы ИИ размещаются исключительно на европейских серверах и защищены в соответствии с GDPR."

      - icon: shield
        headline: Экономическая эффективность благодаря умным индивидуальным решениям
        text: "SeaTable как бесплатный инструмент управления проектами впечатляет своей экономичностью и современными функциями ИИ. Выберите нужную модель и настройте программное обеспечение под ваш проект, включая кредиты на ИИ. SeaTable Free навсегда бесплатен — масштабируйтесь только тогда, когда это необходимо."
    ...
    - name: content-12
      ...
      items:
        ...
        - text: Автоматизированные рабочие процессы с использованием искусственного интеллекта
      ...
      image_alt: 'Представление управления проектами SeaTable для командной работы с задачами и статусами'
    ...
    - name: content-1
      ...
      - headline: Большая свобода творчества
        text: Платформа [No‑Code с искусственным интеллектом]({{< relref "/" >}}) позволяет вам начать с нуля и индивидуально настраивать свои процессы. Вы получаете все необходимые инструменты для разработки своего проекта в соответствии со своими представлениями.
      ...
      iamge_alt: 'Команда обсуждает проекты, используя SeaTable как инструмент управления проектами'
    - name: 'content-8'
      weight: 10
      ...
      items:
          - text: План проекта
            ...
            image_alt: "Шаблон плана проекта SeaTable с задачами и вехами"
          ...
          - text: План мероприятий
            ...
            image_alt: "Шаблон плана мероприятий SeaTable для задач и зон ответственности"
      buttons:
    ...
    - name: content-25
      ...
      - headline: Планировщик проектов
        ...
        image_alt: 'Представление планировщика проектов SeaTable с временной шкалой и задачами'
      - headline: План структуры проекта
        ...
        image_alt: 'Шаблон структурного плана проекта SeaTable с рабочими пакетами'
      - headline: График проекта
        ...
        image_alt: 'План хода проекта SeaTable с временной последовательностью действий'
      - headline: Управление портфелем проектов
        ...
        image_alt: 'Представление портфеля проектов SeaTable для нескольких параллельных проектов'
      - headline: Приложение для управления проектами
        ...
        iamge_alt: 'Приложение управления проектами SeaTable как веб‑интерфейс планирования проектов'
