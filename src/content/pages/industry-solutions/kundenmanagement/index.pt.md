...
seo:
    ...
    description: 'SeaTable para gestão de clientes: CRM flexível sem código, em conformidade com o RGPD, com automações, API e modelos gratuitos.'
date: '2025-07-18'
    ...
    - name: faq
      ...
      items:
          ...
          - q: O SeaTable oferece uma versão gratuita?
            a: Para pequenas equipas de até 25 pessoas, o SeaTable oferece uma versão gratuita baseada na nuvem que já tem todas as caraterísticas e funções e visualizações necessárias para a gestão estratégica de clientes. Com automatizações, Universal App Builder, inúmeros modelos gratuitos e formulários integrados, o SeaTable Free oferece um pacote que nenhum software de CRM oferece gratuitamente.
