...
sections:
    ...
    - name: content-12
      ...
      subtitle: Die skalierbare No-Code-Plattform
      description: SeaTable ist so flexibel wie eine Tabellenkalkulation und so leistungsfähig wie eine Datenbank. So behalten Sie den Überblick über alle Kundeninteraktionen, können Prozesse automatisieren und Ihre Daten intelligent auswerten.
      items:
        ...
        - text: Integrierte Benachrichtigungen und Automatisierungen
    ...
    - name: 'content-4'
      ...
      items:
        ...
        - headline: Volle Kontrolle über Ihre Daten
          text: Cloud- oder On-Premise-Hosting – Sie bestimmen, wo Ihre Daten gespeichert werden.
          icon: terminal
        - headline: Tabelle, Kanban, u.v.m. 
          text: "Strukturieren Sie Ihre Daten so, wie Sie es brauchen, z. B. als klassische Tabelle, Kalender oder Kanban Board."
          icon: list
        ...
        - headline: 'Schnelle Integration ohne IT'
          text: 'Einfach registrieren und loslegen: SeaTable Cloud ist sofort einsatzbereit.'
          icon: code  
        - headline: 'Statistiken und Dashboards'
          text: In SeaTable haben Sie alle Daten stets im Blick und können direkt Dashboards und Reportings erstellen. 
          icon: chart-line
    ...
    - name: "content-4"
      ...
      - icon: terminal
        ...
        text: "Wer ein CRM System self-hosted betreiben möchte, hat mit SeaTable Server den gleichen Funktionsumfang wie bei der Cloud Version – und behält die vollständige Hoheit über seine Daten."
      - icon: user-plus
      ...
      - icon: fingerprint
        ...
        text: "SeaTable unterstützt alle gängigen Authentifizierungstechniken und ermöglicht Zwei-Faktor-Authentifizierung und SSO in allen Abo-Modellen."
