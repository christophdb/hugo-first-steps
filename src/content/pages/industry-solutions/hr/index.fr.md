...
sections:
    - name: hero-5
      ...
      text: Découvrez l'avenir de la gestion des ressources humaines ! Avec SeaTable, vous pouvez non seulement numériser vos processus RH, mais aussi les automatiser massivement grâce à des flux de travail intelligents basés sur l'IA. Améliorez la qualité des données et augmentez votre productivité grâce à des solutions sans code qui s'adaptent parfaitement à votre entreprise.
      classes:
          - bg-gray-200
    ...
    - name: content-12
      ...
      image_alt: 'Interface SeaTable pour planifier et analyser les processus RH'
    ...
    - name: 'content-8'
      ...
      items:
          - text: Enregistrement du temps de travail
            ...
            image_alt: 'Modèle RH SeaTable pour suivi du temps de travail'
          - text: Intégration des employés
            image: /images/Landing-Page-HR_Template_Onboarding.png
            image_alt: 'Modèle RH SeaTable pour onboarding des employés'
          - text: Recrutement de personnel
            image: /images/Landing-Page-HR_Template_Recruiting.png
            image_alt: 'Modèle SeaTable HR pour le recrutement assisté par IA'
      buttons:
    ...
    - name: content-25
      ...
      items:
          - headline: "Gestion des candidatures basée sur l'IA"
            text: "Un outil performant qui automatise l'ensemble du processus de recrutement. Utilisez l'IA pour présélectionner les candidatures, coordonner automatiquement les rendez-vous et améliorer ainsi considérablement l'expérience candidat."
          ...
          - headline: 'Gérer les dossiers de personnel numériques'
            ...
            image_alt: 'Interface SeaTable pour gestion numérique et conforme au RGPD des dossiers du personnel'
          ...
          - headline: 'Saisie simple du temps de travail'
            ...
            image_alt: 'Vue de suivi du temps RH dans SeaTable avec heures de travail et absences'
          ...
          - headline: 'Création d’organigrammes'
            ...
            image_alt: 'Vue d’organigramme dans SeaTable pour visualiser la structure de l’entreprise'
          ...
          - headline: "Optimiser les flux de travail grâce à l'IA"
            ...
            image_alt: 'Tableau de bord RH SeaTable pour optimiser et automatiser les processus RH'
    ...
    - name: content-22
      ...
      text: 'Avec notre [plateforme IA sans code]({{< relref "/" >}}), presque tous les processus RH peuvent être mis en place dans votre application.'
    ...
    - name: 'content-13'
      ...
      items:
          ...
          - headline: Conformité et pistes d’audit
            text: "Assurez-vous que vos données RH sont toujours conformes aux exigences d'audit. L'IA vous aide à identifier les incohérences dans les documents et garantit la conformité des flux de travail avec le RGPD."
          - headline: Gestion des performances
            text: Fixez des objectifs clairs et suivez les performances de vos collaborateurs grâce à des tableaux de bord et des rapports personnalisables. Laissez l'IA résumer les entretiens d'évaluation et dégager des tendances objectives à partir des données de performance.
          - headline: Gestion des absences
            text: Automatisez les workflows liés aux arrêts maladie et intégrez le planificateur de congés directement dans les calendriers de votre équipe. L'IA aide à planifier intelligemment les ressources afin d'identifier à temps les pénuries pendant les périodes de congés. 
    - name: 'content-9'
      weight: 9
