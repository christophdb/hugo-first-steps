...
seo:
    ...
    description: 'Упростите цифровое управление с SeaTable — гибкие решения без кода, соответствующие GDPR, в облаке или на локальном сервере'
date: '2025-04-03'
    ...
    - name: 'content-4'
      ...
      items:
          ...
          - icon: check
            ...
            text: Эффективно и прозрачно управляйте проектами с помощью автоматизированных процессов и совместной работы в режиме реального времени.
          - icon: music
            headline: Продвижение культуры
            text: Организуйте проекты финансирования прозрачно и автоматически для большей безопасности планирования.   
    ...
    - name: content-4
      ...
      items:
          ...
          - headline: SeaTable Dedicated
            text: Используя SeaTable Dedicated, Вы сочетаете простоту облака с гибкостью самостоятельной системы. Мы устанавливаем, поддерживаем и обслуживаем Ваш собственный сервер SeaTable.
