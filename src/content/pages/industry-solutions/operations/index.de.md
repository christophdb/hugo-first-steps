...
sections:
    ...
    - name: "content-4"
      ...
      text: "SeaTable Cloud wird ausschließlich auf lizenzierten Servern in Deutschland gehostet. Dadurch ist SeaTable als Software für Prozessmanagement 100 % DSGVO-konform und gewährt ein Höchstmaß an Datenschutz und Datensicherheit. "
      items:
      - icon: terminal
    ...
    - name: faq
      ...
      items:
          - q: Bietet SeaTable Vorlagen für mein Operations Team?
            a: Ja, SeaTable bietet verschiedene sofort einsetzbare Vorlagen für Operations-Teams an, z. B. für Supply Chain Management, Ordering Work Process and Fulfillment, Inventarisierung oder Flottenmanagement. 
