...
sections:
    ...
    - name: 'content-12'
      ...
      image_alt: 'Vue travail d’équipe SeaTable avec bases partagées et commentaires'
    ...
    - name: content-1
      ...
      image_alt: 'Capture SeaTable avec vues galerie, calendrier et Kanban pour la visualisation des données'
