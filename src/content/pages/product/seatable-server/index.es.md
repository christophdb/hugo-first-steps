...
url: '/es/on-premises'
seo:
    title: 'On-Premises: base de datos segura para empresas'
    description: 'Instala SeaTable en tu servidor, controla tus datos y gestiona accesos. Solución empresarial para máxima privacidad y seguridad.'
...
sections:
    ...
    - name: content-11
      ...
      image_position: left
      image_alt: 'Interfaz de SeaTable Server para implementación on‑premises con control total de datos'
      buttons:
    ...
    - name: content-11
      ...
      image_alt: 'Arquitectura de sistema SeaTable on‑premises con infraestructura de servidor propia'
      buttons:
          - label: A precios
            link: pages/prices
