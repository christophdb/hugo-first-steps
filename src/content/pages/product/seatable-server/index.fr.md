...
url: '/fr/on-premises'
seo:
    title: 'On-Premises : base de données sécurisée entreprise'
    description: 'Vos données sur votre serveur, accès gérés sur mesure. SeaTable On-Premises : sécurité et autonomie pour entreprises exigeantes.'
...
sections:
    ...
    - name: content-11
      ...
      image_position: left
      image_alt: 'Interface SeaTable Server pour déploiement on‑premises avec contrôle complet des données'
      buttons:
    ...
    - name: content-11
      ...
      image_alt: 'Architecture système SeaTable on‑premises avec infrastructure serveur dédiée'
      buttons:
