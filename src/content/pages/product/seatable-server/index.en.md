...
aliases:
    - '/en/on-premises/'
seo:
    title: 'On-Premises: Secure Database Solution for Business'
    description: 'Full control on your own server: SeaTable On-Premises secures data, custom access. The enterprise choice for IT compliance.'
...
sections:
    ...
    - name: content-11
      ...
      image_position: left
      image_alt: 'SeaTable Server interface for on‑premises operation with full data control'
      buttons:
    ...
    - name: content-11
      ...
      image_alt: 'SeaTable on‑premises system architecture with dedicated server infrastructure'
      buttons:
          - label: To pricing
            link: pages/prices
