...
url: '/ru/on-premises'
seo:
    title: 'On-Premises: защищённая база для компаний'
    description: 'SeaTable On-Premises : собственный сервер, полный контроль и безопасность данных. Идеальное решение для бизнеса и IT.'
