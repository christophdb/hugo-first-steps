...
url: '/de/cloud'
seo:
    title: 'No-Code Cloud-Datenbank für Unternehmen & Teams'
    description: 'Effizient, sicher & schnell: Die innovative No-Code Cloud von SeaTable. Skalierbare Datenbanklösung für Ihr Business erleben.'
...
sections:
    ...
    - name: content-6
      ...
      items:
          - text: Die SeaTable Cloud läuft in den zertifizierten deutschen Rechenzentren des schweizer Anbieters Exoscale. Amerikanischen Dienstleistern haben wir den Rücken gekehrt.
      buttons:
