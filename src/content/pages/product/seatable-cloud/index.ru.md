...
url: '/ru/cloud'
seo:
    title: 'Но-код облачная база для бизнеса и команд'
    description: 'Быстро, безопасно, масштабируемо: инновационная облачная база данных SeaTable. Эффективное решение для вашего бизнеса.'
