    ...
    - name: 'faq'
      ...
      items:
          ...
          - q: 'Onde encontro mais informações sobre a API?'
            a: 'Para aproveitar ao máximo o SeaTable, consulte a [referência da API REST do SeaTable](https://api.seatable.io). Como alternativa ao Airtable, o SeaTable se destaca por oferecer muito mais chamadas de API do que o Airtable.'
