    ...
    - name: "faq"
      ...
      items:
        ...
        - q: 'Я хочу запустить свой собственный сервер SeaTable. Где я могу узнать больше?'
          a: 'Пожалуйста, ознакомьтесь с [Руководством администратора SeaTable](https://admin.seatable.com) для получения инструкций по установке собственного сервера. Вы можете купить лицензию прямо на нашей [странице с ценами]({{< relref "pages/prices" >}}).'
---
