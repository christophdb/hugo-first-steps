...
description: 'SeaTable bietet leistungsstarke Funktionen zu fairen Preisen. Entdecken Sie unsere verschiedenen Tarife und finden Sie die optimale Lösung für Ihre Datenverwaltung.'
date: '2025-03-30'
url: '/de/preise'
    ...
    - name: faq
      ...
      items:
          ...
          - q: Welche Zahlungsmethoden kann ich nutzen?
            a: Sie können grundsätzlich mit Kreditkarte sowie mit Apple Pay und Google Pay bezahlen. Eine Lizenzen für 50 Benutzer und mehr können Sie auch per Banküberweisung bezahlen.
          ...
          - q: Wie kann ich die automatische Verlängerung der Lizenz für SeaTable Server kündigen?
            a: Sie können die automatische Verlängerung jederzeit im  deaktivieren.
          ...
          - q: Was sind die Mindestanforderungen für den Betrieb von SeaTable Server?
            a: Konsultieren Sie das [SeaTable Admin Manual](https://admin.seatable.io) für alle technischen Fragen.
    ...
    - name: faq
      ...
      items:
          ...
          - q: Kann ich die Enterprise Funktionen testen?
            a: Wir können Ihr Free oder Plus Abonnement für eine beschränkte Zeit kostenfrei auf ein Enterprise Abonnement upgraden. [Senden Sie uns bitte über die Teamverwaltung eine entsprechende Anfrage](https://account.seatable.io/).
          ...
          - q: Kann ich die Anzahl der Benutzer in meinem Team ändern?
            a: 'Sie können die Benutzeranzahl in Ihrem Team jederzeit anpassen.<br><br>Bei SeaTable Cloud Free, Plus und Enterprise können Sie dies selbst über die Anpassung Ihres Abonnements in der [Teamverwaltung](https://account.seatable.io/) machen. Bei SeaTable Dedicated sprechen Sie bitte Ihren persönlichen Ansprechpartner an.<br><br>Im Free Abonnement ist die Teamgröße auf 25 begrenzt. Bei SeaTable Cloud Plus und Enterprise sowie bei SeaTable Dedicated ist die Benutzeranzahl unbegrenzt.'
          ...
          - q: Kann ich verschieden Abrechnungsperioden kombinieren?
          ...
          - q: 'Wie kann ich die Rechnungsadresse anpassen?'
            a: 'Sie können die Rechnungsadresse jederzeit in der [Teamverwaltung](https://account.seatable.io/) anpassen.<br><br>Die nachträgliche Änderung einer Rechnung ist nicht möglich.'
