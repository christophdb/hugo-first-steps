...
sections:
    ...
    - name: 'content-3'
      ...
      description: Con SeaTable, usted elige entre dos potentes opciones de implementación para su [gestión de flujos de trabajo]({{< relref "pages/landing-pages/industry-solutions/individual" >}}).
      items:
