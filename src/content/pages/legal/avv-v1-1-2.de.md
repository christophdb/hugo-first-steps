...
version: '1.1.2'
type: 'legal'
url: '/de/auftrag-zur-auftragsverarbeitung/v1-1-2'
noindex: true
---

{{< alert icon="empty" cardColor="gradient" textColor="#fff" >}}

Diese Version ist nicht mehr aktuell. Hier geht es zur **[aktuellen Version]({{< relref path="pages/legal/avv" lang="de" >}})**.
