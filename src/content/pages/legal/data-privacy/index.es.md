...
Esta política de privacidad sólo está disponible en inglés y alemán. La versión en inglés es una traducción de conveniencia no vinculante.
El **[original alemana]({{< relref path="/pages/legal/data-privacy" lang="de" >}})** es jurídicamente vinculante.

{{< /alert >}}

## 1. Data Protection at a Glance

In this section, we provide you with an easy to navigate overview of what will happen with your personal data when you visit and use this online service. This online service comprises the website (seatable.io), the cloud service SeaTable Cloud (cloud.seatable.io), the team administration of SeaTable Cloud (account.seatable.com), the SeaTable Forum (forum.seatable.com) and SeaTable Ideas (ideas.seatable.com) as well as the store SeaTable Market (market.seatable.io). Personal data refers to all data that can be used to personally identify you. More information about privacy at SeaTable is available in the following sections.

**Who is the responsible party for the recording of data on this website (i.e. the controller)?**

The data on this online service is processed by the operator of the online service. You find the contact information of the operator in the Imprint.
...
Most of the data is collected to fulfill contractual and pre-contractual obligations (e.g. email address, address, inquiries) and some of the data is collected to ensure the reliable operation of this online service (e.g. log data). Other data may be used to analyze your user behavior.
...
Please do not hesitate to contact us at any time if you have questions about this or any other data protection-related issues. For contact details, see the Imprint.
...
This online service does not use any services of companies based in the USA and does not integrate any tools of US companies. Your personal data will not be transmitted to US servers.

Only when using a credit card to pay this online services, personal data may be sent indirectly to the USA. This is unavoidable, as all major credit card providers are based in the USA.

## 3. Hosting

This online service uses the technical infrastructure of external service providers (hosters). Personal data collected on this online service and in your personal communication with our staff are stored on the servers of the respective hoster. These may include, but are not limited to, IP addresses, contact requests, metadata and communications, contract information, contact information, names, website access, and other data generated through the visit of a website.

**Purpose and legal basis**

The hosters are used for the purpose of fulfilling the contract with our potential and existing customers (Art. 6 (1) b GDPR) and in the interest of secure, fast and efficient provision of this online service (Art. 6 (1) f GDPR).

**Data processing**

In order to guarantee processing in compliance with data protection regulations, we have concluded data processing agreements with all hosters we use.

### Exoscale

The website, the cloud service SeaTable Cloud, the team administration of SeaTable Cloud, the SeaTable Forum and SeaTable Ideas as well as and the store SeaTable Market are hosted by Akenes SA, Boulevard de Grancy 19A, 1006 Lausanne, Switzerland (Exoscale).
...
We run test and demo systems on infrastructure by Hetzner Online GmbH, Industriestraße 25, 91710 Gunzenhausen, Germany (Hetzner). We use these systems with a view to improving the performance and stability of SeaTable Cloud and providing interested parties with individual testing opportunities.

Hetzner operates data centers in Europe (Germany and Finland) and in the USA. We use exclusively the European data centers. You can find more information on Hetzner’s data centers at https://www.hetzner.com/unternehmen/rechenzentrum.

### Host Europe

The mail server managing the mail accounts of this online service is hosted by Host Europe GmbH, Hansestraße 111, 51149 Cologne, Germany (Host Europe).

## 4. Recording of Data

### Log-data

The log files of the servers we use store data that your browser automatically transmits to us when using this online service, including:
...
Cookies have a variety of functions. Many cookies are technically essential since certain website functions would not work in the absence of the cookies (e.g. the shopping cart function or the display of videos). The purpose of other cookies may be the analysis of user behavior or the display of personalized ads.
...
This online service uses exclusively cookies that are essential for its operation.
...
This online service uses the web analytics software Matomo (Matomo).
...
We have installed Matomo on a server of our own. Matomo is run with settings that do not allow the tracking or the recognition of individual users: Tracking cookies and other advanced features such as custom variables are disabled and IP addresses get anonymized. The data collected is not passed on to third parties.

**Purposes and legal basis**

We use Matomo to analyze user behavior and to optimize our online offer. This represents a legitimate interest within the meaning of Art. 6 (1) f GDPR.

## 6. Newsletter

If you would like to subscribe to the newsletter offered on this online service, we will need from you an email address as well as information that allow us to verify that you are the owner of the email address and consent to the receipt of the newsletter. No further data shall be collected or shall be collected only on a voluntary basis. We shall use such data only for the sending of the requested information and shall not share such data with any third parties.

### Sendinblue

This online service uses the email-marketing tool Sendinblue. The provider is Sendinblue GmbH, Köpenicker Straße 126, 10179 Berlin, Germany (Sendinblue).
...
Sendinblue allows us to organize and analyze newsletters campaigns. For example, we can see by whom and how often a newsletter was opened, and which embedded links were clicked most often. This way we can determine, among other things, which content generated the highest user interaction.
...
You can find more information about the features of Sendinblue at https://www.sendinblue.com/features/email-marketing/.

You can find the privacy policy of Sendinblue at https://de.sendinblue.com/legal/privacypolicy.
...
This online service integrates text and video links to video content on the video sharing platform YouTube. The operator is Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Ireland (Google).

The linking of a video in a page of this online service does not result in data being transmitted to YouTube or cookies being stored on your end device when visiting a page. When accessing the page, data is loaded exclusively from the online service’s servers.

Only when clicking on the link, you are redirected to YouTube and a connection to the YouTube servers is established. Among other things, YouTube gets to know from which page you switched to their site. If you are logged into your YouTube account, you enable YouTube to assign your surfing behavior directly to your personal profile.

For more information on how YouTube handles user data, consult the YouTube Data Privacy Policy at https://policies.google.com/privacy?hl=en.

### Google Fonts

This online service uses fonts provided by Google (Google Fonts). You can find more information about Google Fonts at https://fonts.google.com.

We have installed all Google Fonts on the servers of this online service. This allows you to use the fonts in this online service without having to connect to Google’s servers.
...
We have installed Zammad on a server of our own. If you send us a request by email (except emails to personal accounts), all data related to this communication process will be processed exclusively on this server.
...
This online service uses Stripe for the administration of user- and subscription data, for billing, and the processing of payments. The provider for customers within the European Union is Stripe Payments Europe, Ltd., 1 Grand Canal Street Lower, Grand Canal Dock, Dublin, Ireland (Stripe).
...
More information about the functions of Stripe can be found at https://stripe.com/en-de/use-cases/saas.

You can find the privacy policy of Stripe at https://stripe.com/en-de/privacy.
...
We use the web meeting and remote access software TeamViewer. The provider is TeamViewer Germany GmbH, Jahnstraße 30, 73037 Göppingen, Germany (TeamViewer). You can find more details about data processing in the TeamViewer privacy policy at https://www.teamviewer.com/en/privacy-policy/.
...
We installed the 3CX phone system on our own server. When you communicate with us via 3CX, all data related to this communication activity are processed on this server.
