    ...
    - name: faq
      ...
      items:
          ...
          - q: 'What advantages does SeaTable offer as software for my applicant management?'
            a: 'The [AI no-code platform SeaTable]({{< relref "/" >}}) is an impressive applicant management software in many respects – especially due to its exceptional flexibility and adaptability. If you have been using an Excel template for your applicant management, you will appreciate SeaTable as an applicant management tool. As an [alternative to Excel]({{< relref "pages/excel-alternative" >}}), SeaTable offers advantages as applicant tracking software, such as more efficient organization and overview, and automated processes.'
