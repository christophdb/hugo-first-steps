...
aliases:
  - '/pt/about-us'
seo:
    title: 'Sobre nós: Dados eficientes, equipes fortes'
    description: 'Ajudamos empresas a otimizar dados e processos com soluções low-code inovadoras para impulsionar a rotina de trabalho.'
...
sections:
    ...
    - name: content-4
      ...
      items:
          - icon: 'leaf'
            ...
            text: 'Com a nossa solução em nuvem, equipas e empresas podem organizar os seus dados e informações de forma mais eficiente em minutos e sem conhecimentos técnicos.'
          - icon: 'terminal'
            headline: 'Controlo'
            text: 'Com a variante auto-hospedada, oferecemos uma saída à dependência. Assuma o controlo total dos seus dados e processos.'
          - icon: 'graduation-cap'
            headline: 'Inovação'
            text: 'A nossa força de inovação leva-nos a desenvolver constantemente novas soluções e tecnologias para tornar os processos empresariais dos nossos clientes mais eficientes e preparados para o futuro.'
          - icon: 'wand-magic-sparkles'
            headline: 'Prestador de serviços'
            text: 'Oferecemos instalação, configuração, manutenção, formação e operação para empresas de todos os tamanhos. Com a nossa equipa, tem tudo numa única fonte.'
          - icon: 'chart-line'
            headline: 'Líder de mercado'
            text: 'O nosso objetivo é tornar-nos líderes de mercado europeus em soluções low-code. Trabalhamos todos os dias para concretizar esta ambição.'
          - icon: 'compass'
            headline: 'Valor acrescentado'
            text: 'Criamos valor real oferecendo soluções personalizadas, perfeitamente ajustadas às necessidades dos nossos clientes, garantindo o sucesso sustentável.'

    - name: content-15
      weight: 4
      title: Sucesso mensurável, resultados comprovados
      subtitle: Estatísticas impressionantes
      description: Atribuímos grande importância à obtenção de resultados sustentáveis e tangíveis para os nossos clientes. Através da inovação contínua e da otimização consistente das nossas soluções, criamos um valor acrescentado real que compensa a longo prazo. <br><br>O nosso objetivo não é apenas possibilitar sucessos a curto prazo, mas também construir uma parceria de confiança baseada na qualidade, fiabilidade e transparência. Deste modo, apoiamos os nossos clientes a alcançar os seus objetivos de forma mensurável e assegurar o seu sucesso a longo prazo.
      items:
          - number: '2020'
            text: Desde o início em
          - number: 40<span class="-mt-12 absolute text-3xl">+</span>
            text: Membros da equipa
          - number: 3
            text: Localizações
          ...
          - number: 99.9<span class="-mt-12 absolute text-3xl">%</span>
            text: Disponibilidade da nossa cloud
    ...
    - name: content-17
      ...
      items:
          ...
          - date: 05/2023
            text: <span class='gradient'>techcrunch</span> publica pela primeira vez sobre o SeaTable
