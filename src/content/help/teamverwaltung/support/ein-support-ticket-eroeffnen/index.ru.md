...
seo:
    ...
    description: 'Узнайте, как создать тикет поддержки с подпиской Plus или Enterprise, просматривать запросы и использовать систему тикетов.'
---
...
2. Выберите пункт меню **Поддержка** в **навигации**.
