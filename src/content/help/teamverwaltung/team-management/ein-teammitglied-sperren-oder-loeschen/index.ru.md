...
Что происходит с базой удаленного пользователя?|||

База попадает в корзину и может быть [восстановлена](https://seatable.io/ru/docs/historie-und-versionen/eine-geloeschte-base-wiederherstellen/) администратором команды.

---

Сохраняется ли у пользователей доступ к общим базам удаленного пользователя?|||

В момент удаления владельца базы, база **также удаляется для всех остальных**, у кого есть разрешение на выпуск. База попадает в корзину и может быть [восстановлена](https://seatable.io/ru/docs/historie-und-versionen/eine-geloeschte-base-wiederherstellen/) администратором.

---

Что происходит с группой, созданной удаленным пользователем?|||

Группа удаленного пользователя остается со всеми остальными членами.
