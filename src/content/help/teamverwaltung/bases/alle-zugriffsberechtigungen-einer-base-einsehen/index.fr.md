...
Dans la **gestion d'équipe**, vous pouvez voir toutes les **autorisations d'accès** pour une base afin de garder une vue d'ensemble sur les personnes qui peuvent voir ou modifier les données.
