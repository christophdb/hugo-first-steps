---
title: 'Descontos para instituições públicas, associações de beneficência, organizações sem fins lucrativos ou instituições de ensino'
date: 2023-01-13
lastmod: '2024-04-11'
categories:
    - 'abo-abrechnung'
...
Se ainda não registou uma equipa em cloud.seatable.io, comece por [se registar](https://seatable.io/pt/docs/erste-schritte/registrierung-login/). Crie sempre primeiro uma equipa com a [subscrição](https://seatable.io/pt/docs/abo-abrechnung/abo-pakete/) gratuita. Depois, proceda da seguinte forma:
...
![Pedir um desconto através da administração da equipa](https://seatable.io/wp-content/uploads/2023/01/Antrag-auf-Rabatt-in-SeaTable.png)

5. Preencher o **formulário** e clicar em **Enviar candidatura**.

## Aguardar por feedback

Por favor, dê-nos um ou dois dias para verificar o seu pedido. Um representante da SeaTable entrará então em contacto consigo. Se lhe concedermos o desconto, pode simplesmente atualizar a sua conta através da administração da equipa e o desconto será aplicado imediatamente.
