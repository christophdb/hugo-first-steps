...
author: 'cdb'
url: '/ru/help/die-funktionen-der-teamverwaltung-in-der-uebersicht'
---
...
В админке команды вы можете видеть все **базы** членов вашей команды и отслеживать, кто к каким базам имеет **доступ**. Кроме того, вы можете отслеживать и ограничивать отправленные [пригласительные](https://seatable.io/ru/docs/freigabelinks/einladungs-link-erklaert/) ссылки и [внешние ссылки](https://seatable.io/ru/docs/freigabelinks/externer-link-erklaert/), а также видеть, предоставляют ли ссылки доступ на чтение или запись, и как часто к ним обращались.
