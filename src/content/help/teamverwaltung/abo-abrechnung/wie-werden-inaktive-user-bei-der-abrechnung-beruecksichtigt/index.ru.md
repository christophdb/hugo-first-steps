...
![Деактивируйте неактивных пользователей через вкладку "Команда" в администрации команды](https://seatable.io/wp-content/uploads/2023/01/deactivate-user.png)

Деактивированные пользователи всегда отображаются в обзоре команды на вкладке **Команда** с красной пометкой **Неактивен**.

![Деактивированных пользователей всегда можно узнать в обзоре команды по красной надписи "неактивен".](https://seatable.io/wp-content/uploads/2023/01/inactive-user.png)

Неактивные пользователи **не** требуют **лицензии** и не увеличивают общее количество забронированных пользователей.

![Неактивные пользователи не влияют на общее количество забронированных пользователей](https://seatable.io/wp-content/uploads/2023/01/inactive-users-dont-count.png)
