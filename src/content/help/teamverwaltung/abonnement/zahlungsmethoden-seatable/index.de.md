...
![In der Teamverwaltung können Sie Ihre hinterlegte Kreditkarte einsehen, verändern und löschen.](images/payment-method.png)
...
Wie und unter welchen Vorraussetzungen Sie die **Bezahlung auf Rechnung** aktivieren können, erfahren Sie in diesem [Artikel]({{< relref "help/teamverwaltung/abonnement/bezahlung-per-rechnung" >}}).
