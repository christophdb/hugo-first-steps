...
categories:
    - 'abo-abrechnung'
author: 'nsc2'
url: '/fr/aide/seatable-gratuit-essai-plus-ou-enterprise'
aliases:
    - '/fr/aide/ist-seatable-kostenlos-kann-ich-das-plus-oder-enterprise-abo-testen'
seo:
    title: 'SeaTable gratuit ? Essayez Plus ou Enterprise gratuitement'
    description: 'SeaTable Cloud existe en version gratuite ! Essayez Plus ou Enterprise 30 jours sans carte bancaire – simplicité, sécurité, flexibilité.'
...
En principe, nous offrons aux entreprises la possibilité d'essayer SeaTable Enterprise gratuitement pendant 30 jours afin de pouvoir tester par elles-mêmes les fonctions supplémentaires. Pour une telle demande, nous proposons un formulaire correspondant dans la [section Abonnement](https://account.seatable.com/subscription) de [l'administration d'équipe](https://account.seatable.com/subscription).

![Essayer SeaTable Enterprise pendant 30 jours](images/try-seatable-enterprise.png)
