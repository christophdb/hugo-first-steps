---
title: 'O SeaTable é gratuito? Posso testar a subscrição Plus ou Enterprise?'
date: 2023-01-13
lastmod: '2023-03-22'
categories:
    - 'abo-abrechnung'
author: 'nsc2'
url: '/pt/ajuda/seatable-gratis-posso-testar-plus-ou-enterprise'
aliases:
    - '/pt/ajuda/ist-seatable-kostenlos-kann-ich-das-plus-oder-enterprise-abo-testen'
seo:
    title: 'SeaTable é gratuito? Experimente Plus e Enterprise grátis'
    description: 'SeaTable Cloud tem versão gratuita! Teste Plus ou Enterprise 30 dias, sem cartão, uso seguro, acesso completo e experiência flexível.'
...
- Crie tantas bases quantas quiser e trabalhe em conjunto sobre os seus dados.
- Definir pontos de vista para permitir a cada membro da equipa trabalhar de forma óptima.
- Utilize os nossos plugins para visualizar os seus dados.
- Partilhe o seu trabalho com outros usando um link de partilha.
...
Em princípio, oferecemos às empresas a possibilidade de testar gratuitamente o SeaTable Enterprise durante 30 dias, a fim de poderem testar elas próprias as funções adicionais. Para tal pedido, oferecemos um formulário correspondente na [administração da equipa na secção de subscrição](https://account.seatable.com/subscription).
