---
title: "Aperçu des fonctions de l'administration d'équipe"
date: 2022-10-21
lastmod: '2023-02-14'
categories:
...
Une équipe peut avoir plusieurs administrateurs, qui ont alors accès aux domaines suivants dans l'administration d'équipe :
...
- [Groupes et leurs membres dans l'administration d'équipe]({{< relref "help/teamverwaltung/team/gruppen-und-ihre-mitglieder-in-der-teamverwaltung" >}})
...
- [Bases dans l'administration d'équipe]({{< relref "help/teamverwaltung/bases/bases-in-der-teamverwaltung" >}})
...
En supprimant toute votre équipe dans l'administration d'équipe, **vous résiliez automatiquement votre contrat** avec SeaTable.
...
Grâce à l'administration d'équipe, vous avez la possibilité de créer un **ticket d'assistance** pour des questions spécifiques. SeaTable peut ainsi vous fournir des réponses personnalisées à vos préoccupations.
...
Dans l'administration d'équipe, vous trouverez l'option de recevoir un **contrat AV** personnalisé ainsi que de consulter **des documents juridiques** généraux.
