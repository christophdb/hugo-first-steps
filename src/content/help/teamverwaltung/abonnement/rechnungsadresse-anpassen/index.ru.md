...
{{< warning  headline="Важное замечание"  text="Адрес для выставления счетов вашей команды может быть изменен только **администраторами команды**." />}}

1. Откройте **Управление командой**. 
2. Нажмите **Подписка**. 
3. Нажмите **"Настроить данные для счета"**.
    ![Изменить адрес для счета](images/change-invoice-address.png)

4. Сохраните **новый** адрес для счета. 
