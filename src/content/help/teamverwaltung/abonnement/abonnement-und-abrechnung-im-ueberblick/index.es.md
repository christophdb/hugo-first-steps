...
[Más información sobre la suscripción gratuita y cómo probar la suscripción Plus o Enterprise.]({{< relref "help/teamverwaltung/abonnement/ist-seatable-kostenlos-kann-ich-das-plus-oder-enterprise-abo-testen" >}})
...
[Más información sobre los distintos paquetes de suscripción de SeaTable.]({{< relref "help/teamverwaltung/abonnement/abonnement-und-abrechnung-im-ueberblick" >}})
...
[Más información sobre las funciones y posibilidades de la gestión de suscripciones.]({{< relref "help/teamverwaltung/abonnement/abonnement-und-abrechnung-im-ueberblick" >}})
...
[Más información sobre la suscripción Plus o Enterprise]({{< relref "help/teamverwaltung/abonnement/plus-oder-enterprise-abonnement-buchen" >}}).
...
[Más información sobre cómo cambiar su suscripción actual]({{< relref "help/teamverwaltung/abonnement/aktuelles-abo-aendern-paket-laufzeit-und-teamgroesse-anpassen" >}}).
...
[Más información sobre los métodos de pago disponibles]({{< relref "help/teamverwaltung/abonnement/zahlungsmethoden-seatable" >}}).
...
[Más información sobre el pago por factura]({{< relref "help/teamverwaltung/abonnement/bezahlung-per-rechnung" >}}).
...
Más información [sobre la personalización de la dirección de facturación]({{< relref "help/teamverwaltung/abonnement/rechnungsadresse-anpassen" >}}).
...
[Más información sobre cómo recuperar sus facturas]({{< relref "help/teamverwaltung/abonnement/wo-finde-ich-meine-rechnungen" >}}).

## Descargar facturas

Si necesita sus facturas en formato PDF, puede descargarlas en cualquier momento a través de la administración del equipo.

Más información [sobre cómo descargar sus facturas]({{< relref "help/teamverwaltung/abonnement/wo-finde-ich-meine-rechnungen" >}}).
...
Más información [sobre cómo cambiar de tarjeta de crédito]({{< relref "help/teamverwaltung/abonnement/aendern-der-kreditkarte" >}}).
...
Más información [sobre el depósito de un NIF]({{< relref "help/teamverwaltung/abonnement/hinterlegen-der-steuer-id" >}}).
...
[Más información sobre cómo influyen los miembros del equipo en los costes de suscripción]({{< relref "help/teamverwaltung/abonnement/wie-teammitglieder-die-abonnementkosten-beeinflussen" >}}).
...
Más información [sobre cómo se tienen en cuenta los usuarios inactivos en la facturación]({{< relref "help/teamverwaltung/abonnement/wie-werden-inaktive-user-bei-der-abrechnung-beruecksichtigt" >}}).
...
Más información [sobre el acceso de lectura a tus datos cuando superas los límites de tu suscripción]({{< relref "help/teamverwaltung/abonnement/was-tun-wenn-man-die-abo-limits-ueberschritten-hat" >}}).
...
[Más información sobre lo que puede hacer si supera sus límites de suscripción]({{< relref "help/teamverwaltung/abonnement/was-tun-wenn-man-die-abo-limits-ueberschritten-hat" >}}).
...
Más información [sobre la cancelación de la suscripción]({{< relref "help/teamverwaltung/abonnement/das-abo-kuendigen" >}}).
...
[Más información sobre las consecuencias para tus datos si eliminas tu equipo]({{< relref "help/teamverwaltung/abonnement/das-komplette-team-loeschen" >}}).
