...
seo:
    ...
    description: 'Узнайте, какие требования необходимо выполнить для использования SSO в SeaTable Cloud. Обзор типов подписок, поддерживаемых протоколов и технических условий для беспроблемной интеграции.'
weight: 2
---
