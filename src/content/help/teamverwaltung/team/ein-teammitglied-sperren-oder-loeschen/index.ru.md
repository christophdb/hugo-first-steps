...
{{< faq "Что происходит с базой удаленного пользователя?" >}}База попадает в корзину и может быть [восстановлена]({{< relref "help/base-editor/historie-und-versionen/eine-geloeschte-base-wiederherstellen" >}}) администратором команды.
{{< /faq >}}
{{< faq "Сохраняется ли у пользователей доступ к общим базам удаленного пользователя?" >}}В момент удаления владельца базы, база **также удаляется для всех остальных**, у кого есть разрешение на выпуск. База попадает в корзину и может быть [восстановлена]({{< relref "help/base-editor/historie-und-versionen/eine-geloeschte-base-wiederherstellen" >}}) администратором.
{{< /faq >}}
