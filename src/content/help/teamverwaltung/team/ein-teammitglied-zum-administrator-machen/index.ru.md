...
Каждый администратор команды получает **полный доступ к** управлению командой и имеет **одинаковые права**. Для подробного обзора всех функций администрации команды, пожалуйста, прочитайте статью [Функции администрации команды в обзоре](https://seatable.io/ru/docs/teamverwaltung/die-funktionen-der-teamverwaltung-in-der-uebersicht/).
