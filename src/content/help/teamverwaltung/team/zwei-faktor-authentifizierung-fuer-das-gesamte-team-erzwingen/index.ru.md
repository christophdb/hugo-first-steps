...
2. Нажмите на опцию **Команда** и выберите **Настройки**.
    ![Принудительно включить двухфакторную аутентификацию для всей команды](images/open-settings.png)

3. Включите флажок **Принудительно включить 2FA для всех участников команды**.
    ![Принудительно включить двухфакторную аутентификацию для всей команды](images/enforce-2fa-for-all-users.png)

4. Нажмите на **Сохранить настройки**.
