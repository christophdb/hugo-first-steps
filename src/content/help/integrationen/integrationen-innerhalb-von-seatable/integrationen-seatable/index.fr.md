...
seo:
    ...
    description: 'Interconnectez SeaTable avec tous vos outils : API REST, webhooks, scripts, email, Zapier, Make, plugins et automatisations. Tout votre écosystème synchronisé!'
---
