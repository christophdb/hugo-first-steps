...
seo:
    ...
    description: 'Descubre cómo conectar SeaTable con cientos de apps: API REST, webhooks, scripts, email, Zapier, Make, plugins y mucho más – automatiza tu flujo de datos.'
---
