...
After that, you can use the email account created in your SeaTable Base to send emails via [automation](https://seatable.io/en/docs/beispiel-automationen/e-mail-versand-per-automation/) or [button.](https://seatable.io/en/docs/andere-spalten/eine-e-mail-per-schaltflaeche-verschicken/)
