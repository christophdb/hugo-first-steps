...
Pode então utilizar a conta de correio electrónico criada no seu SeaTable Base para enviar mensagens de correio electrónico através de [automação](https://seatable.io/pt/docs/beispiel-automationen/e-mail-versand-per-automation/) ou [botão](https://seatable.io/pt/docs/andere-spalten/eine-e-mail-per-schaltflaeche-verschicken/).
