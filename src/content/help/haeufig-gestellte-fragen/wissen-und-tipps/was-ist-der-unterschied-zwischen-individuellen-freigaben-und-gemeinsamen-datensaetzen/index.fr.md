...
Contrairement aux partages individuels, les jeux de données communs représentent une **table maîtresse** dont le contenu est utilisé dans d'autres tables. Les membres de votre équipe peuvent adapter à tout moment les **dérivés** de la table maîtresse, de sorte qu'ils puissent utiliser les données du jeu de données commun dans les contextes les plus divers.
