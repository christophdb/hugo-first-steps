...
Die Ausgabe des Skripts liefert zum Beispiel das folgende Ergebnis, welches Sie dann kopieren und für einen **Eintrag im Forum** oder für ein [Support-Ticket]({{< relref "help/teamverwaltung/support/ein-support-ticket-eroeffnen" >}}) verwenden können.
