...
seo:
    ...
    description: 'In SeaTable you can share entire bases or individual views. Learn benefits, sharing targets and options for full or limited access.'
...
If you don't want to share a whole base, but only parts of it, that is of course also possible. [Custom sharing]({{< relref "help/startseite/freigaben/benutzerdefinierte-freigabe-erstellen" >}}) allows you to share multiple tables and views at once and send them bundled to team members or whole groups.
