...
2. [Перейдите на подписку](https://seatable.io/ru/docs/abo-abrechnung/aktuelles-abo-aendern-paket-laufzeit-und-teamgroesse-anpassen/#aktuelles_abo_anpassen), которая предоставляет вам более высокие лимиты.
   {{< warning headline="Подписки" text="Подробный обзор всех доступных **подписок**, а также функций, опций и лимитов, доступных для вас в рамках этих подписок, можно найти на [странице с ценами](https://seatable.io/ru/preise/)." />}}
