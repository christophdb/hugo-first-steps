...
{{< warning headline="Дополнительная информация" text="Более подробную информацию и конкретные указания по использованию общих наборов данных можно найти [здесь](https://seatable.io/ru/docs/gemeinsame-datensaetze/funktionsweise-von-gemeinsamen-datensaetzen/)." />}}
