...
categories:
    - 'erste-schritte'
author: 'cdb'
url: '/es/ayuda/obtener-soporte-seatable'
aliases:
    - '/es/ayuda/hilfe-bekommen'
seo:
    title: 'SeaTable soporte: contacto, comunidad, expertos y recursos de ayuda explicados'
    description: 'Todos los servicios de ayuda de SeaTable: manual, foro de comunidad, tickets de soporte, YouTube, ayuda experta y noticias.'
---
...
Si no encuentra lo que busca en el manual de usuario, puede publicar su pregunta en el [foro de la comunidad SeaTable](https://forum.seatable.com). Describa su situación actual, qué problema tiene y qué ha hecho para resolverlo. Además de la activa comunidad, el personal de SeaTable también consulta regularmente el foro para responder a las preguntas abiertas.
...
- [Abra un ticket de soporte]({{< relref "help/teamverwaltung/support/ein-support-ticket-eroeffnen" >}}).
...
- También publicamos regularmente pequeños tutoriales para problemas típicos en nuestro foro [de la comunidad](https://forum.seatable.com). Busca en el foro el término **tutorial** y encontrarás varias pequeñas ayudas.
...
{{< /faq >}}
{{< faq "¿Puedo contactar con el soporte de SeaTable sin tener una cuenta SeaTable?" >}}No. Para contactar con el soporte de SeaTable, necesita una suscripción Plus o Enterprise. Por supuesto, siempre puede ponerse en contacto con nuestro [equipo de ventas](mailto:sales@seatable.com).
