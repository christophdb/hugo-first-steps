...
La navegación de la izquierda de la página de inicio contiene enlaces a varias secciones y recursos cómo [Bases]({{< relref "help/startseite/bases" >}}) y [Papelera]({{< relref "help/startseite/papierkorb" >}}). También encontrará enlaces a esta guía del usuario y a las [plantillas]({{< relref "templates" >}}) disponibles en SeaTable.
