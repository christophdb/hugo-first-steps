...
The left side navigation of the Home page contains links to various sections and resources like [bases]({{< relref "help/startseite/bases" >}}) and [Trash]({{< relref "help/startseite/papierkorb" >}}). You will also find links to this User Guide and the [templates]({{< relref "templates" >}}) available to you within SeaTable.
