...
Совместное использование не ограничивается другими пользователями SeaTable: Вы также можете делиться данными с помощью [внешних ссылок]({{< relref "help/startseite/freigaben/externer-link-erklaert" >}}) или [приглашать](https://seatable.io/ru/docs/freigaben/einladungs-link-erklaert/) людей, не имеющих учетной записи SeaTable, к сотрудничеству непосредственно в SeaTable.
