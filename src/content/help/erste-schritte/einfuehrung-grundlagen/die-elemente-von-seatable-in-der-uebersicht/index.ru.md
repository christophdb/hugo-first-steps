...
Если столбец является [столбцом чисел]({{< relref "help/base-editor/numerische-spalten/die-zahlen-spalte" >}}), вы также можете хранить в нем только числа. SeaTable знает множество различных типов столбцов, поэтому вы можете записывать любые данные.
