...
If a column is a [number column]({{< relref "help/base-editor/numerische-spalten/die-zahlen-spalte" >}}), you can also store only numbers in that column. SeaTable knows a lot of different column types, so you can capture all the data you want.
