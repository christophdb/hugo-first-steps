...
categories:
    - 'kurzanleitungen'
author: 'cdb'
url: '/es/ayuda/elementos-principales-de-seatable'
aliases:
    - '/es/ayuda/die-elemente-von-seatable-in-der-uebersicht'
seo:
    title: 'Elementos principales de SeaTable: vista general'
    description: 'Conozca los elementos clave de SeaTable: bases, tablas, columnas, vistas, plugins, grupos, permisos y gestión de equipos fácilmente.'
...
[Más información sobre las tablas →]({{< relref "help/erste-schritte/einfuehrung-funktionen/einfuehrung-in-die-arbeit-mit-bases-und-tabellen" >}})
...
[Más información sobre plugins →]({{< relref "help/base-editor/plugins/alle-plugins-in-der-uebersicht" >}})
...
[Más información sobre grupos aquí →]({{< relref "help/startseite/gruppen/einfuehrung-in-die-arbeit-mit-gruppen" >}})

### Autorizaciones

[Obtén más información sobre los permisos en un grupo →]({{< relref "help/startseite/gruppen/berechtigungen-in-einer-gruppe-vergeben" >}})
...
[Más información sobre la colaboración SeaTable →]({{< relref "help/erste-schritte/einfuehrung-funktionen/zusammenarbeit" >}})
...
[Más información sobre la gestión de equipos →]({{< relref "help/teamverwaltung/abonnement/die-funktionen-der-teamverwaltung-in-der-uebersicht" >}})
...
[Más información sobre suscripción y facturación →]({{< relref "help/teamverwaltung/abonnement/abonnement-und-abrechnung-im-ueberblick" >}})
