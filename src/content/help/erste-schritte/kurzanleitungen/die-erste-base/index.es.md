...
En SeaTable usted organiza sus datos en [bases](https://seatable.io/es/docs/arbeiten-mit-bases/bases/). Una base es un contenedor para una o varias tablas. Las tablas de una base pueden ser independientes entre sí o, como en una base de datos, estar vinculadas mediante relaciones.

También puedes [compartir](https://seatable.io/es/docs/freigaben/base-und-ansichtsfreigaben-im-ueberblick/) tus [bases](https://seatable.io/es/docs/freigaben/base-und-ansichtsfreigaben-im-ueberblick/) con otros miembros del equipo o [invitar a](https://seatable.io/es/docs/freigaben/unterschiede-zwischen-einladungs-links-und-externen-links/) terceros externos a trabajar en ellas juntos.
...
Después de iniciar sesión, te encontrarás en la página de **inicio**. Aquí puede gestionar sus bases. Si ha seleccionado [plantillas](/es/docs/handbuch/templates/) durante el registro, se mostrarán aquí.
...
Con el icono del lápiz, puedes cambiar el nombre de la base y asignarle un icono y un color diferentes. Las funciones avanzadas incluyen, por ejemplo, [compartir](https://seatable.io/es/docs/freigaben/base-und-ansichtsfreigaben-im-ueberblick/) una base o [exportarla](https://seatable.io/es/docs/import-von-daten/datenimport-und-export/). Para abrir la base, haz clic en su nombre.

## Vista de la tabla

La nueva Base contiene una [tabla](https://seatable.io/es/docs/seatable-nutzen/einfuehrung-in-die-arbeit-mit-bases-und-tabellen/) desde el principio. La vista de tabla es la [vista](/es/docs/handbuch/datenmanagement/ansichten/) central, pero no la única [, de](/es/docs/handbuch/datenmanagement/ansichten/) SeaTable. En la vista de tabla usted gestiona las tablas de la base, define su estructura de columnas e introduce o analiza sus datos.

Antes de [introducir los datos](https://seatable.io/es/docs/seatable-nutzen/datenerfassung/), hay que definir la estructura de la tabla. La estructura de columnas determina los tipos de datos que se pueden introducir en la tabla, las opciones de vista y el comportamiento de los campos en [los formularios web](https://seatable.io/es/docs/webformulare/webformulare/).

SeaTable ofrece un total de [más de 20 tipos de columnas](https://seatable.io/es/docs/arbeiten-mit-spalten/uebersicht-alle-spaltentypen/). Probablemente ya esté familiarizado con las columnas de texto, números y fechas de las hojas de cálculo convencionales. Por supuesto, SeaTable también las conoce. Además, SeaTable ofrece columnas para [imágenes y archivos](https://seatable.io/es/docs/dateien-und-bilder/unterschiede-zwischen-bild-und-datei-spalte/), para [texto formateado](https://seatable.io/es/docs/text-und-zahlen/die-spalten-text-und-formatierter-text/), para [botones](https://seatable.io/es/docs/andere-spalten/die-schaltflaeche/) y [casillas de verificación](https://seatable.io/es/docs/auswahlspalten/anlegen-einer-checkbox-spalte/), así como [campos de selección](https://seatable.io/es/docs/auswahlspalten/die-mehrfachauswahl-spalte/) [simple](https://seatable.io/es/docs/auswahlspalten/anlegen-einer-einfachauswahl-spalte/) y [múltiple](https://seatable.io/es/docs/auswahlspalten/die-mehrfachauswahl-spalte/).
