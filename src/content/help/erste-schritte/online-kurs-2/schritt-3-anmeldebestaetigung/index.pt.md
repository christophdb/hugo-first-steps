...
- [O botão](https://seatable.io/pt/docs/andere-spalten/die-schaltflaeche/)
- [Envio de um e-mail por botão](https://seatable.io/pt/docs/andere-spalten/eine-e-mail-per-schaltflaeche-verschicken/)
- [Correio eletrónico através de automatização](https://seatable.io/pt/docs/beispiel-automationen/e-mail-versand-per-automation/)
