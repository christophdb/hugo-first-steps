...
- [Enviar un correo electrónico mediante un botón](https://seatable.io/es/docs/andere-spalten/eine-e-mail-per-schaltflaeche-verschicken/)
- [Correo electrónico automatizado](https://seatable.io/es/docs/beispiel-automationen/e-mail-versand-per-automation/)
