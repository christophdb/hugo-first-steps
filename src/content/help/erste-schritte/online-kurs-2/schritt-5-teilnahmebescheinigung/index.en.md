...
- [Instructions for the page design plugin](https://seatable.io/en/docs/seitendesign-plugin/anleitung-zum-seitendesign-plugin/)
...
- [The file column](https://seatable.io/en/docs/dateien-und-bilder/die-datei-spalte/)
