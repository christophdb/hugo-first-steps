...
[Les formulaires web]({{< relref "help/base-editor/webformulare/webformulare" >}}) sont le moyen par excellence de faire saisir de nouveaux enregistrements dans un tableau non pas **par vous-même**, mais par des **personnes au sein ou en dehors de votre équipe**. Cela semble trop beau pour être vrai ? Alors essayez-le tout de suite !
