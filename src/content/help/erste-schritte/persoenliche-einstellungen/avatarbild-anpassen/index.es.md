...
Una imagen de avatar es útil para que otros miembros del equipo puedan identificarle rápidamente en SeaTable, ya que la imagen también se muestra como una miniatura en [las columnas de](https://seatable.io/es/docs/datum-dauer-und-personen/die-spalten-letzter-bearbeiter-und-zuletzt-bearbeitet/) [personal](https://seatable.io/es/docs/datum-dauer-und-personen/die-spalte-mitarbeiter/), [creador](https://seatable.io/es/docs/datum-dauer-und-personen/die-spalten-ersteller-und-erstellt/) y [último editor](https://seatable.io/es/docs/datum-dauer-und-personen/die-spalten-letzter-bearbeiter-und-zuletzt-bearbeitet/), por ejemplo, y delante de su nombre en los recursos compartidos.
