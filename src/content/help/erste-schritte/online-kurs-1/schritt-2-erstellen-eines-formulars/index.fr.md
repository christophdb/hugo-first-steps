...
- [Les formulaires web en général](https://seatable.io/fr/docs/webformulare/webformulare/)
- [Créer un formulaire web](https://seatable.io/fr/docs/webformulare/anlegen-eines-webformulars/)
