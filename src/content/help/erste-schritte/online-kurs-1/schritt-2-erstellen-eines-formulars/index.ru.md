...
![Управление формами с кнопкой «Forms» и новым веб-формуляром](images/level1-create-webform.png)
...
![Веб-форма «Expense Tracking» с полями Reason, Date, Amount, Category](images/level1-webform.png)
