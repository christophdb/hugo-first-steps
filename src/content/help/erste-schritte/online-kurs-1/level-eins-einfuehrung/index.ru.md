...
1. **SeaTable**: Вы можете использовать любую систему SeaTable. Проще всего это сделать с помощью [бесплатной учетной записи SeaTable Cloud](https://seatable.io/ru/registrierung/).
2. **Форум**: [Учетная запись на форуме нашего сообщества](https://forum.seatable.io/), если вы хотите получить значок после успешного завершения.
...
- Если вы успешно пройдете это испытание, то получите [значок для своего профиля на форуме](https://forum.seatable.io/badges/106/completed-seatable-course-level-1). Этот значок будет виден каждый раз, когда вы отвечаете на форуме, и будет подчеркивать ваши навыки для всех остальных пользователей.
