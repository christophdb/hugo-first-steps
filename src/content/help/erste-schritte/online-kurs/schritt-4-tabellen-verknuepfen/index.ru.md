...
1. Вы можете назначить запись в `Expenses` Выберите строку из таблицы вручную `Categories` щелкнув в ячейке на {{< keyboard "+" >}} а затем выберите соответствующую категорию. Это быстро становится утомительным и приводит к ошибкам при работе с большими объемами данных.  
