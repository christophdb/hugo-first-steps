...
[Cree una primera base](https://seatable.io/es/docs/arbeiten-mit-bases/eine-neue-base-erstellen/) y empiece simplemente creando los [tipos de columna](https://seatable.io/es/docs/arbeiten-mit-spalten/uebersicht-alle-spaltentypen/) adecuados en una tabla para toda la información de que disponga. Puedes hacer optimizaciones más adelante.
...
Otras fuentes son nuestro [canal de YouTube](https://www.youtube.com/seatable), donde publicamos muchos vídeos explicativos, y nuestro [blog SeaTable](/es/blog/), donde escribimos regularmente sobre nuevos casos de uso y soluciones.

## ¿Preguntas?

Si tienes preguntas o simplemente necesitas más información sobre determinadas funciones e integraciones: ¡echa un vistazo a nuestra [sección de ayuda](https://seatable.io/es/docs/)! Seguro que encuentras la respuesta a tus preguntas en más de 350 artículos.

También puede visitar el [foro de](https://forum.seatable.io) nuestra [comunidad](https://forum.seatable.io) y hacer una pregunta. Normalmente, todas las preguntas se responden en pocos días.
