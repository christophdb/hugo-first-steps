...
En este artículo te presentaremos estas tres posibilidades diferentes. El artículo asume que ya has [creado](https://seatable.io/es/docs/javascript-python/anlegen-und-loeschen-eines-skriptes/) un primer [script](https://seatable.io/es/docs/javascript-python/anlegen-und-loeschen-eines-skriptes/) en tu base, que en nuestro ejemplo no hace nada más que dar como salida _hola mundo_.
...
1. Crear una columna de tipo [Button](https://seatable.io/es/docs/andere-spalten/die-schaltflaeche/).
...
2. Haga clic en **Añadir Regla** y cree una nueva **automatización**. Puede encontrar información más detallada sobre cómo hacerlo [aquí](https://seatable.io/es/docs/automationen/anlegen-einer-automation/).
