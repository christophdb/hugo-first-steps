...
- **Invoked by** (указывает, как сценарий был запущен на выполнение - [вручную, через автоматизацию или через кнопку](https://seatable.io/ru/docs/javascript-python/skript-manuell-per-schaltflaeche-oder-automation-ausfuehren/))
