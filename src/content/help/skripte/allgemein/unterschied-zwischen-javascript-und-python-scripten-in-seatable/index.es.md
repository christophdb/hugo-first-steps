...
Puede encontrar más información y ejemplos sencillos de JavaScript en SeaTable en el [Manual del desarrollador de SeaTable](https://developer.seatable.io/scripts/javascript/basic_structure_js/).

## Python en SeaTable

El entorno Python de SeaTable es compatible con numerosas [bibliotecas Python conocidas](/es/unterstuetzte-python-bibliotheken/) y permite consultar servicios externos y API. Esto significa que incluso las tareas extensas y complejas se pueden completar con scripts de Python.
...
Puede encontrar más información sobre scripts Python en SeaTable en el [Manual del Desarrollador de SeaTable](https://developer.seatable.io/scripts/python/basic_structure_python/).
