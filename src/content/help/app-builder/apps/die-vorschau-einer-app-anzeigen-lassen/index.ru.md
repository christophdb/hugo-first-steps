---
title: "Показ предварительного просмотра приложения - SeaTable"
date: 2023-05-04
lastmod: "2024-07-15"
categories: 
  - "apps"
author: "nsc2"
url: "/ru/help/die-vorschau-einer-app-anzeigen-lassen"
---
...
1. Наведите курсор мыши на универсальное приложение и нажмите на появившийся **значок карандаша** {{< seatable-icon icon="dtable-icon-rename" >}}, чтобы открыть его в режиме редактирования.
