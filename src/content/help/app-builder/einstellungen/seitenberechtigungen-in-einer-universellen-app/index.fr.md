...
seo:
    title: 'Autorisations de pages dans App Universelle – guide'
    description: 'Gérez dans SeaTable les autorisations de pages d’une App Universelle : accès, rôles, droits d’ajout, de modification et de lecture.'
---
