...
![Modificar el nombre y el icono de una página en Universal Apps](images/Modify-name-and-icon-of-a-page-in-Universal-Apps.png)
...
![Página duplicada en Universal App](images/Duplicate-page-in-Universal-App.png)
...
![Eliminar página en Universal App](images/Delete-page-in-Universal-App.png)

## Mover página

Si ya ha creado una **carpeta** en su aplicación universal, puede mover sus páginas a esta carpeta utilizando los **tres puntos**.

![Mover página a carpeta en Universal Apps](images/Move-page-to-folder-in-Universal-Apps.png)
