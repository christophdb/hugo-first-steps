...
![Ajouter la page de l'application et remplir les détails](images/Add-app-page-and-fill-in-details.png)
...
![Déplacer les pages d'une application universelle par glisser-déposer](images/move-pages-via-drag-and-drop.gif)
...
![Ajouter un dossier à l'application universelle](images/Add-folder-in-Universal-Apps.png)

8. **Nommez** le dossier et choisissez éventuellement une **icône** appropriée pour celui-ci.

![Ajouter un nouveau dossier à l'application](images/Add-new-folder-to-app.png)
...
![Ajouter des pages à un dossier dans l'application universelle](images/add-page-via-folder-to-universal-app.png)
...
![Personnalisation du nom et de l'icône d'un dossier dans votre application universelle](images/modify-name-and-icon-of-a-folder-in-the-universal-app-new.png)
...
![Supprimer un dossier dans votre application universelle](images/delete-folder-in-your-universal-app-new.png)
...
![Déplacer des dossiers dans l'application universelle par glisser-déposer](images/move-folders-in-the-universal-app-via-drag-and-drop.gif)
