...
![Universal App Builder en mode édition avec liste d’apps ouverte](images/Apps-bearbeiten.png)

3. Cliquez en haut à gauche de la page sur {{< seatable-icon icon="dtable-icon-history" >}} **Gestion des versions**.

![Gestion des versions d’une application universelle avec liste des snapshots existants](images/Version-management-in-Universal-App-Builder.png)
...
![Aperçu d’une version enregistrée de l’application dans l’Universal App Builder](images/Preview-version-of-app-snapshot.png)
