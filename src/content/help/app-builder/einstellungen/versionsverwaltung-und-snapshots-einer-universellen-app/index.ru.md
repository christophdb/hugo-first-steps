...
![Universal App Builder в режиме редактирования с открытым списком приложений](images/Apps-bearbeiten.png)

3. Щелкните на {{< seatable-icon icon="dtable-icon-history" >}} **Управление версиями** в верхней левой части страницы.

![Управление версиями универсального приложения со списком созданных снимков](images/Version-management-in-Universal-App-Builder.png)
...
![Предпросмотр сохранённой версии приложения в Universal App Builder](images/Preview-version-of-app-snapshot.png)
