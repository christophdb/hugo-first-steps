...
В четвертом разделе вы можете решить, должен ли **список сотрудников** быть виден всем пользователям приложения. Затем вы можете ввести людей в [колонки сотрудников]({{< relref "help/base-editor/auswahl-spalten/die-spalte-mitarbeiter" >}}) или добавить их в [комментарии]({{< relref "help/base-editor/zeilen/zeilen-kommentieren" >}}). Если Вы хотите, чтобы Ваши сотрудники оставались невидимыми для других, Вам следует отключить эту функцию.
