...
![Ajouter une page app](https://seatable.io/wp-content/uploads/2023/05/Add-app-page.png)
...
![Ajouter une page d'application et sélectionner le type de page](https://seatable.io/wp-content/uploads/2023/05/Add-app-page-and-select-page-type.png)

10. Donnez un **nom** à la page, définissez le **tableau** sous-jacent et déterminez éventuellement une **icône** pour la page.

![Ajouter la page de l'application et remplir les détails](https://seatable.io/wp-content/uploads/2023/05/Add-app-page-and-fill-in-details.png)
...
![Modifier le nom et l'icône d'une page dans les applications universelles](images/Modify-name-and-icon-of-a-page-in-Universal-Apps.png)
...
![Page dupliquée dans l'application universelle](images/Duplicate-page-in-Universal-App.png)
...
![Supprimer la page dans l'application universelle](images/Delete-page-in-Universal-App.png)
...
![Déplacer une page vers un dossier dans Universal Apps](images/Move-page-to-folder-in-Universal-Apps.png)
...
![Déplacer les pages d'une application universelle par glisser-déposer](https://seatable.io/wp-content/uploads/2023/05/move-pages-via-drag-and-drop.gif)
...
![Ajouter un dossier à l'application universelle](https://seatable.io/wp-content/uploads/2023/05/Add-folder-in-Universal-Apps.png)

8. **Nommez** le dossier et choisissez éventuellement une **icône** appropriée pour celui-ci.

![Ajouter un nouveau dossier à l'application](https://seatable.io/wp-content/uploads/2023/05/Add-new-folder-to-app.png)
...
![Ajouter des pages à un dossier dans l'application universelle](https://seatable.io/wp-content/uploads/2023/05/add-page-via-folder-to-universal-app.png)
...
![Personnalisation du nom et de l'icône d'un dossier dans votre application universelle](https://seatable.io/wp-content/uploads/2023/05/modify-name-and-icon-of-a-folder-in-the-universal-app-new.png)
...
![Supprimer un dossier dans votre application universelle](https://seatable.io/wp-content/uploads/2023/05/delete-folder-in-your-universal-app-new.png)
...
![Déplacer des dossiers dans l'application universelle par glisser-déposer](https://seatable.io/wp-content/uploads/2023/05/move-folders-in-the-universal-app-via-drag-and-drop.gif)
