...
При удалении **приложения галереи** удаляются _только_ **галереи**, отображаемые в приложении, но **изображения** остаются в [колонках изображений]({{< relref "help/base-editor/spalten/die-bild-spalte" >}}) в таблицах.
