...
При удалении **приложения галереи** удаляются _только_ **галереи**, отображаемые в приложении, но **изображения** остаются в [колонках изображений]({{< relref "help/base-editor/dateien/die-bild-spalte" >}}) в таблицах.
