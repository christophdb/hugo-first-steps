...
Bei der Löschung einer **Galerie-App** werden _ausschließlich_ die in der App dargestellten **Galerien** gelöscht, die **Bilder** hingegen bleiben weiterhin in den [Bild-Spalten]({{< relref "help/base-editor/dateien/die-bild-spalte" >}}) Ihrer Tabellen erhalten.
