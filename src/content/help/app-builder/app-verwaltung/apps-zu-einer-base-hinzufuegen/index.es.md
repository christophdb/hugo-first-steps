...
categories:
    - 'apps'
author: 'nsc2'
url: '/es/ayuda/agregar-app-a-base'
aliases:
    - '/es/ayuda/apps-zu-einer-base-hinzufuegen'
seo:
    title: 'Añadir apps a tu base SeaTable – guía fácil y rápida'
    description: 'Aprende a agregar aplicaciones a tu base SeaTable, personaliza funciones para distintos equipos o tareas, todo desde el menú de Apps.'
star: true
weight: 2
---
...
{{< warning  headline="Autorización necesaria en el grupo"  text="Para poder crear una app, debes ser el **propietario** o **administrador del grupo** en el que se encuentra la **base** subyacente. **Los miembros** de un grupo simple sólo pueden ver y utilizar las apps existentes." />}}
...
![Ventana de diálogo para añadir aplicaciones](images/Add-App.png)
