...
seo:
    title: 'Страницы запросов в Универсальных приложениях'
    description: 'Ищите и фильтруйте большие наборы данных в универсальных приложениях SeaTable: задавайте фильтры, сортировки и поля запроса для своих результатов.'
