...
Однако после успешного запроса данных пользователи приложения могут нажимать на [кнопки]({{< relref "help/base-editor/schaltflaechen/die-schaltflaeche" >}}) в отображаемом списке, чтобы **выполнить** определенные **действия**.
