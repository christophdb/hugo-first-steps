...
![Настройки элементов поля таблицы на страницах с одной записью в универсальном приложении](images/Element-settings-of-a-table-field-on-Single-Record-Pages-in-the-Universal-App.png)
