---
title: 'Страницы форм в универсальных приложениях - SeaTable'
date: 2023-12-04
lastmod: '2025-02-26'
categories:
    - 'seitentypen-in-universellen-apps'
author: 'kgr'
url: '/ru/help/formularseiten-in-universellen-apps'
---
...
Используя **настройки страницы**, с которыми вы уже знакомы по [редактору веб-форм](https://seatable.io/ru/docs/webformulare/konfigurationsmoeglichkeiten-und-optische-anpassungen-eines-webformulars/), вы можете добавлять различные **элементы** и **поля** в веб-форму с помощью перетаскивания. Помимо **полей таблицы**, соответствующих столбцам выбранной таблицы, вы можете добавить **горизонтальные линии** и **аннотации**.
