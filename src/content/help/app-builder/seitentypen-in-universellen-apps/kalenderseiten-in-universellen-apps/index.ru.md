---
title: 'Страницы календаря в универсальных приложениях - SeaTable'
date: 2023-12-04
lastmod: '2025-02-26'
categories:
...
Этот тип страницы универсального приложения работает аналогично [плагину календаря](https://seatable.io/ru/docs/plugins/anleitung-zum-kalender-plugin/) в Base и позволяет отображать записи из одного или двух [столбцов даты](https://seatable.io/ru/docs/datum-dauer-und-personen/die-datum-spalte/) вашей таблицы в виде **календаря**. Конкретным вариантом использования может быть, например, отображение в календаре предстоящих **встреч**.
