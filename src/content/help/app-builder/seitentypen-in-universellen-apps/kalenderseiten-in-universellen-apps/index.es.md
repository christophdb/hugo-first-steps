---
title: 'Páginas de calendario en aplicaciones universales - SeaTable'
date: 2023-12-04
lastmod: '2025-02-26'
categories:
...
Este tipo de página de la aplicación universal funciona de forma similar al [complemento de calendario](https://seatable.io/es/docs/plugins/anleitung-zum-kalender-plugin/) de Base y permite mostrar las entradas de una o dos [columnas de fechas](https://seatable.io/es/docs/datum-dauer-und-personen/die-datum-spalte/) de la tabla en un **calendario**. Un caso de uso específico podría ser, por ejemplo, la visualización en el calendario de las próximas **reuniones**.
...
![Cambiar la configuración de la página de calendario](https://seatable.io/wp-content/uploads/2023/12/Einstellungen-auf-der-Kalenderseite-aendern.png)
...
![Añadir filtro en las páginas de calendario en Universal Apps](https://seatable.io/wp-content/uploads/2023/12/Add-filter-on-calendar-pages-in-Universal-Apps.png)
...
![Autorizaciones de página en páginas de calendario](https://seatable.io/wp-content/uploads/2023/12/Seitenberechtigungen-auf-Kalenderseiten.png)
