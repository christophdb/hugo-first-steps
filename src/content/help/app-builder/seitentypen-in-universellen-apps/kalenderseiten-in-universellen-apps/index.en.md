...
This page type of the Universal App works in a similar way to the [calendar plugin]({{< relref "help/base-editor/numerische-spalten/die-datum-spalte" >}}) of your table in a **calendar**. A specific use case could be, for example, the calendar display of upcoming **meetings**.
