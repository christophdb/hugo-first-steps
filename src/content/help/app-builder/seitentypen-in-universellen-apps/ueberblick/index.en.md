...
This page type works something like the [calendar plugin]({{< relref "help/base-editor/spalten/die-datum-spalte" >}}) your table in a **calendar**. For example, a concrete use case could be the calendar display of upcoming **meetings**.
