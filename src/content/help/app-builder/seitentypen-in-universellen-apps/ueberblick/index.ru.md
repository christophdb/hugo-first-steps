...
Этот тип страницы работает подобно [плагину календаря]({{< relref "help/base-editor/spaltentypen/die-datum-spalte" >}}) вашей таблицы в виде **календаря**. Конкретным примером использования может быть, например, отображение в календаре предстоящих **встреч**.
