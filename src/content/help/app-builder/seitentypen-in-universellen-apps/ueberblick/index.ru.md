...
Этот тип страницы работает подобно [плагину календаря]({{< relref "help/base-editor/spalten/die-datum-spalte" >}}die-datum-spalte/) вашей таблицы в виде **календаря**. Конкретным примером использования может быть, например, отображение в календаре предстоящих **встреч**.
