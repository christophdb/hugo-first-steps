...
categories:
    - 'universelle-apps'
author: 'nsc2'
url: '/es/ayuda/tipos-pagina-app-universal'
aliases:
...
Este tipo de página funciona de forma similar al [plugin de calendario]({{< relref "help/base-editor/spaltentypen/die-datum-spalte" >}}) su tabla en un **calendario**. Un caso de uso concreto podría ser, por ejemplo, la visualización en el calendario de las próximas **reuniones**.
