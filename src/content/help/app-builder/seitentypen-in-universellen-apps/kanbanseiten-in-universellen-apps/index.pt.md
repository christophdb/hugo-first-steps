...
![Páginas Kanban em aplicações universais](images/Kanbanseiten-in-Universellen-Apps.png)
...
![Definições de página da página Kanban em aplicações universais](images/Seiteneinstellungen-der-Kanbanseite-in-Universellen-Apps.png)
...
![Adicionar filtro às páginas kanban nas Aplicações Universais](images/Add-filter-on-kanban-pages-in-Universal-Apps.png)
...
![Ocultar colunas nas páginas da galeria em aplicações universais](images/Hide-columns-on-gallery-pages-in-Universal-Apps-1.png)
...
![Outras definições de página para a página Kanban em aplicações universais](images/Weitere-Seiteneinstellungen-der-Kanbanseite-in-Universellen-Apps.png)
...
Decida quem está autorizado a ver, adicionar, editar e eliminar a página Kanban. Graças às opções de autorização diferenciadas deste tipo de página, pode definir isto com precisão.
