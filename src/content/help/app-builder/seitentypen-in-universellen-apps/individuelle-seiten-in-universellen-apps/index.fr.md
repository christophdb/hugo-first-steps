...
Les éléments de texte formaté vous permettent, comme leur nom l'indique, de **formater des textes plus longs**. Pour cela, l'éditeur de texte que vous connaissez déjà du type de colonne [Texte formaté]({{< relref "help/base-editor/text-spalten/die-spalten-text-und-formatierter-text" >}}) s'ouvre.
