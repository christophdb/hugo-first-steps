...
author: 'kgr'
url: '/fr/aide/pages-individuelles-apps-universelles'
aliases:
    - '/fr/aide/individuelle-seiten-in-universellen-apps'
seo:
    title: 'Créez et personnalisez des pages individuelles dans les apps universelles SeaTable'
    description: 'Apprenez à concevoir des pages personnalisées avec textes, images, tableaux de bord et à configurer chaque élément dans vos apps universelles SeaTable.'
---
...
![Glisser-déposer des éléments sur des pages personnalisées](images/Drag-and-drop-elements-on-custom-pages.gif)
...
![Ajouter des textes sur des pages individuelles](images/Texte-auf-individuellen-Seiten-hinzufuegen.png)
...
![Paramètres des éléments pour les textes sur les pages individuelles](images/Elementeinstellungen-fuer-Texte-auf-individuellen-Seiten.png)
...
![Paramètres des éléments pour les textes formatés sur des pages individuelles](images/Elementeinstellungen-fuer-formatierte-Texte-auf-individuellen-Seiten.png)
...
![Paramètres des éléments pour les lignes sur les pages individuelles](images/Elementeinstellungen-fuer-Linien-auf-individuellen-Seiten.png)
...
![Ajouter une image sur une page individuelle](images/Bild-auf-individueller-Seite-hinzufuegen.gif)
...
![Paramètres des éléments pour les images sur les pages individuelles](images/Elementeinstellungen-fuer-Bilder-auf-individuellen-Seiten.png)
...
![Paramètres des éléments pour les conteneurs sur les pages individuelles](images/Elementeinstellungen-fuer-Container-auf-individuellen-Seiten.png)
...
![Paramètres des éléments pour les cartes sur les pages individuelles](images/Elementeinstellungen-fuer-Karten-auf-individuellen-Seiten.png)
...
![Paramètres de style pour les cartes sur les pages individuelles](images/Stileinstellungen-fuer-Karten-auf-individuellen-Seiten.png)
...
![Ajouter des statistiques sur des pages individuelles](images/Statistiken-auf-individuellen-Seiten-hinzufuegen.gif)
...
![Filtrer les données affichées par les statistiques](images/Angezeigte-Daten-von-Statistiken-filtern.png)
...
![Fonction "drill-down" pour les statistiques](images/Drill-down-Funktion-fuer-Statistiken.gif)
...
![Paramètres de données des statistiques sur les pages individuelles](images/Dateneinstellungen-von-Statistiken-auf-individuellen-Seiten.png)
...
![Paramètres de données Axe Y des statistiques sur les pages individuelles](images/Dateneinstellungen-Y-Achse-von-Statistiken-auf-individuellen-Seiten.png)
...
![Paramètres de style pour les diagrammes à colonnes sur des pages individuelles](images/Stileinstellungen-bei-Saeulendiagrammen-auf-individuellen-Seiten.gif)
...
![Paramètres de style pour les diagrammes à secteurs sur les pages individuelles](images/Stileinstellungen-bei-Kuchendiagrammen-auf-individuellen-Seiten.gif)
...
Sur les pages individuelles, il existe un type de statistiques particulier : le **tableau simple** permet - comme les [pages de tableaux]({{< relref "help/app-builder/seitentypen-in-universellen-apps/tabellenseiten-in-universellen-apps" >}}) - de présenter sous forme de tableau un ensemble de données préfiltrées et prétriées par l'administrateur de l'application. Contrairement à la page de tableau, il est donc possible de réunir **plusieurs tableaux** sur un même tableau de bord.
...
![Définir la couleur de fond de la page individuelle](images/Hintergrundfarbe-der-individuellen-Seite.png)
