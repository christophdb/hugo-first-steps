...
seo:
    title: 'Различия: пригласительная и внешняя ссылка – что выбрать в SeaTable?'
    description: 'Пригласительная ссылка vs внешняя ссылка в SeaTable: нужен ли аккаунт, какие права выдаются и когда что использовать.'
---
...
Вы можете отправить [внешнюю ссылку]({{< relref "help/startseite/freigaben/externer-link-erklaert" >}}) другим людям **без** необходимости иметь **учетную запись в SeaTable**. Таким образом, внешняя ссылка для базы — это **публичная ссылка**, предоставляющая **доступ на чтение** к базе. Вы также можете использовать внешнюю ссылку для встраивания базы в веб-страницу.
