...
seo:
    ...
    description: 'Enlace de invitación vs enlace externo en SeaTable: cuenta necesaria, permisos y usos recomendados para cada tipo de acceso.'
---

Ambos tipos de uso compartido le permiten colaborar con **personas externas** **sin añadirlas a su equipo**.

## Enlaces externos

Puede enviar un [enlace externo]({{< relref "help/startseite/freigaben/externer-link-erklaert" >}}) a otras personas **sin** que necesiten una **cuenta de SeaTable**. Un enlace externo para una base es, por tanto, un **enlace público** que concede **acceso de lectura** a una base. También puede utilizar un enlace externo para incrustar una base en una página web.
