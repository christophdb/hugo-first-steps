...
Everything else you should know about external links can be found in the article [Create external link for a base]({{< relref "help/startseite/freigaben/externer-link-erklaert" >}}).
...
1. Open a **view** you want to share.
2. In the view options, click **Share View** and then **External Link**.
3. If needed, set a custom or randomly generated **password**, an **expiration date** and a **description** for the link.
4. Choose whether you want to generate a **random URL** or set your own **custom URL**.
...
For example, this is what the integration of a table with press releases on a website could look like:
