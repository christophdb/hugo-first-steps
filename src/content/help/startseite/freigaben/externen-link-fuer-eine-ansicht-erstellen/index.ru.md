...
seo:
    title: 'Создать внешнюю ссылку для представления в SeaTable'
    description: 'Узнайте, как делиться представлением SeaTable с внешними пользователями через ссылку только для чтения. Защитите доступ паролем или сроком действия.'
---
...
Кроме того, доступны различные варианты, с помощью которых можно защитить внешнюю ссылку:
...
- Кроме того, вы можете установить любой **пароль** для внешней ссылки. Для получения доступа к представлению он должен быть правильно введен другим пользователем.
...
1. Откройте **представление**, к которому вы хотите предоставить общий доступ.
2. В опциях представления нажмите на **Поделиться представлением**, а затем на **Внешняя ссылка**.
3. При необходимости задайте для ссылки собственный или случайно сгенерированный **пароль**, **срок действия** и **описание**.
4. Выберите, хотите ли вы сгенерировать **случайный URL** или определить **собственный URL** самостоятельно.
5. Подтвердите нажатием на **Создать**.
...
Например, так может выглядеть интеграция таблицы с пресс-релизами на веб-сайте:
