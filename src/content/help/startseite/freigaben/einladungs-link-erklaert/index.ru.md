...
Администратор команды может глобально запретить использование ссылок‑приглашений в управлении командой. Ссылки всё ещё можно создавать, но при их открытии возникнет ошибка.

Подробнее см. статью [Разрешить доступ к базам через ссылку‑приглашение]({{< relref "help/teamverwaltung/bases/freigabe-von-bases-per-einladungslink-erlauben" >}}).
