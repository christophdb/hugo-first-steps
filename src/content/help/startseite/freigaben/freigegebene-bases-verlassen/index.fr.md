...
2. Déplacez le curseur de la souris sur la **base partagée avec vous** et cliquez sur les **trois points** qui apparaissent à droite {{< seatable-icon icon="dtable-icon-more-vertical" color="grey" >}}.
