...
External links are basically **public links**, i.e. the link can be accessed by anyone, regardless of whether they are logged into SeaTable or not. This is also one of the main [differences from the invitation link](https://seatable.io/en/docs/freigabelinks/unterschiede-zwischen-einladungs-links-und-externen-links/). An **invitation link** requires a login to SeaTable and thus a user account. Read more about this in the article [Creating an invitation link](https://seatable.io/en/docs/freigabelinks/einladungs-link-erklaert/).
