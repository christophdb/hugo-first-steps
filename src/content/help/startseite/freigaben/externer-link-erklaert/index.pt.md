...
As ligações externas são basicamente **ligações públicas**, ou seja, a ligação pode ser acedida por qualquer pessoa, independentemente de estarem ou não ligadas ao SeaTable. Esta é também uma das principais [diferenças em relação ao link do convite](https://seatable.io/pt/docs/freigabelinks/unterschiede-zwischen-einladungs-links-und-externen-links/). Um **link de convite** requer um login no SeaTable e, portanto, uma conta de utilizador. Leia mais sobre isto no artigo [Criar um link para convite](https://seatable.io/pt/docs/freigabelinks/einladungs-link-erklaert/).
