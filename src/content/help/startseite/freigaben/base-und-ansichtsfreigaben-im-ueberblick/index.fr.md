...
> Vous pouvez également obtenir un aperçu complet de tous les partages et liens vers une base sous [Bases dans l'administration d'équipe]({{< relref "help/teamverwaltung/bases/bases-in-der-teamverwaltung" >}}), si vous êtes administrateur d'équipe.
