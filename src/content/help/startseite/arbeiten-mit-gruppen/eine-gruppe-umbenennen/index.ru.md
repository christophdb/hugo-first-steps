...
![Переименование группы](https://seatable.io/wp-content/uploads/2022/09/rename-group.jpg)

5. Введите любое имя.
6. Подтвердите нажатием кнопки **Отправить**.

![Переименование группы](https://seatable.io/wp-content/uploads/2022/09/rename-group-2.png)
