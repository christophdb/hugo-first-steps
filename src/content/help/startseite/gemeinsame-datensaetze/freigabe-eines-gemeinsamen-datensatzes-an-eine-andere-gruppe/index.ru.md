...
![Совместное использование общей записи с другой группой](images/release-a-common-dataset-to-a-external-group-2.gif) 3. Откройте **стартовую** страницу SeaTable. 4. Перейдите на вкладку " **Общая запись"**. 5. Выберите запись общих данных, которую вы хотите **передать** другой группе. 6. Нажмите на **три точки** справа от соответствующей записи данных, а затем на **Управление доступом**. 7. Выберите **группу**, для которой будет выпущена запись. 8. Подтвердите освобождение, нажав на кнопку **Добавить**.
