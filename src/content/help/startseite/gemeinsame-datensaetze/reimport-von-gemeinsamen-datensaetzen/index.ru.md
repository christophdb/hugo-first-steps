...
author: 'kgr'
url: '/ru/pomoshch/povtornyi-import-obshchikh-dannykh'
aliases:
    - '/ru/pomoshch/reimport-von-gemeinsamen-datensaetzen'
seo:
    title: 'Повторный импорт общих данных в таблицы SeaTable'
    description: 'Узнайте, как восстановить связь с общими наборами данных после копирования или восстановления базы в SeaTable. Пошагово импортируйте и синхронизируйте данные.'
