...
seo:
    ...
    description: 'Пошагово: публикуйте, управляйте и импортируйте общие датасеты в групповых базах SeaTable – для совместной работы и централизации данных в команде.'
