...
author: 'nsc2'
url: '/help/why-shared-datasets-only-work-in-groups'
aliases:
    - '/help/warum-funktionieren-gemeinsame-datensaetze-nur-in-gruppen'
seo:
    title: 'Why shared datasets in SeaTable only work within groups'
    description: 'Shared datasets can currently only be created from group bases in SeaTable. Learn about technical reasons and how to bypass the current limitation.'
---
