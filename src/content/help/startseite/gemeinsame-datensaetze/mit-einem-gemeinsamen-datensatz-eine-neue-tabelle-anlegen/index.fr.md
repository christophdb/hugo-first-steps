...
Si vous apportez des modifications à une vue de tableau que vous avez publiée en tant qu'**enregistrement partagé**, ces modifications seront également appliquées à toutes les tables créées avec l'enregistrement partagé correspondant. La condition préalable à cela est une **synchronisation des tables respectives avec l'ensemble de données**, [qui peut être automatique ou manuelle]({{< relref "help/startseite/gemeinsame-datensaetze/synchronisation-eines-gemeinsamen-datensatzes" >}}).
