...
author: 'nsc2'
url: '/ru/pomoshch/kak-rabotayut-obshchie-datasety-seatable'
aliases:
    - '/ru/pomoshch/funktionsweise-von-gemeinsamen-datensaetzen'
seo:
    title: 'Как работают общие датасеты в SeaTable: возможности и синхронизация'
    description: 'Общие датасеты позволяют централизовать, синхронизировать и расширять данные между таблицами — основы для командной работы и автоматизации.'
star: true
weight: 1
---
...
По сравнению с общим [просмотром]({{< relref "help/startseite/freigaben/freigabe-einer-ansicht-an-ein-teammitglied" >}}), общий набор данных предоставляет дополнительные возможности, которые иллюстрируются следующим примером:
...
{{< warning headline="Общие записи и Big Data Backend" text="В настоящее время использовать общие записи в представлении Big Data невозможно." />}}

**В этом видеоуроке мы за несколько минут расскажем вам, как создать и импортировать общий набор данных в SeaTable (с русскими субтитрами).**
