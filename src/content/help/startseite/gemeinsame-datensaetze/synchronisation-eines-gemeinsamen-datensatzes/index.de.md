...
{{< warning  type="warning" headline="Berechtigung erforderlich"  text="Sie können die Synchronisation nur erzwingen, wenn Sie als **Ersteller** des gemeinsamen Datensatzes dazu berechtigt sind." />}}
