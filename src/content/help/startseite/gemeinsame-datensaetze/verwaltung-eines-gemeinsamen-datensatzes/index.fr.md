---
title: "Gestion d'un ensemble de données communes"
date: 2024-06-11
lastmod: '2024-06-11'
categories:
...
Une fois que vous avez créé un ensemble de données partagées, vous pouvez effectuer différentes opérations pour gérer votre ensemble de données. Vous pouvez accéder à l'aperçu de vos enregistrements partagés via la page d'accueil.

## Comment gérer vos dossiers partagés
...
## Obtenir les détails d'un enregistrement commun
