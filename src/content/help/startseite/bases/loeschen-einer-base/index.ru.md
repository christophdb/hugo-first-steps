...
Удаленные базы попадают в **корзину для мусора**. Оттуда вы можете сначала **восстановить** их. Как это сделать, вы можете узнать [здесь](https://seatable.io/ru/docs/historie-und-versionen/eine-geloeschte-base-wiederherstellen/).
