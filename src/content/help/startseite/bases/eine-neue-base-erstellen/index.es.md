...
categories:
    - 'arbeiten-mit-bases'
author: 'nsc2'
url: '/es/ayuda/eine-neue-base-erstellen'
---
...
4. Seleccione si desea **crear** una **base vacía**, [importar](https://seatable.io/es/docs/import-von-daten/datenimport-und-export/#base_importieren) una base o crear una [base a partir de una plantilla](https://seatable.io/es/docs/arbeiten-mit-bases/anlegen-einer-base-mithilfe-einer-vorlage/).
