...
aliases:
    - '/ru/pomoshch/eine-neue-base-erstellen'
seo:
    title: 'Создать новую базу в SeaTable'
    description: 'Узнайте, как создать новую пустую базу в SeaTable через стартовую страницу или папку. Укажите имя, цвет, значок и начните работу.'
---
...
4. Выберите, хотите ли вы **создать пустую базу**, [импортировать]({{< relref "help/startseite/import-von-daten/datenimport-und-export" >}}#base_importieren) базу или создать [базу из шаблона]({{< relref "help/startseite/bases/anlegen-einer-base-mithilfe-einer-vorlage" >}}).
