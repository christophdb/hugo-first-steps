...
**Нет**, учетные записи электронной почты, настроенные для базы, **не копируются**. Если вы копируете базу в область _"Мои базы"_ или [в группу]({{< relref "help/startseite/bases/eine-base-in-eine-gruppe-kopieren" >}}), необходимо **заново настроить** учетные записи электронной почты в новой базе.
