...
3. Klicken Sie im sich öffnenden Fenster auf **Neuen Ordner**.
4. Geben Sie dem Ordner einen beliebigen **Namen** und bestätigen Sie diesen mit einem Klick auf den **grünen Haken** oder mit der **Enter-Taste**.
5. Der Ordner erscheint nun sowohl in der geöffneten **Ordner-Übersicht** als auch im entsprechenden **Abschnitt** auf der Startseite und Sie können diesen nach Belieben mit Bases füllen.
