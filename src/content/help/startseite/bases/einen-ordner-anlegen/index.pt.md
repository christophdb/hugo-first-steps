...
5. A pasta aparece agora na **vista geral das pastas** abertas e na **secção** correspondente da página inicial e pode ser preenchida com as bases que desejar.
   {{< warning  headline="Nota importante"  text="Para criar uma pasta dentro de um **grupo**, é necessário ser **o proprietário** ou **administrador do** grupo. Esta função **não** está disponível para os utilizadores que são apenas **membros de** um grupo." />}}
