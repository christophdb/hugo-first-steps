...
categories:
    - 'arbeiten-mit-bases'
author: 'nsc2'
url: '/ru/pomoshch/sozdat-papku'
aliases:
   - '/ru/pomoshch/einen-ordner-anlegen'
seo:
    title: 'Создать папку в SeaTable – подробная пошаговая инструкция'
    description: 'Узнайте, как создать новую папку для баз в SeaTable, давать имена и настраивать порядок: полное руководство для главной, групп и панели.'
...
5. Теперь **папка** появляется в соответствующем разделе, и вы можете заполнить ее [базами]({{< relref "help/startseite/bases/allgemeines-zu-bases" >}}) по своему усмотрению.
