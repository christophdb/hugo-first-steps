...
После копирования соответствующая база находится как в **исходном местоположении**, так и в **местоположении назначения**. При необходимости базу можно [удалить]({{< relref "help/startseite/papierkorb/loeschen-einer-base" >}}) в том или ином месте.
