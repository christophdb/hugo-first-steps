...
Darüber hinaus können Sie als zeitlichen Trigger wählen, dass die **Deadline eines Eintrags naht**. Dieser Trigger ist nur einsetzbar, wenn eine [Datum-Spalte]({{< relref "help/base-editor/numerische-spalten/die-datum-spalte" >}}) in der ausgewählten Tabellenansicht vorliegt. Sie können dann festlegen, **ab wann** und **wie oft** SeaTable **Erinnerungen** verschickt.
