...
Además, puede seleccionar como desencadenante temporal que se **acerca la fecha límite de una entrada**. Este disparador sólo puede utilizarse si hay una [columna de fecha]({{< relref "help/base-editor/spalten/die-datum-spalte" >}}) en la vista de tabla seleccionada. A continuación, puede definir a partir de **cuándo** y **con qué frecuencia** SeaTable envía **recordatorios**.
