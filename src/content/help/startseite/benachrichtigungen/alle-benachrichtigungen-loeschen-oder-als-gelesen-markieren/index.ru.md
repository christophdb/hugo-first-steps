...
Обратите внимание, что от **содержания** уведомления зависит, где именно оно будет отображаться. Например, уведомления, касающиеся релизов, всегда отображаются на **стартовой** странице, в то время как уведомления, возникающие в результате [автоматизаций]({{< relref "help/base-editor/zeilen/die-kommentarfunktion-in-seatable" >}}) или [записей в колонке персонала]({{< relref "help/base-editor/spalten/die-spalte-mitarbeiter" >}}), отображаются в соответствующей **базе**.
