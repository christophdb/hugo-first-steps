---
title: 'Buscar una base o aplicación'
date: 2025-07-01
lastmod: '2025-07-01'
categories:
    - 'arbeiten-mit-bases'
author: 'kgr'
url: '/es/ayuda/buscar-una-base-o-aplication'
seo:
    title: 'Buscar una base o aplicación en SeaTable'
    description: 'Descubra cómo usar la función de búsqueda de SeaTable para encontrar rápidamente bases y aplicaciones y acceder a sus búsquedas recientes.'
...
![Buscar una base](images/search-for-a-base.gif)

- Abra la **página de inicio** de SeaTable.
- Utilice la **combinación de teclas** {{< key "Ctrl" >}} + {{< key "F" >}} o haga clic en el **campo de búsqueda** de la esquina superior derecha.
...
{{< warning  headline="Nota" text="Actualmente sólo puede buscar por nombre, no por contenido dentro de una base o aplicación." />}}
...
![Última base buscada](images/base-last-searched.png)