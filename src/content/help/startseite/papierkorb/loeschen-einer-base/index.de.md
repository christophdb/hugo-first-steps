...
![Eine Base in SeaTable löschen](images/delete-base-via-starting-page.gif)
...
Gelöschte Bases landen in einem **Papierkorb**. Von dort aus können Sie sie zunächst **wiederherstellen**. Wie das geht, erfahren Sie [hier]({{< relref "help/startseite/papierkorb/eine-geloeschte-base-wiederherstellen" >}}).
...
![Den Papierkorb leeren](images/clean-trash.gif)
