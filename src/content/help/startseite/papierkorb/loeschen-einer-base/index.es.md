...
Las bases borradas acaban en la **papelera**. A partir de ahí, primero puedes **restaurarlos**. [Aquí]({{< relref "help/startseite/papierkorb/eine-geloeschte-base-wiederherstellen" >}}) encontrará información sobre cómo hacerlo.
...
Si no quieres esperar a que pasen los 30 días, también puedes borrar definitivamente tus propias bases **manualmente vaciando la papelera**.

![Vaciar la papelera](images/clean-trash.gif)

1. Cambie a la **página de inicio** de SeaTable.
2. Abre la **papelera** en el menú lateral, donde ahora podrás ver tus bases eliminadas.
3. Haga clic en el botón **Limpiar** de la esquina superior derecha.
4. Confirme el diálogo posterior con **Limpiar** de nuevo para eliminar todas las bases.
