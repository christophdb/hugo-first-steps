...
3. Die erforderlichen Schritte zum Importieren einer CSV-Datei aus Microsoft Access sind dabei **identisch** zum [Importieren einer beliebigen CSV-Datei]({{< relref "help/startseite/import-von-daten/daten-import-mithilfe-von-csv-in-seatable" >}}).
