...
You can always **import** a DTABLE file back into SeaTable as a new Base. You can learn more about this in the article [Creating a Base from a DTABLE File](https://seatable.io/en/docs/import-von-daten/erstellen-einer-base-aus-einer-dtable-datei/).
