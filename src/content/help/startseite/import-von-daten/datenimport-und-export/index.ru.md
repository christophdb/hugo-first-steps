...
Если вы уже создали таблицу в **SeaTable** и она нужна вам в **другой базе**, вы можете просто скопировать ее. О том, как импортировать таблицы из другой базы, вы можете узнать [здесь](https://seatable.io/ru/docs/arbeiten-in-tabellen/eine-tabelle-in-einer-base-hinzufuegen/).
