...
seo:
    title: 'CSV-Dateien nach SeaTable importieren – Anleitung'
    description: 'Importieren Sie CSV-Dateien als neue Tabelle, in bestehende Tabellen oder Bases. Mit Vorschau, Tipps zu Spaltennamen und Formatproblemen.'
