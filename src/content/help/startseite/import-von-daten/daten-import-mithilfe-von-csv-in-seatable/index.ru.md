...
categories:
    - 'import-von-daten'
author: 'nsc2'
url: '/ru/help/daten-import-mithilfe-von-csv-in-seatable'
---
...
Как должен выглядеть CSV-файл, который будет импортирован в таблицу?|||

CSV-файл должен быть отформатирован в соответствии со [стандартом UTF-8](https://de.wikipedia.org/wiki/UTF-8) и содержать суффикс **.csv** в **конце имени файла** **.**

---

Будут ли существующие данные заменены во время импорта?|||

**Нет**, при импорте данные **не** заменяются.

---

Импортированные данные просто вставляются под существующие строки?|||

**Да**, импортированные данные будут вставлены в соответствующие столбцы таблицы под уже существующими строками.

---

Какое сообщение об успехе появляется при успешном импорте данных?|||

Если импорт данных **прошел успешно**, появится следующее сообщение об успехе:

![успех](images/Bildschirmfoto-2022-10-28-um-11.51.04.png)
