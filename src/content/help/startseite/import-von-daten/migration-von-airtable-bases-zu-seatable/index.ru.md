...
Для того чтобы SeaTable корректно импортировал данные, необходимо выполнить еще один шаг: указать [колонки связей](https://seatable.io/ru/docs/verknuepfungen/wie-man-tabellen-in-seatable-miteinander-verknuepft/) в Airtable Base.
