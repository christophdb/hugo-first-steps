...
Para que o SeaTable importe os dados corretamente, é necessário mais um passo: a especificação das [colunas de ligação]({{< relref "help/base-editor/spalten/wie-man-tabellen-in-seatable-miteinander-verknuepft" >}}) na Airtable Base.
