...
![Eine Gruppe übertragen](images/transfer-group.jpg) 5. Geben Sie den **Namen** des gewünschten **Benutzers** ein und wählen Sie diesen aus.

![Eingabe des Benutzers, an den die Gruppe übertragen werden soll](images/type-name-to-transfer-group-to.png) 7. Bestätigen Sie mit **Absenden**.

![Bestätigen der Übertragung einer Gruppe](images/confirm-transfer-to-group.jpg)
