...
author: 'nsc2'
url: '/fr/aide/transferer-groupe-seatable'
aliases:
    - '/fr/aide/eine-gruppe-an-einen-anderen-benutzer-uebertragen'
seo:
    title: 'Transférer un groupe à un autre utilisateur SeaTable'
    description: 'Donnez la propriété d’un groupe en quelques clics : l’utilisateur désigné devient propriétaire, l’ancien propriétaire est membre simple du groupe.'
...
![Transférer un groupe](images/transfer-group.jpg)

5. Saisissez le **nom** de l'**utilisateur** souhaité et sélectionnez-le.

![Saisie de l'utilisateur auquel le groupe doit être transféré](images/type-name-to-transfer-group-to.png)

7. Confirmez en cliquant sur **Envoyer**.

![Confirmer le transfert d'un groupe](images/confirm-transfer-to-group.jpg)
