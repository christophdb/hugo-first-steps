...
Как **администратор команды**, у вас есть вторая возможность, а именно [создать группу через администрацию команды]({{< relref "help/teamverwaltung/team/eine-neue-gruppe-anlegen-2" >}}).
