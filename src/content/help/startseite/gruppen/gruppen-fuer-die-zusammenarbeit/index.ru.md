...
author: 'cdb'
url: '/ru/pomoshch/gruppy'
aliases:
    - '/ru/pomoshch/gruppen'
seo:
    title: 'Группы в SeaTable: совместная работа и управление правами'
    description: 'Узнайте, как с помощью групп SeaTable организовать совместную работу, распределять роли, управлять базами и быстро настраивать все уровни доступа.'
---
