...
author: 'nsc2'
url: '/help/change-avatar-picture'
aliases:
    - '/help/avatarbild-anpassen'
seo:
    title: 'Change Your SeaTable Avatar: Step‑by‑Step Guide'
    description: 'Update your SeaTable profile picture via personal settings; JPG/PNG/GIF up to 1 MB accepted and images are auto‑scaled on upload.'

---

You can customize your own **avatar image** in just a few steps in the **personal settings of** your account.

An avatar image is helpful for other team members to quickly identify you in SeaTable, because the image is also displayed as a thumbnail in [collaborator]({{< relref "help/base-editor/spaltentypen/die-mitarbeiter-spalte" >}}), [creator]({{< relref "help/base-editor/spaltentypen/die-spalten-ersteller-und-erstelldatum" >}}), for example, and in front of your name in shares.
