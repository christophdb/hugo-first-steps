...
An avatar image is helpful for other team members to quickly identify you in SeaTable, because the image is also displayed as a thumbnail in [collaborator]({{< relref "help/base-editor/auswahl-spalten/die-spalte-mitarbeiter" >}}), [creator]({{< relref "help/base-editor/autofill-spalten/die-spalten-ersteller-und-erstelldatum" >}}), for example, and in front of your name in shares.
