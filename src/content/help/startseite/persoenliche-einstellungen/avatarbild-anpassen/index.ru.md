...
Изображение аватара полезно для того, чтобы другие члены команды могли быстро идентифицировать вас в SeaTable, поскольку изображение также отображается в виде эскиза, например, в [колонках]({{< relref "help/base-editor/auswahl-spalten/die-spalte-mitarbeiter" >}})", " [Создатель"]({{< relref "help/base-editor/autofill-spalten/die-spalten-ersteller-und-erstelldatum" >}}), а также перед вашим именем в акциях.
