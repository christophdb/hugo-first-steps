...
Votre **avatar** est une petite image qui apparaît à plusieurs endroits dans SeaTable, seule ou avec votre nom, pour vous identifier en tant qu'utilisateur (par exemple dans les partages ou les colonnes de personnes). Découvrez comment [personnaliser l'image de](https://seatable.io/fr/docs/persoenliche-einstellungen/avatarbild-anpassen/) votre [avatar](https://seatable.io/fr/docs/persoenliche-einstellungen/avatarbild-anpassen/).
...
Vous pouvez modifier votre **mot de passe** en cliquant sur **Actualiser**. Pour savoir comment procéder, consultez l'article [Modifier son propre mot de passe](https://seatable.io/fr/docs/persoenliche-einstellungen/eigenes-passwort-aendern/).

## Langue

Vous pouvez utiliser SeaTable en **cinq langues**: Allemand, anglais, français, russe et chinois (au 09 mars 2023). Pour savoir comment changer de langue, consultez l'article [Personnaliser la langue d'interface](https://seatable.io/fr/docs/persoenliche-einstellungen/anpassen-der-oberflaechensprache/).
...
Si vous ne souhaitez pas être informé des modifications, vous pouvez [vous désabonner](https://seatable.io/fr/docs/persoenliche-einstellungen/e-mails-von-seatable-abbestellen/) des [e-mails de notification de SeaTable](https://seatable.io/fr/docs/persoenliche-einstellungen/e-mails-von-seatable-abbestellen/).

## Authentification à 2 facteurs

L'**authentification à deux facteurs** (2FA) protège votre compte d'utilisateur et donc vos données - au-delà de votre mot de passe personnel - contre tout accès non autorisé. Si la 2FA est activée, vous devez saisir un **code à six chiffres** en plus de votre **mot de passe** lorsque vous vous connectez. Ce code est généré par une **application 2FA** sur votre smartphone ou votre tablette. Vous apprendrez comment cela fonctionne exactement dans l'article [Activer l'authentification à 2 facteurs](https://seatable.io/fr/docs/persoenliche-einstellungen/2-faktor-authentifizierung-aktivieren/).

En tant qu'**administrateur d'équipe**, vous pouvez également [activer](https://seatable.io/fr/docs/teamverwaltung/zwei-faktor-authentifizierung-fuer-ein-teammitglied-aktivieren/) l'[authentification à deux facteurs pour un membre de l'équipe](https://seatable.io/fr/docs/teamverwaltung/zwei-faktor-authentifizierung-fuer-ein-teammitglied-aktivieren/) ou [forcer](https://seatable.io/fr/docs/teamverwaltung/zwei-faktor-authentifizierung-fuer-das-gesamte-team-erzwingen/) l'[authentification à deux facteurs pour l'ensemble de l'équipe](https://seatable.io/fr/docs/teamverwaltung/zwei-faktor-authentifizierung-fuer-das-gesamte-team-erzwingen/) afin d'augmenter la sécurité globale.
