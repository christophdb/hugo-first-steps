...
L'**authentification à deux facteurs** (2FA) protège votre compte d'utilisateur et donc vos données - au-delà de votre mot de passe personnel - contre tout accès non autorisé. Si la 2FA est activée, vous devez saisir un **code à six chiffres** en plus de votre **mot de passe** lorsque vous vous connectez. Ce code est généré par une **application 2FA** sur votre smartphone ou votre tablette. Vous apprendrez comment cela fonctionne exactement dans l'article [Activer l'authentification à 2 facteurs]({{< relref "help/startseite/persoenliche-einstellungen/2-faktor-authentifizierung-aktivieren" >}}).
