...
**Two-factor authentication** (2FA) protects your user account and thus your data - beyond your personal password - against unauthorized access. With 2FA activated, you must enter a **six-digit code** in addition to your **password** when logging in. This code is generated by a **2FA app** on your smartphone or tablet. You can learn exactly how this works in the article [Activating two-factor authentication]({{< relref "help/startseite/persoenliche-einstellungen/2-faktor-authentifizierung-aktivieren" >}}).
