...
Если вы еще не зарегистрировали команду на cloud.seatable.io, начните с [регистрации](https://seatable.io/ru/docs/erste-schritte/registrierung-login/). Сначала всегда создавайте команду с бесплатной [подпиской](https://seatable.io/ru/docs/abo-abrechnung/abo-pakete/). Затем выполните следующие действия:
