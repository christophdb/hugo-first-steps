---
title: 'Segundo nivel: Introducción'
date: 2024-09-18
lastmod: '2024-09-23'
categories:
    - 'online-kurs-2'
...
¡Bienvenido al **curso en línea SeaTable Nivel 2!**
...
- desea profundizar en las funciones de SeaTable tras completar el [curso en línea de Nivel 1]({{< relref "help/online-courses/online-kurs-1/level-eins-einfuehrung" >}}).

## ¿Qué aprenderé en este curso en línea?

La segunda parte de este curso trata sobre cómo implementar un proceso de negocio completo con SeaTable. Desarrollará un sistema informático para un proveedor de servicios en línea. No importa si ofrece talleres gráficos, cursos de cocina, clases particulares, sesiones fotográficas o coaching individual: su oferta sigue siendo individual. SeaTable se encarga de toda la administración, desde la presentación del curso y la inscripción de los participantes hasta el pago y el envío de las confirmaciones de participación.
