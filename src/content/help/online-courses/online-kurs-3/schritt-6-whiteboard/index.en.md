...
- one color per person or department, used for your own additions — since the board keeps no log, the colors are how you tell afterwards who did what;
...
A minute's work between the two of you — and because you each drew in your own color, the finished board shows at a glance who changed what, even though SeaTable kept no record of it.
