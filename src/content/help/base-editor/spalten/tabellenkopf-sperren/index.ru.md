...
author: 'nsc2'
url: '/ru/pomoshch/zablokirovat-zagolovok-tablitsy-seatable'
aliases:
    - '/ru/pomoshch/tabellenkopf-sperren'
seo:
    title: 'Заблокируйте заголовок таблицы в SeaTable'
    description: 'Защитите структуру таблицы: заблокируйте заголовок, чтобы предотвратить изменение колонок другими пользователями.'
---
