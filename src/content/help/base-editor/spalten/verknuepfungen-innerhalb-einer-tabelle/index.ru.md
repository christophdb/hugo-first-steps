...
- По всем остальным вопросам работы с колонками ссылок обращайтесь к статье [Как связать таблицы в SeaTable]({{< relref "help/base-editor/spalten/wie-man-tabellen-in-seatable-miteinander-verknuepft" >}}).
