...
If you specify the reference **{creator.name}** or **{creator.id}** as the default value in a [text column]({{< relref "help/base-editor/text-spalten/die-spalten-text-und-formatierter-text" >}}), the **name** or **ID of the user** who added the row is automatically entered.
