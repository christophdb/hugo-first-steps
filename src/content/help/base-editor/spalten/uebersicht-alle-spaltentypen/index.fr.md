...
[En savoir plus sur la colonne de texte]({{< relref "help/base-editor/spalten/die-spalten-text-und-formatierter-text" >}})
...
[En savoir plus sur la colonne Texte formaté]({{< relref "help/base-editor/spalten/die-spalten-text-und-formatierter-text" >}})
...
[En savoir plus sur la colonne des chiffres]({{< relref "help/base-editor/spalten/die-zahlen-spalte" >}})
...
[En savoir plus sur la colonne des dates]({{< relref "help/base-editor/spalten/die-datum-spalte" >}})
...
[En savoir plus sur la colonne permanente]({{< relref "help/base-editor/spalten/die-dauer-spalte" >}})
...
[En savoir plus sur la colonne de sélection simple]({{< relref "help/base-editor/spalten/anlegen-einer-einfachauswahl-spalte" >}})
...
[En savoir plus sur la colonne de sélection multiple]({{< relref "help/base-editor/spalten/die-mehrfachauswahl-spalte" >}})
