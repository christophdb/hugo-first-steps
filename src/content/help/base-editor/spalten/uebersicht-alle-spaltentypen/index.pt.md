...
[Mais informações sobre a coluna de texto]({{< relref "help/base-editor/spalten/die-spalten-text-und-formatierter-text" >}})
...
[Mais informações sobre a coluna Texto formatado]({{< relref "help/base-editor/spalten/die-spalten-text-und-formatierter-text" >}})
...
[Mais sobre a coluna dos números]({{< relref "help/base-editor/spalten/die-zahlen-spalte" >}})
...
[Mais informações sobre a coluna de data]({{< relref "help/base-editor/spalten/die-datum-spalte" >}})
...
[Mais informações sobre a coluna permanente]({{< relref "help/base-editor/spalten/die-dauer-spalte" >}})
...
[Mais informações sobre a coluna de selecção única]({{< relref "help/base-editor/spalten/anlegen-einer-einfachauswahl-spalte" >}})
...
[Mais informações sobre a coluna de selecção múltipla]({{< relref "help/base-editor/spalten/die-mehrfachauswahl-spalte" >}})
...
[Mais informações sobre a coluna do ficheiro]({{< relref "help/base-editor/spalten/die-datei-spalte" >}})
...
[Mais informações sobre a coluna Último editor]({{< relref "help/base-editor/spalten/die-spalten-letzter-bearbeiter-und-bearbeitungsdatum" >}})
