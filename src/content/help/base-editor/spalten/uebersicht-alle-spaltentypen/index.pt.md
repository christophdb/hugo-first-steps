...
[Mais informações sobre a coluna de texto]({{< relref "help/base-editor/text-spalten/die-spalten-text-und-formatierter-text" >}})
...
[Mais informações sobre a coluna Texto formatado]({{< relref "help/base-editor/text-spalten/die-spalten-text-und-formatierter-text" >}})
...
[Mais informações sobre a coluna de data]({{< relref "help/base-editor/numerische-spalten/die-datum-spalte" >}})
...
[Mais informações sobre a coluna de imagens]({{< relref "help/base-editor/dateien/die-bild-spalte" >}})
...
[Mais informações sobre a coluna do ficheiro]({{< relref "help/base-editor/dateien/die-datei-spalte" >}})
...
[Mais informações sobre a coluna da caixa de verificação]({{< relref "help/base-editor/auswahl-spalten/anlegen-einer-checkbox-spalte" >}})
...
[Mais informações sobre a coluna de classificação]({{< relref "help/base-editor/numerische-spalten/die-rating-spalte" >}})
...
Precisa de mais informações sobre a coluna de fórmulas? Então, consulte este [artigo]({{< relref "help/base-editor/formeln/grundlagen-von-seatable-formeln" >}}). Como as fórmulas são uma característica muito complexa, encontrará muitos outros artigos de ajuda no nosso manual. Clique [aqui]({{< relref "help/base-editor/formeln" >}}) e será redireccionado para a página de resumo.
...
Para mais informações sobre o tipo de coluna Link para outras entradas, [clique aqui]({{< relref "help/base-editor/tabellen/wie-man-tabellen-in-seatable-miteinander-verknuepft" >}}).
...
[Mais informações sobre a coluna do pessoal]({{< relref "help/base-editor/auswahl-spalten/die-spalte-mitarbeiter" >}})
...
Para mais informações sobre o botão e as acções que podem ser desencadeadas em colunas deste tipo, consulte este [artigo]({{< relref "help/base-editor/schaltflaechen/die-schaltflaeche" >}}).
...
[Mais informações sobre a coluna do criador]({{< relref "help/base-editor/autofill-spalten/die-spalten-ersteller-und-erstelldatum" >}})
...
[Mais informações sobre a coluna Data de criação]({{< relref "help/base-editor/autofill-spalten/die-spalten-ersteller-und-erstelldatum" >}})
...
[Mais informações sobre a coluna Último editor]({{< relref "help/base-editor/autofill-spalten/die-spalten-letzter-bearbeiter-und-bearbeitungsdatum" >}})
...
[Mais informações sobre a coluna da data de processamento]({{< relref "help/base-editor/autofill-spalten/die-spalten-letzter-bearbeiter-und-bearbeitungsdatum" >}})
...
[Mais informações sobre a coluna Número automático]({{< relref "help/base-editor/autofill-spalten/der-spaltentyp-automatische-nummer" >}}).
