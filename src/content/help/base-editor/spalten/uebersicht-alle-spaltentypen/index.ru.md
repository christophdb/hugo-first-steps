...
[Подробнее о текстовой колонке]({{< relref "base-editor/spalten/die-spalten-text-und-formatierter-text" >}})
...
[Подробнее о колонке Форматированный текст]({{< relref "base-editor/spalten/die-spalten-text-und-formatierter-text" >}})
...
[Подробнее о колонке цифр]({{< relref "base-editor/spalten/die-zahlen-spalte" >}})
...
[Подробнее о столбце даты]({{< relref "base-editor/spalten/die-datum-spalte" >}})
...
[Подробнее о постоянной рубрике]({{< relref "base-editor/spalten/die-dauer-spalte" >}})
...
[Подробнее о колонке с одиночным отбором]({{< relref "base-editor/spalten/anlegen-einer-einfachauswahl-spalte" >}})
...
[Подробнее о колонке множественного выбора]({{< relref "base-editor/spalten/die-mehrfachauswahl-spalte" >}})
