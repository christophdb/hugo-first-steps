...
[Подробнее о текстовой колонке]({{< relref "help/base-editor/spalten/die-spalten-text-und-formatierter-text" >}})
...
[Подробнее о колонке Форматированный текст]({{< relref "help/base-editor/spalten/die-spalten-text-und-formatierter-text" >}})
...
[Подробнее о колонке цифр]({{< relref "help/base-editor/spalten/die-zahlen-spalte" >}})
...
[Подробнее о столбце даты]({{< relref "help/base-editor/spalten/die-datum-spalte" >}})
...
[Подробнее о постоянной рубрике]({{< relref "help/base-editor/spalten/die-dauer-spalte" >}})
...
[Подробнее о колонке с одиночным отбором]({{< relref "help/base-editor/spalten/anlegen-einer-einfachauswahl-spalte" >}})
...
[Подробнее о колонке множественного выбора]({{< relref "help/base-editor/spalten/die-mehrfachauswahl-spalte" >}})
...
[Подробнее о колонке с флажками]({{< relref "help/base-editor/spalten/anlegen-einer-checkbox-spalte" >}})
...
[Подробнее о рейтинговой колонке]({{< relref "help/base-editor/spalten/die-rating-spalte" >}})
...
[Подробнее о колонке для персонала]({{< relref "help/base-editor/spalten/die-spalte-mitarbeiter" >}})
...
Более подробную информацию о кнопке и действиях, которые могут быть вызваны в колонках этого типа, см. в этой [статье]({{< relref "help/base-editor/spalten/die-schaltflaeche" >}}).
...
[Подробнее о колонке "Последний редактор]({{< relref "help/base-editor/spalten/die-datum-spalte" >}}die-spalten-letzter-bearbeiter-und-bearbeitungssatumt/)
...
[Подробнее о колонке "Автоматический номер]({{< relref "help/base-editor/spalten/der-spaltentyp-automatische-nummer" >}}).
