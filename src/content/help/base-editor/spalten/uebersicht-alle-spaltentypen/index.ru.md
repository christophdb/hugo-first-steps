...
Вам нужна дополнительная информация о столбце формул? Тогда ознакомьтесь с этой [статьей]({{< relref "help/base-editor/formeln/grundlagen-von-seatable-formeln" >}}). Поскольку формулы - это очень сложная функция, в нашем руководстве вы найдете множество других справочных статей. Нажмите [здесь](https://seatable.io/ru/docs-category/formeln/), и вы будете перенаправлены на страницу обзора.
