...
SeaTable erlaubt das **Löschen** von **Dateien** und **Bildern** auf verschiedenen Wegen. Die folgenden Anleitungen gelten sowohl für [Bild-]({{< relref "help/base-editor/spalten/die-bild-spalte" >}}) als auch für [Datei-Spalten]({{< relref "help/base-editor/spalten/die-datei-spalte" >}}).
