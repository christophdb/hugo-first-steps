...
Если вы хотите иметь возможность хранить **дополнительную информацию** для каждого варианта выбора, вам следует рассмотреть возможность преобразования единственного столбца выбора в [столбец ссылок](https://seatable.io/ru/docs/verknuepfungen/wie-man-tabellen-in-seatable-miteinander-verknuepft/). Затем вы можете создать полную запись для каждого варианта в отдельной таблице.
