...
Эта настройка особенно полезна в [фильтруемых представлениях]({{< relref "help/base-editor/spalten/wie-man-tabellen-in-seatable-miteinander-verknuepft" >}}#7-toc-title) эта настройка может быть полезна, если требуется связать **отдельные записи** в таблицах.
