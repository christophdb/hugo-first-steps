...
seo:
    ...
    description: 'Remova com segurança operações de processamento de dados das tabelas SeaTable: guia de exclusão, efeitos e colunas calculadas mantidas.'
---
...
É claro que já **não** se pode executar uma operação de processamento de dados apagados, ou seja, já **não** se pode considerar entradas acrescentadas posteriormente à coluna de origem. No entanto, se quiser trabalhar com a operação de processamento de dados na sua tabela novamente numa altura posterior, pode [criá-la novamente]({{< relref "help/base-editor/datenverarbeitung/datenverarbeitungsoperationen-anlegen" >}}) em qualquer altura.
