...
- Для **операций с отношениями** вам нужны очень специфические типы столбцов в зависимости от приложения, например, [столбец с персоналом]({{< relref "help/base-editor/spalten/die-spalte-mitarbeiter" >}}) и [текстовый](https://seatable.io/ru/docs/text-und-zahlen/die-spalten-text-und-formatierter-text/) столбец при переносе имен пользователей.
