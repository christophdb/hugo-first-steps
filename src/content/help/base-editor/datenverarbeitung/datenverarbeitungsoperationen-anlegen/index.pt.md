...
Para cálculos matemáticos, ou seja, para as operações **Calcular Valores Cumulados**, Calcular **Classificação**, Calcular **Alterações** e Calcular **Percentagem**, são necessárias pelo menos **duas** [colunas de números]({{< relref "help/base-editor/numerische-spalten/die-zahlen-spalte" >}}) na vista da tabela seleccionada. Normalmente, a **coluna de origem** já existe e é preenchida com dados, enquanto que a **coluna de resultados** é criada e preenchida com valores através da operação.

Para as outras operações, é necessário em parte [ligar colunas]({{< relref "help/base-editor/tabellen/wie-man-tabellen-in-seatable-miteinander-verknuepft" >}})**(comparar e ligar** & **comparar e copiar**) ou [colunas de texto]({{< relref "help/base-editor/text-spalten/die-spalten-text-und-formatierter-text" >}})**(transferir nome de utilizador**).
