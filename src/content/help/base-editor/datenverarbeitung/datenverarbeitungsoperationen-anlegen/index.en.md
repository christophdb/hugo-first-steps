...
For the other operations you need partly [link columns]({{< relref "help/base-editor/tabellen/wie-man-tabellen-in-seatable-miteinander-verknuepft" >}})**(compare and link** & **compare and copy**) or [text columns]({{< relref "help/base-editor/spaltentypen/die-spalten-text-und-formatierter-text" >}})**(transfer user name**).
