...
For the other operations you need partly [link columns]({{< relref "help/base-editor/spalten/wie-man-tabellen-in-seatable-miteinander-verknuepft" >}})**(compare and link** & **compare and copy**) or [text columns](https://seatable.io/en/docs/text-und-zahlen/die-spalten-text-und-formatierter-text/)**(transfer user name**).
