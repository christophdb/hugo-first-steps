...
Для математических вычислений, т.е. для операций **Вычислить кумулятивные значения**, Вычислить **рейтинг**, Вычислить **изменения** и Вычислить **процент**, необходимо как минимум **два** [числовых столбца]({{< relref "help/base-editor/numerische-spalten/die-zahlen-spalte" >}}) в выбранном представлении таблицы. Обычно **исходный столбец** уже существует и заполнен данными, в то время как вы создаете **столбец результата** и заполняете его значениями в ходе операции.

Для других операций вам частично понадобятся [колонки ссылок]({{< relref "help/base-editor/tabellen/wie-man-tabellen-in-seatable-miteinander-verknuepft" >}})**(сравнить и связать**, **сравнить и скопировать**) или [текстовые колонки]({{< relref "help/base-editor/text-spalten/die-spalten-text-und-formatierter-text" >}})**(перенести имя пользователя**).
