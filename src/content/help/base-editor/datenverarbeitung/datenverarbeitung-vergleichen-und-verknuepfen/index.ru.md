---
title: 'Обработка данных: сравнение и связь - SeaTable'
date: 2023-03-20
lastmod: '2023-03-20'
categories:
    - 'datenverarbeitung'
...
{{< warning  headline="Важное замечание"  text="При использовании этой операции обработки данных вам **не** придется добавлять **столбцы** в таблицы вручную, так как при первом ее выполнении в обеих таблицах автоматически создается [столбец связи](https://seatable.io/ru/docs/verknuepfungen/wie-man-tabellen-in-seatable-miteinander-verknuepft/)." />}}
