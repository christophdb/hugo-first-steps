...
Se, por exemplo, mantiver uma tabela com tarefas a realizar na qual **os membros da** sua **equipa** são registados como pessoas de contacto responsáveis numa [coluna de pessoal](https://seatable.io/pt/docs/datum-dauer-und-personen/die-spalte-mitarbeiter/), pode simplesmente copiar os nomes de utilizador para uma [coluna de texto](https://seatable.io/pt/docs/text-und-zahlen/die-spalten-text-und-formatierter-text/), por exemplo para os utilizar para uma lista de pessoal.
