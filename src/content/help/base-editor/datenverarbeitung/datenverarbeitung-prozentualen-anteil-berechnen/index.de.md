...
Damit die errechneten Zahlen als Prozentwerte angezeigt werden, müssen Sie zuvor die **Formateinstellungen** der [Zahlen-Spalte]({{< relref "help/base-editor/numerische-spalten/die-zahlen-spalte" >}}) anpassen. Dort wählen Sie als Format **Prozent** aus. Zudem können Sie als **Dezimaltrennzeichen** Punkt oder Komma einstellen und auf wie viele **Nachkommastellen** gerundet werden soll.
