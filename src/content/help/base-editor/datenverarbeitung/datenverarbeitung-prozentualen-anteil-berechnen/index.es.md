...
Para que los números calculados se muestren como porcentajes, primero debe ajustar la **configuración de formato de** la [columna de números]({{< relref "help/base-editor/spaltentypen/die-zahlen-spalte" >}}). Allí se selecciona **Porcentaje** como formato. También puede ajustar el **separador** **decimal** **a** punto o coma y el número de **decimales a** redondear.
