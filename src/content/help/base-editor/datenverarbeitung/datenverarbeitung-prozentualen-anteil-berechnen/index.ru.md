...
Для того чтобы вычисленные числа отображались в виде процентов, необходимо сначала настроить **параметры формата** [столбца чисел]({{< relref "help/base-editor/numerische-spalten/die-zahlen-spalte" >}}). Там вы выбираете формат **Проценты**. Вы также можете установить **десятичный** **разделитель**: точка или запятая, а также количество **знаков после запятой для** округления.
