---
title: 'Обработка данных: Вычислить процент - SeaTable'
date: 2023-03-16
lastmod: '2023-03-16'
categories:
    - 'datenverarbeitung'
author: 'nsc2'
url: '/ru/help/datenverarbeitung-prozentualen-anteil-berechnen'
---
...
{{< warning  headline="Настройки формата примечаний"  text="Для того чтобы вычисленные числа отображались в виде процентов, необходимо сначала настроить **параметры формата** [столбца чисел](https://seatable.io/ru/docs/text-und-zahlen/die-zahlen-spalte/). Там вы выбираете формат **Проценты**. Вы также можете установить **десятичный** **разделитель**: точка или запятая, а также количество **знаков после запятой для** округления." />}}
