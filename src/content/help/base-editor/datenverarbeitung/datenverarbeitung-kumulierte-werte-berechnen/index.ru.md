...
seo:
    ...
    description: 'Рассчитывайте накопленные значения в строках таблицы SeaTable. Автоматизируйте суммирование в отдельных столбцах — быстро и наглядно.'
