...
Un caso de uso concreto de esta operación de tratamiento de datos podría darse, por ejemplo, si desea recoger en su tabla el número de accesos diarios a una página web. Para ello, desea **sumar** las **cifras de acceso de** cada día individual, que se registran en una [columna numérica]({{< relref "help/base-editor/numerische-spalten/die-zahlen-spalte" >}}) existente, de fila en fila en una nueva columna.
