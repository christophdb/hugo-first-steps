...
Übrigens können Sie Tabellen auch [per Drag-and-Drop verschieben]({{< relref "help/base-editor/tabellen/verschieben-einer-tabelle" >}}), um Ihre meistgenutzten Tabellen immer griffbereit links im Base-Header zu sehen.
