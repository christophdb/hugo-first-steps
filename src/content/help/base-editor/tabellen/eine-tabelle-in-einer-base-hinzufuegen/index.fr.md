---
title: 'Ajouter un tableau dans une base'
date: 2022-09-28
lastmod: '2025-02-28'
categories:
...
Dans SeaTable, [les bases]({{< relref "help/startseite/bases/allgemeines-zu-bases" >}}) sont en principe des unités séparées, mais il n'est pas rare d'avoir besoin de données dans une autre base. Au lieu de devoir exporter un tableau d'une base et l'importer dans la base souhaitée, SeaTable offre la possibilité d'**importer** **directement** des tableaux d'autres bases et de transférer ainsi des données au-delà des frontières de la base.

![Importation d'un tableau à partir d'une autre base](images/import-table-from-other-base.gif)

Avec les [jeux de données communs]({{< relref "help/startseite/gemeinsame-datensaetze/funktionsweise-von-gemeinsamen-datensaetzen" >}}), vous pouvez en outre partager un tableau maître dans un groupe et utiliser et synchroniser les branches du tableau dans différentes bases. Pour en savoir plus, [cliquez ici]({{< relref "help/startseite/gemeinsame-datensaetze/mit-einem-gemeinsamen-datensatz-eine-neue-tabelle-anlegen" >}}).
