...
{{< warning  headline="Note"  text="The deleted data is **not** lost, but remains in the base trash indefinitely." />}}

## Frequently asked questions

{{< faq "Is it possible to recover deleted tables?" >}}In SeaTable you don't need to be afraid of deleting. Even if you accidentally delete a table, row or column, you can easily [recover]({{< relref "help/base-editor/tabellen/eine-geloeschte-tabelle-wiederherstellen" >}}) it. You can find your deleted data in the base trash.
{{< /faq >}}
