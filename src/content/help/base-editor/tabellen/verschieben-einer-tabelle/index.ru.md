...
author: 'nsc2'
url: '/ru/pomoshch/peremestit-tablitsu'
aliases:
    - '/ru/pomoshch/verschieben-einer-tabelle'
seo:
    title: 'Переместить таблицу в SeaTable – пошаговая инструкция'
    description: 'Узнайте, как перемещать таблицы в SeaTable: перетаскивание или меню, чтобы гибко структурировать ваши данные. Простые шаги для быстрой организации.'
---
