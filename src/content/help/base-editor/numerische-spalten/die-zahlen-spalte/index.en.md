...
The use of **number columns** allows you, for example, to **calculate values** that you can visualize with formulas and [statistics]({{< relref "help/base-editor/text-spalten/die-spalten-text-und-formatierter-text" >}}).
