...
El uso de **columnas numéricas** le permite, por ejemplo, **calcular valores** que puede visualizar con fórmulas y [estadísticas]({{< relref "help/base-editor/text-spalten/die-spalten-text-und-formatierter-text" >}}).
