...
![Tabela de exemplo com uma escala de classificação](https://seatable.io/wp-content/uploads/2023/01/example-table-rating-skala-1.png)

## Criar a coluna de classificação

1. Seleccione **Rating** como o tipo de coluna e dê um **nome** à nova coluna.

![Dê um nome à coluna de classificação.](https://seatable.io/wp-content/uploads/2023/01/benennen.png)

3. Definir um **símbolo de classificação**.

![Determinação de um símbolo de classificação](https://seatable.io/wp-content/uploads/2023/01/style.png)

5. Determinar o **número** máximo **de pontos** permitido **de 1 a 10**.

![Determinar a classificação máxima admissível](https://seatable.io/wp-content/uploads/2023/01/maximale-bewertung.png)
...
![Definir valor padrão numa coluna de classificação](https://seatable.io/wp-content/uploads/2023/01/Set-default-value-in-a-rating-column.png)
...
![Criar e alterar uma classificação](https://seatable.io/wp-content/uploads/2023/01/set-and-change-a-rating.png)
