...
Обсуждения и комментарии видны всем лицам, имеющим доступ к таблице. Сюда также входят люди, которые получают доступ к таблице по [внешней ссылке]({{< relref "help/startseite/freigaben/externen-link-fuer-eine-ansicht-erstellen" >}}).
