...
categories:
    - 'arbeiten-mit-zeilen'
author: 'vge'
url: '/pt/ajuda/adicionar-linha'
aliases:
    - '/pt/ajuda/hinzufuegen-einer-zeile'
seo:
    title: 'Adicionar nova linha no SeaTable – guia de todas opções'
    description: 'Veja como adicionar novas linhas no SeaTable: ícone, menu, atalho ou plugin. Dicas de permissões e detalhes de uso.'
---
...
Além disso, alguns **plugins** do SeaTable oferecem a opção de adicionar novas entradas. Estes incluem a [galeria]({{< relref "help/base-editor/plugins/neue-kalendereintraege-im-kalender-plugin-anlegen" >}}) e o [plugin Kanban]({{< relref "help/base-editor/plugins/anleitung-zum-kanban-plugin" >}}).
