...
También puede añadir **imágenes** a sus comentarios mediante el **icono de imagen** situado debajo del campo de entrada. Éstas sólo son visibles en la ventana de comentarios y no se guardan en una [columna de]({{< relref "help/base-editor/dateien/die-bild-spalte" >}}) imágenes de la tabla, sino en la [gestión de archivos de la base]({{< relref "help/base-editor/dateien/das-dateimanagement-einer-base" >}}).
