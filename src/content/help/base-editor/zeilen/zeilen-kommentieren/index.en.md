...
You can also add **images** to your comments via the **image icon** below the input field. These are only visible in the comment window and are not stored in an [image column of]({{< relref "help/base-editor/dateien/die-bild-spalte" >}}) the table, but in the [file management of Base]({{< relref "help/base-editor/dateien/das-dateimanagement-einer-base" >}}).
