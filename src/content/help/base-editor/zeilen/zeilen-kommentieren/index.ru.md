...
Вы также можете добавлять **картинки** к своим комментариям с помощью **значка картинки** под полем ввода. Они видны только в окне комментариев и сохраняются не в [колонке картинок]({{< relref "help/base-editor/dateien/die-bild-spalte" >}}) таблицы, а в [файле управления базой]({{< relref "help/base-editor/dateien/das-dateimanagement-einer-base" >}}).
