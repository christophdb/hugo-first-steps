...
Использование **числовых столбцов** позволяет Вам, например, **вычислять значения** с помощью формул и создавать наглядные **графики и статистику**. Однако он не подходит для сохранения строк любой длины (например, номеров счетов), поскольку при использовании более 15 цифр происходит округление. В этом случае Вам следует использовать [текстовый столбец]({{< relref "help/base-editor/spaltentypen/die-spalten-text-und-formatierter-text" >}}).
