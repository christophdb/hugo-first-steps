...
seo:
    ...
    description: 'Добавьте колонку рейтинга (от 1 до 10), выберите символ, настройте стандартное значение. Максимум функционала для оценок и ранжирования ваших данных.'
