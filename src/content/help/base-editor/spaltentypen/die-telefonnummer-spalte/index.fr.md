---
title: 'La colonne des numéros de téléphone'
date: 2025-12-17
lastmod: '2025-12-17'
categories:
    - 'text-und-zahlen'
author: 'kgr'
url: '/fr/aide/la-colonne-des-numeros-de-telephone'
seo:
...
![créer une colonne de numéro de téléphone](images/column-type-phone-number.gif)
...
Vous pouvez définir une [valeur par défaut]({{< relref "help/base-editor/spalten/standardwert-fuer-eine-spalte-festlegen" >}}) pour chaque colonne de numéro de téléphone. Cette valeur sera automatiquement insérée dans chaque nouvelle ligne du tableau.
...
![appeler un numéro de téléphone](images/call-phone-number.png)