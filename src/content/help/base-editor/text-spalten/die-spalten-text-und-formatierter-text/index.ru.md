...
В SeaTable есть еще два текстовых типа столбцов для особых случаев использования: [столбец электронной почты]({{< relref "help/base-editor/text-spalten/die-e-mail-spalte-und-ihre-verwendung" >}}) и [столбец URL]({{< relref "help/base-editor/text-spalten/die-url-spalte" >}}).
