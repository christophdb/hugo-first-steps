...
En principe, vous disposez de deux méthodes différentes pour valider les entrées dans les colonnes de texte. Une validation peut être effectuée au cours de l'**ajout d'une nouvelle** [colonne de texte]({{< relref "help/base-editor/text-spalten/die-spalten-text-und-formatierter-text" >}}) **déjà créées**.
