...
Basically, there are two different ways to validate entries in text columns. Validation can be performed both when **adding a new** [text column]({{< relref "help/base-editor/text-spalten/die-spalten-text-und-formatierter-text" >}}) that have **already been created**.
