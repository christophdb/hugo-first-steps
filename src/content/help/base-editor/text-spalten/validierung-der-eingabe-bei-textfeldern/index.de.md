...
Grundsätzlich stehen Ihnen zwei verschiedene Wege für die Validierung von Eingaben in Text-Spalten zur Verfügung. Eine Validierung kann sowohl im Zuge des **Hinzufügens einer neuen** [Text-Spalte]({{< relref "help/base-editor/text-spalten/die-spalten-text-und-formatierter-text" >}}) erfolgen.
