...
![Janela para selecionar a ação de botão «Enviar e-mail»](images/send-email-action.png)
...
![Aviso indicando que é preciso adicionar primeiro uma conta de e-mail](images/add-email-account.png)
...
![Ecrã de configuração do assunto e corpo do e-mail](images/subject-and-message.png)
...
![Editor de texto formatado com placeholders de colunas inseridos](images/Spalten-in-E-Mail-Texte-einfuegen.png)
...
![Janela para inserir destinatários, endereços CC e de resposta](images/send-to-copy-to-reply-to.png)
...
![Seleção de colunas de ficheiros como fonte de anexos do e-mail](images/file-001.png)
...
![Botão envia o e-mail apenas se a coluna de ficheiro não estiver vazia](images/send-email-via-button-with-conditions-1.gif)
