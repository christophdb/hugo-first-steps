...
![Диалог выбора действия кнопки «Отправить письмо» ](images/send-email-action.png)
...
![Окно-подсказка, что сначала нужно добавить учетную запись почты](images/add-email-account.png)
...
![Экран настройки темы и текста письма](images/subject-and-message.png)
...
![Редактор форматированного текста с плейсхолдерами столбцов](images/Spalten-in-E-Mail-Texte-einfuegen.png)
...
![Диалог ввода получателей, адресов копии и ответа](images/send-to-copy-to-reply-to.png)
...
![Выбор файловых столбцов как источников вложений письма](images/file-001.png)
...
![Кнопка отправляет письмо, только если файловый столбец не пуст](images/send-email-via-button-with-conditions-1.gif)
