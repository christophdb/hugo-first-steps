...
2. Select the lowest option labeled **View or Add Folder**.
...
After you create **the first new views folder**, all the views you have already created will automatically be in the **More** Views folder. Move the views to fill your specially created folders.
