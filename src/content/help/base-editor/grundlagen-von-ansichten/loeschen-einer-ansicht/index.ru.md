---
title: 'Удалить представление - SeaTable'
date: 2022-10-26
lastmod: '2023-01-02'
categories:
...
**Нет**. Поскольку представление не содержит никаких собственных данных, а является лишь специальным представлением данных, удаленное представление не может быть удалено ни через корзину, ни через ярлык {{< keyboard "CTRL" >}} + {{< keyboard "Z" >}} Восстановить.
