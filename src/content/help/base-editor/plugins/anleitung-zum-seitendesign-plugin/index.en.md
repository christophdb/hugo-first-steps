...
Read the article [Activating a Plugin in a Base]({{< relref "help/base-editor/plugins/aktivieren-eines-plugins-in-einer-base" >}}) to learn how to activate the Page Design plugin and add it to your toolbar.
