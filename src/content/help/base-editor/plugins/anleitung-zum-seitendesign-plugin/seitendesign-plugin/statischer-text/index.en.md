...
![Move Statistical Text](images/Statischer-Text-Verschieben.gif)
...
![Static text change order](images/Statischer-text-Reihenfolge.gif)
...
![Static text input](images/Statischer-Text-eingabe-1.gif)
...
![Static text Inside spacing Vertical text](images/Statischer-Text-Innenabstand.gif)
...
![Lock, delete, duplicate static text](images/Statischer-Text-sperren-duplizieren-loeschen.gif)
