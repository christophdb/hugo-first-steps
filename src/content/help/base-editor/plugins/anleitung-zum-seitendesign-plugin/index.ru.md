...
author: 'vge'
url: '/ru/pomoshch/rukovodstvo-po-plaginu-dizayna-stranits'
aliases:
   - '/ru/pomoshch/anleitung-zum-seitendesign-plugin'
seo:
    title: 'Руководство по плагину дизайна страниц – макеты и PDF'
    description: 'Узнайте, как с помощью плагина дизайна страниц в SeaTable создавать письма, карточки и документы, а также экспортировать их в PDF.'
---
