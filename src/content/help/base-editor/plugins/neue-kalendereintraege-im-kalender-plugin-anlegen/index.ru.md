...
У вас есть различные варианты добавления **новых записей** в календарь. Вы можете сделать это **в основной таблице**, создав там новую строку и введя в [столбец даты]({{< relref "help/base-editor/spalten/die-datum-spalte" >}}die-datum-spalte/) встречу, которая затем также будет отображаться в плагине календаря.
