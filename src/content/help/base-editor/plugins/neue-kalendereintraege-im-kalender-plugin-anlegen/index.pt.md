...
Existem várias opções para adicionar **novas entradas** ao calendário. Pode fazê-lo **na tabela subjacente**, criando aí uma nova linha e introduzindo um compromisso na [coluna da data]({{< relref "help/base-editor/spalten/die-datum-spalte" >}}die-datum-spalte/), que é depois também apresentada no plugin do calendário.
