...
Um **neue Einträge** im Kalender hinzuzufügen, haben Sie verschiedene Möglichkeiten. Sie können das **in der zugrundeliegenden Tabelle** tun, indem Sie dort eine neue Zeile anlegen und einen Termin in die [Datum-Spalte]({{< relref "help/base-editor/spalten/die-datum-spalte" >}}) eintragen, der dann auch im Kalender-Plugin angezeigt wird.
