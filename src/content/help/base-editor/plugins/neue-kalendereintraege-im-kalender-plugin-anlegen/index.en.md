...
You have various options for adding **new entries** to the calendar. You can do this **in the underlying table** by creating a new row there and entering an appointment in the [date column]({{< relref "help/base-editor/numerische-spalten/die-datum-spalte" >}}), which is then also displayed in the calendar plugin.
