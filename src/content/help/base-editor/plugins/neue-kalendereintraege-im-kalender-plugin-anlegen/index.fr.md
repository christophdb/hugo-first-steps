...
Pour ajouter **de nouvelles entrées** dans le calendrier, vous avez plusieurs possibilités. Vous pouvez le faire **dans le tableau sous-jacent** en y créant une nouvelle ligne et en inscrivant une date dans la [colonne des dates]({{< relref "help/base-editor/spalten/die-datum-spalte" >}}die-datum-spalte/), qui sera ensuite également affichée dans le plug-in de calendrier.
