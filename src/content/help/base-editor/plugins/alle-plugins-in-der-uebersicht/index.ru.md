...
![Обзорная схема с значками всех плагинов SeaTable ](images/Uebersicht-ueber-alle-Plugins-in-SeaTable.gif)
...
![Плагин календаря с событиями в помесячном представлении](images/Calendar.png)
...
![Плагин временной шкалы с таймлайном проектов и периодов](images/projektmanagement-timeline.png)
...
![Плагин галереи с изображениями и подписями под миниатюрами](images/Galerie.png)
...
![Плагин дедупликации данных со списком дубликатов записей ](images/Deduplication.png)
...
![Плагин Канбан с карточками в столбцах для разных статусов](images/Kanban-Plugin.png)
...
![Плагин связей таблиц с линиями между связанными таблицами](images/Table-Relationships-Plugin.png)
