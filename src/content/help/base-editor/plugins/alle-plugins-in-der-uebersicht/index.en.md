...
In the calendar plugin you can display dates from a [date column]({{< relref "help/base-editor/spalten/die-datum-spalte" >}}) in a **year**, **month**, **week**, **day** or **agenda view**. You can also use two date columns to display **time spans** and keep track of all important dates, etc.
