...
![Настройки галереи с видимыми и скрытыми столбцами](images/galerie-plugin.png)
...
![Галерея с серым числом для нескольких изображений в альбоме](images/graue-nummer.png)
...
![Полноэкранный режим с лупами для зума и стрелками навигации](images/Vollbildmodus-im-Galerie-Plugin.png)
