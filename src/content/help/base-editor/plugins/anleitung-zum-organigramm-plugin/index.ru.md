...
Если вы хотите проиллюстрировать записи данных в организационной диаграмме изображениями, вам также понадобится [колонка изображений]({{< relref "help/base-editor/spaltentypen/die-bild-spalte" >}}) в таблице, куда можно загружать фотографии и графику.
