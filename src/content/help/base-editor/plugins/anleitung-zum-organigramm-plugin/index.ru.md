---
title: 'Руководство по плагину организационной структуры - SeaTable'
date: 2024-07-18
lastmod: '2025-02-28'
categories:
    - 'plugins'
...
Если вы хотите проиллюстрировать записи данных в организационной диаграмме изображениями, вам также понадобится [колонка изображений](https://seatable.io/ru/docs/dateien-und-bilder/die-bild-spalte/) в таблице, куда можно загружать фотографии и графику.
