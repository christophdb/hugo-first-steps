...
Si vous souhaitez illustrer les enregistrements de l'organigramme avec des images, vous avez également besoin d'une [colonne d'images]({{< relref "help/base-editor/spalten/die-bild-spalte" >}}) dans le tableau, dans laquelle vous pouvez télécharger des photos et des graphiques.
