...
Хорошим примером использования плагина Tree является [система отслеживания ошибок]({{< relref "templates/software-development/bug-tracker" >}}). В трех разных таблицах вы можете записать версии программного обеспечения, проведенные тесты и найденные ошибки. Используя древовидную диаграмму, вы можете наглядно представить все эти данные.
