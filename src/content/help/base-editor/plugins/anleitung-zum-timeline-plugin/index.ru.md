---
title: "Инструкции для плагина временной шкалы - SeaTable"
date: 2023-02-06
lastmod: "2023-08-14"
categories: 
  - "plugins"
...
Прочитайте статью [Активация плагина в базе](https://seatable.io/ru/docs/arbeiten-mit-plugins/aktivieren-eines-plugins-in-einer-base/), чтобы узнать, как активировать плагин Timeline.

## Функция подключаемого модуля временной шкалы

Плагин временной шкалы отображает **временные промежутки**. Поэтому для такого представления вам нужны **два** [столбца даты](https://seatable.io/ru/docs/datum-dauer-und-personen/die-datum-spalte/) в таблице, которые определяют **начало** и **конец** временного интервала.
...
3. В **настройках** {{< seatable-icon icon="dtable-icon-set-up" >}} определите, к какому [виду таблицы](https://seatable.io/ru/docs/grundlagen-von-ansichten/was-ist-eine-ansicht/) и к каким [столбцам дат](https://seatable.io/ru/docs/datum-dauer-und-personen/die-datum-spalte/) должна относиться новая временная шкала.
