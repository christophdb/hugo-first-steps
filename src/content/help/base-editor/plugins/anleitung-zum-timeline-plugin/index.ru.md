...
categories:
    - 'plugins'
author: 'vge'
url: '/ru/pomoshch/anleitung-zum-timeline-plugin'
---
...
Плагин временной шкалы отображает **временные промежутки**. Поэтому для такого представления вам нужны **два** [столбца даты]({{< relref "help/base-editor/numerische-spalten/die-datum-spalte" >}}) в таблице, которые определяют **начало** и **конец** временного интервала.
...
3. В **настройках** {{< seatable-icon icon="dtable-icon-set-up" >}} определите, к какому [виду таблицы]({{< relref "help/base-editor/ansichten/was-ist-eine-ansicht" >}}) и к каким [столбцам дат]({{< relref "help/base-editor/numerische-spalten/die-datum-spalte" >}}) должна относиться новая временная шкала.
