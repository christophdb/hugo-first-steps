...
Pour créer plusieurs calendriers, vous avez besoin soit **de plusieurs tableaux**, soit d'un tableau avec différentes [vues]({{< relref "help/base-editor/ansichten/anlegen-einer-neuen-ansicht" >}}), soit d'un tableau avec différentes [colonnes de dates]({{< relref "help/base-editor/numerische-spalten/die-datum-spalte" >}}).
