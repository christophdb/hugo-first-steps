...
categories:
    - 'plugins'
author: 'vge'
url: '/fr/aide/creer-calendriers-multiples-base-seatable'
aliases:
    - '/fr/aide/mehrere-kalender-fuer-eine-base-anlegen'
seo:
    title: 'Créez plusieurs calendriers dans une base SeaTable'
    description: 'Configurez différents calendriers par projet, vue ou colonne : SeaTable permet une gestion flexible du temps et des plannings d’équipe.'
...
Pour créer plusieurs calendriers, vous avez besoin soit **de plusieurs tableaux**, soit d'un tableau avec différentes [vues]({{< relref "help/base-editor/ansichten/anlegen-einer-neuen-ansicht" >}}), soit d'un tableau avec différentes [colonnes de dates]({{< relref "help/base-editor/spaltentypen/die-datum-spalte" >}}).
