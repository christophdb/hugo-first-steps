...
Para crear varios calendarios, necesita **varias tablas** o una tabla con diferentes [vistas]({{< relref "help/base-editor/ansichten/anlegen-einer-neuen-ansicht" >}}) o una tabla con diferentes [columnas de fecha]({{< relref "help/base-editor/spalten/die-datum-spalte" >}}die-datum-spalte/).
