...
Для создания нескольких календарей необходимо либо **несколько таблиц**, либо таблица с различными [представлениями]({{< relref "help/base-editor/ansichten/anlegen-einer-neuen-ansicht" >}}), либо таблица с различными [столбцами дат]({{< relref "help/base-editor/numerische-spalten/die-datum-spalte" >}}).
