...
**Группировка** определяет, какой столбец определяет **столбцы**. [Колонки]({{< relref "help/base-editor/auswahl-spalten/die-spalte-mitarbeiter" >}}) особенно подходят для этого.
