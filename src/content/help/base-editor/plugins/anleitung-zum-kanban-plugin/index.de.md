...
Die **Gruppierung** bestimmt, welche Spalte die **Säulen** definiert. Hierfür eignen sich besonders [Auswahl-](https://seatable.io/docs/auswahlspalten/anlegen-einer-einfachauswahl-spalte/) und [Mitarbeiter-Spalten](https://seatable.io/docs/datum-dauer-und-personen/die-spalte-mitarbeiter/).
