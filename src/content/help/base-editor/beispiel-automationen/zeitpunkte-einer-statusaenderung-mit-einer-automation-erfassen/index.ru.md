---
title: 'Захват времени изменения состояния с помощью автоматизации - SeaTable'
date: 2023-04-28
lastmod: '2023-04-28'
categories:
...
В другой таблице ("Журнал состояния заказов") также необходимо видеть различные **номера заказов** вместе с соответствующими **суммами**. Кроме того, в этой таблице в [столбце](https://seatable.io/ru/docs/datum-dauer-und-personen/die-datum-spalte/) даты "Последнее изменение статуса" указывается **время последнего** изменения статуса.
