...
seo:
    ...
    description: 'Lancez des opérations de traitement des données par automation : calculez, reliez des tables et optimisez vos processus sans intervention manuelle répétée.'
