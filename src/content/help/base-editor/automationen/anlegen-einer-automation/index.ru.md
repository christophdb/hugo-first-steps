---
title: "Создание автоматизации - SeaTable"
date: 2022-12-06
lastmod: "2023-03-10"
categories: 
  - "automationen"
...
![На первом этапе вы сначала определяете основные настройки для вновь созданной автоматизации](https://seatable.io/wp-content/uploads/2022/12/steps-to-create-an-automation-1-1.png)
...
![Определение события, которое запускает автоматизацию в качестве триггера](https://seatable.io/wp-content/uploads/2022/12/steps-to-create-an-automation-2-1.png)
...
![Определение автоматического действия, запускаемого ранее определенным триггерным событием.](https://seatable.io/wp-content/uploads/2022/12/steps-to-create-an-automation-3.png)
