...
Узнать, как удалить автоматизацию, можно [здесь](https://seatable.io/ru/docs/arbeiten-mit-automationen/automationen-loeschen/).
...
Узнайте больше о триггерах автоматизации [здесь](https://seatable.io/ru/docs/arbeiten-mit-automationen/automations-trigger/).
...
Узнать, как добавлять линии с помощью автоматизации, можно [здесь](https://seatable.io/ru/docs/beispiel-automationen/zeilen-per-automation-hinzufuegen/).
...
Узнайте [здесь](https://seatable.io/ru/docs/beispiel-automationen/eintraege-in-andere-tabellen-per-automation-hinzufuegen/), как добавить записи в другие таблицы с помощью автоматизации.
...
Узнайте [здесь](https://seatable.io/ru/docs/beispiel-automationen/e-mail-versand-per-automation/), как можно отправлять электронные письма с помощью автоматизации.
