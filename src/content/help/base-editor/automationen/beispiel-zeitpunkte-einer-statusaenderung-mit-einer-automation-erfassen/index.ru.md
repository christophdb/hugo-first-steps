...
author: 'nsc2'
url: '/ru/pomoshch/avtomaticheskiy-uchet-vremeni-statusa'
aliases:
...
В другой таблице ("Журнал состояния заказов") также необходимо видеть различные **номера заказов** вместе с соответствующими **суммами**. Кроме того, в этой таблице в [столбце]({{< relref "help/base-editor/spaltentypen/die-datum-spalte" >}}) даты "Последнее изменение статуса" указывается **время последнего** изменения статуса.
