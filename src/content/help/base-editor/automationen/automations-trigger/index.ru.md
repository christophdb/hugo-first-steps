...
![Доступные в настоящее время триггерные события](images/types-of-trigger-events.png)
...
![Возможные ограничения события срабатывания: Когда добавляется новая запись](images/specialization-of-trigger-records-added.png)
...
![Настройка параметров для периодического триггера](images/specification-periodic-trigger.png)
...
![Триггер автоматизации: "Периодический триггер, когда записи соответствуют определенным условиям".](images/trigger-event-periodic-match-conditions.png)
