...
С помощью **столбца ссылок** в SeaTable можно не только [связать несколько таблиц](https://seatable.io/ru/docs/verknuepfungen/wie-man-tabellen-in-seatable-miteinander-verknuepft/), но и **соотнести записи данных в одной и той же таблице**.
...
{{< warning  headline="Внимание"  text="Два столбца ссылок **неразрывно** связаны между собой. Если вы **удалите** один из двух столбцов, второй также немедленно исчезнет. Однако если вы хотите видеть в таблице только один из двух столбцов, вы можете [скрыть](https://seatable.io/ru/docs/ansichtsoptionen/ausblenden-und-verschieben-von-spalten/) второй." />}}
...
- Если вы хотите наглядно **представить** иерархические связи, мы можем порекомендовать вам [плагин организационной диаграммы](https://seatable.io/ru/docs/plugins/anleitung-zum-organigramm-plugin/).
- По всем остальным вопросам работы с колонками ссылок обращайтесь к статье [Как связать таблицы в SeaTable](https://seatable.io/ru/docs/verknuepfungen/wie-man-tabellen-in-seatable-miteinander-verknuepft/).
