...
Die Lookup-Funktion kann nur verwendet werden, wenn bereits eine Spalte des Typs _Verknüpfung zu anderen Einträgen_ existiert. Wenn Sie bisher keine solche Spalte haben, legen Sie zuerst eine an. Wie das funktioniert, erfahren Sie [hier](https://seatable.io/docs/verknuepfungen/wie-man-tabellen-in-seatable-miteinander-verknuepft/).
