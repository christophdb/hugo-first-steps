...
categories:
    - 'arbeiten-mit-bases'
author: 'nsc2'
url: '/es/ayuda/configurar-email-base-seatable'
aliases:
    - '/es/ayuda/einrichtung-eines-e-mail-kontos-in-einer-base'
seo:
    title: 'Configurar correo electrónico en base de SeaTable'
    description: 'Integre su cuenta de correo electrónico a una base SeaTable, incluya pruebas, envíe mails automáticos y optimice la seguridad con los principales proveedores.'
...
Si todo ha funcionado según lo descrito, ha configurado correctamente su cuenta de correo electrónico en SeaTable y puede empezar a enviar correos electrónicos mediante [automatización]({{< relref "help/base-editor/schaltflaechen/eine-e-mail-per-schaltflaeche-verschicken" >}}).
...
- [Envío por correo electrónico mediante un botón]({{< relref "help/base-editor/schaltflaechen/eine-e-mail-per-schaltflaeche-verschicken" >}})
