...
categories:
    - 'arbeiten-mit-bases'
author: 'nsc2'
url: '/fr/aide/configurer-email-base-seatable'
aliases:
    - '/fr/aide/einrichtung-eines-e-mail-kontos-in-einer-base'
seo:
    title: 'Configurer e-mail dans une base SeaTable et envoyer'
    description: 'Ajoutez un compte email à SeaTable, effectuez les tests, bénéficiez de l’envoi automatique et suivez les conseils sécurité selon votre fournisseur.'
...
Si tout s'est déroulé comme décrit, vous avez configuré avec succès votre compte e-mail dans SeaTable et vous pouvez commencer à envoyer des e-mails par [automatisation]({{< relref "help/base-editor/schaltflaechen/eine-e-mail-per-schaltflaeche-verschicken" >}}).
...
- [Envoi d'e-mails par bouton]({{< relref "help/base-editor/schaltflaechen/eine-e-mail-per-schaltflaeche-verschicken" >}})
