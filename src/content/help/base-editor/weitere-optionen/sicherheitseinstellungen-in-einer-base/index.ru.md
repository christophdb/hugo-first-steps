...
categories:
    - 'arbeiten-mit-bases'
author: 'nsc2'
url: '/ru/pomoshch/nastroiki-bezopasnosti-v-base'
aliases:
    - '/ru/pomoshch/sicherheitseinstellungen-in-einer-base'
seo:
    title: 'Настройки безопасности в базе SeaTable: инструкция'
    description: 'Безопасность в SeaTable: ограничьте экспорт, печать, копирование и обработку данных для всех пользователей и групп.'
...
Активировав этот параметр, вы можете **запретить** другим пользователям [печатать]({{< relref "help/base-editor/ansichten/das-drucken-einer-ansicht" >}}) различные табличные представления вашей базы.
...
Вторая часть настроек безопасности относится к полномочиям **пользователей**, которым доступна соответствующая [база]({{< relref "help/startseite/freigaben/anlegen-einer-benutzerfreigabe" >}}). В этой части вы можете сделать те **же** настройки, которые уже доступны всем пользователям в первой части:
...
Активировав эту настройку, вы можете **запретить** пользователям, для которых [выпущена]({{< relref "help/base-editor/ansichten/das-drucken-einer-ansicht" >}}) различные табличные представления базы.
