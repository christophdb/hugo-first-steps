...
![Kopieren der Zeilen-URL über die Tabellenansicht](images/copy-cell-URL.jpg)
...
![Aufklopfende Erfolgsmeldung bei erfolgreichem Kopieren der Zeilen-URL](images/Erfolgsmeldung-Kopieren-Zeilen-URL.png)

## So kopieren Sie die Zeilen-URL über die Zeilendetails

![Kopieren der Zeilen-URL über die Zeilendetails](images/copy-URL-1.gif)
...
{{< warning  type="warning" headline="Tipp"  text="Sie können die Zeilen-URL auch der **Suchzeile Ihres Browsers** entnehmen, sobald Sie die Zeilendetails geöffnet haben." />}}
