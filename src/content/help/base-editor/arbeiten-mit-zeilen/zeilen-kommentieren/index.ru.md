---
title: 'Комментарий к рядам - SeaTable'
date: 2022-11-16
lastmod: '2025-02-27'
categories:
    - 'arbeiten-mit-zeilen'
...
Вы можете привлечь внимание членов команды к своему комментарию, связавшись с ними через **Плюс символ** чтобы добавить в чат. Кроме того, вы можете добавить {{< keyboard "@" >}} и **Имя участника** чтобы добавить членов команды в чат. Член команды получает **Уведомление в SeaTable** и будет получать уведомления о новых комментариях в истории чата, даже если в нем больше не будет упоминаний о {{< keyboard "@" >}} происходит.
