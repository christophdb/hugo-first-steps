...
- Duration and periods = duration [column](https://seatable.io/en/docs/datum-dauer-und-personen/die-dauer-spalte/)
- Date and times = [date column](https://seatable.io/en/docs/datum-dauer-und-personen/die-datum-spalte/)
