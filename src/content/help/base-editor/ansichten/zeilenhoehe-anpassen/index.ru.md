---
title: 'Регулировка высоты строки'
date: 2022-10-26
lastmod: '2023-03-28'
categories:
    - 'ansichtsoptionen'
...
- Простой (значение по умолчанию для новых таблиц и представлений)
- Двойной
- Тройной
- Четырехсторонний
...
{{< warning  headline="Одна высота строки для всех строк"  text="Высота строки всегда настраивается для **всех строк** в представлении. Высота отдельных рядов в представлении невозможна." />}}
