...
![Скрыть колонки](images/hide-columns.gif)
...
{{< warning  headline="Примечание"  text="Вы можете решить **отдельно для каждого столбца**, должен ли он быть показан или скрыт, или, нажав кнопку **Скрыть все**, одновременно скрыть все столбцы, кроме первого столбца таблицы. Так же легко вы можете снова показать все колонки, нажав кнопку **Показать все**." />}}

## Переместить колонки

Удерживайте левую кнопку мыши на области **шеститочечного захвата** перед названиями колонок и перетаскивайте их вверх или вниз в списке, чтобы изменить порядок столбцов в таблице по желанию.
