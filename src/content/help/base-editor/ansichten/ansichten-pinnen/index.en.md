...
seo:
    ...
    description: 'Learn to pin views for fast navigation, quick switching and easy comparison.'
weight: 8
---
...
2. Click on the **pin** {{< seatable-icon icon="dtable-icon-pin" color="grey" >}} in the top right corner.

![Pinning the different views of a table](images/pin-view-list.gif)

As long as the pin is highlighted in **red**, the available table views are **pinned** to the left-hand side of the page. To **hide** the view navigation, click on the pin again.
