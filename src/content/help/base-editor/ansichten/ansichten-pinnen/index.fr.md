...
1. Cliquez sur l'icône déroulante {{< seatable-icon icon="dtable-icon-drop-down" color="grey" >}} à côté de la vue actuellement ouverte.
2. Cliquez sur l'épingle {{< seatable-icon icon="dtable-icon-pin" color="grey" >}}.

![Épingler les différentes vues d'un tableau](images/pin-views-of-a-table.gif)
