...
С помощью идентификатора пользователя можно устанавливать **динамические фильтры** в SeaTable, которые в определенных ситуациях подходят лучше, чем фильтр по [колонке создателя]({{< relref "help/base-editor/spalten/die-spalten-ersteller-und-erstelldatum" >}}). В этой статье мы представляем преимущества и недостатки фильтров с идентификатором пользователя.
