...
With the help of User ID you can set **dynamic filters** in SeaTable, which in certain situations is more suitable than filtering by the [creator column]({{< relref "help/base-editor/spaltentypen/die-spalten-ersteller-und-erstelldatum" >}}). In this article we will present you the advantages and disadvantages of filters with User ID.
...
The alternative would be to filter by the [Creator]({{< relref "help/base-editor/spaltentypen/die-mitarbeiter-spalte" >}}) column, which also offer dynamic filtering options. However, these two columns have the following disadvantages:
