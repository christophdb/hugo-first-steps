...
Приватные представления, как следует из названия, **не** видны другим пользователям. Поэтому они особенно подходят для просмотра личных данных при совместной работе с другими пользователями в таблице, где настройки представления[(фильтры]({{< relref "help/base-editor/ansichten/farbliche-markierung-von-zeilen" >}}), [скрытые столбцы](https://seatable.io/ru/docs/ansichtsoptionen/ausblenden-und-verschieben-von-spalten/)) часто меняются.
