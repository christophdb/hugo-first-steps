...
seo:
    title: 'Руководство по Kanban-плагину в SeaTable – доска и советы'
    description: 'Освойте настройку и работу с Kanban-плагином SeaTable для визуализации процессов, управления проектами и совместной работы.'
---
