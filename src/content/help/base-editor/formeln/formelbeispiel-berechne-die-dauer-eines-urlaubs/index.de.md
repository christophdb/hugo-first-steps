...
![Beispiel-Tabelle zur Berechnung der Dauer von Urlauben mithilfe einer Formel](images/Beispiel-Tabelle-zur-Berechnung-der-Dauer-von-Urlauben-mithilfe-einer-Formel.png)
...
![Eingabe der Formel in das hierfür vorgesehene Textfeld](images/input-formular-2-1.jpg)
...
![Hinzufügen der Verweise auf die Namen der Tabellen-Spalten, in denen die Ankunfts- und Abreisedaten zu finden sind](images/reference-to-columns.jpg)
...
![Beenden der Formel mit der Berechnungsmethodik und einer Klammer](images/finish-formular.jpg)
...
![Das Ergebnis der Formel ist die Dauer des Urlaubs in Tagen](images/Das-Ergebnis-der-Formel-ist-die-Dauer-des-Urlaubs-in-Tagen.png)
...
![Das Ergebnis der Formel als Zeitraum inklusive Abreisetag](images/Das-Ergebnis-der-Formel-als-Zeitraum-inklusive-Abreisetag.png)
