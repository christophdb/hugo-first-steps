---
title: 'Пример формулы: вычисление дней до события - SeaTable'
date: 2023-01-28
lastmod: '2023-09-21'
categories:
    - 'formeln'
author: 'nsc2'
url: '/ru/help/formelbeispiel-berechne-tage-bis-zu-einem-event'
---
...
![Пример таблицы Вычисление дней до события с помощью формулы](https://seatable.io/wp-content/uploads/2023/01/example-table-days-until-event.png)

Для этого сначала добавьте в таблицу **столбец формул**, в редактор которого затем можно вставить **формулу**.

![Добавление формулы в предназначенное для этого текстовое поле](https://seatable.io/wp-content/uploads/2023/01/insert-formular-example-days-until-event.png)
...
![Добавление функции "now" и закрытие функции скобкой](https://seatable.io/wp-content/uploads/2023/01/add-now-and-close-the-.png)
...
![Добавьте ссылку на имя столбца таблицы, в котором находятся данные о событии.](https://seatable.io/wp-content/uploads/2023/01/add-reference-to-event-date.png)
...
![Окончание формулы с методикой расчета ](https://seatable.io/wp-content/uploads/2023/01/finish-the-formular-example-days-until-event.png)
...
![После подтверждения формулы оставшиеся дни будут автоматически рассчитаны и добавлены в столбец формулы вашей таблицы.](https://seatable.io/wp-content/uploads/2023/01/table-after-formular-days-until-events.png)
