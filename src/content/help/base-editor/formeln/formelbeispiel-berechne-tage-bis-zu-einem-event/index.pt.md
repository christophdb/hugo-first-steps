...
![Tabela de exemplo Calcular dias até um evento com uma fórmula](https://seatable.io/wp-content/uploads/2023/01/example-table-days-until-event.png)

Para o fazer, comece por adicionar uma **coluna de fórmula** à tabela, em cujo editor pode então inserir a **fórmula**.

![Acrescentar uma fórmula no campo de texto previsto para o efeito](https://seatable.io/wp-content/uploads/2023/01/insert-formular-example-days-until-event.png)
...
![Acrescentar a função "agora" e fechar a função com um parêntesis](https://seatable.io/wp-content/uploads/2023/01/add-now-and-close-the-.png)
...
![Acrescentar a referência ao nome da coluna da tabela onde os dados do evento podem ser encontrados.](https://seatable.io/wp-content/uploads/2023/01/add-reference-to-event-date.png)
...
![Terminar a fórmula com a metodologia de cálculo ](https://seatable.io/wp-content/uploads/2023/01/finish-the-formular-example-days-until-event.png)
...
![Após confirmar a fórmula, os dias restantes são automaticamente calculados e adicionados à coluna da fórmula da sua tabela.](https://seatable.io/wp-content/uploads/2023/01/table-after-formular-days-until-events.png)
