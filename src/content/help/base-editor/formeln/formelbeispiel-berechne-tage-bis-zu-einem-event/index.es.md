...
categories:
    - 'formeln'
author: 'nsc2'
url: '/es/ayuda/formula-calcular-dias-hasta-evento-seatable'
aliases:
    - '/es/ayuda/formelbeispiel-berechne-tage-bis-zu-einem-event'
seo:
    title: 'Fórmula: calcule días hasta evento en SeaTable'
    description: 'Calcule automáticamente los días restantes hasta una fecha o evento usando una fórmula simple en su tabla SeaTable.'
...
![Tabla de ejemplo Calcular días hasta un evento con una fórmula](images/example-table-days-until-event.png)

Para ello, añada primero una **columna de fórmulas** a la tabla, en cuyo editor podrá insertar después la **fórmula**.

![Añadir una fórmula en el campo de texto previsto a tal efecto](images/insert-formular-example-days-until-event.png)
...
![Añadir la función "now" y cerrar la función con un corchete](images/add-now-and-close-the-.png)
...
![Añade la referencia al nombre de la columna de la tabla donde se encuentran los datos del evento.](images/add-reference-to-event-date.png)
...
![Finalizar la fórmula con la metodología de cálculo ](images/finish-the-formular-example-days-until-event.png)
...
![Tras confirmar la fórmula, los días restantes se calculan automáticamente y se añaden a la columna de fórmulas de su tabla.](images/table-after-formular-days-until-events.png)
