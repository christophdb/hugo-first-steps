---
title: 'Пример формулы: объединение текстовых колонок с помощью формулы - SeaTable'
date: 2023-01-28
lastmod: '2023-09-18'
categories:
    - 'formeln'
...
![Пример таблицы для объединения различного содержимого в один столбец формул](https://seatable.io/wp-content/uploads/2023/01/example-table-zusammenfuehren-von-inhalten-mit-Formel.png)

Для этого сначала добавьте в таблицу **столбец формул**, в редактор которого затем можно вставить формулу.

![Добавление формулы в предназначенное для этого текстовое поле](https://seatable.io/wp-content/uploads/2023/01/insert-formular-example-1.png)
...
![Когда вы ссылаетесь на имена столбцов в своих таблицах, всегда заключайте их в фигурные скобки](https://seatable.io/wp-content/uploads/2023/01/verweis-auf-spaltennamen-in-formel-beispiel-2.png)
...
![Расположите имена различных столбцов в нужном порядке в формуле и разделите их символом &](https://seatable.io/wp-content/uploads/2023/01/insert-symbols.png)
...
![Добавление дополнительного символа & и двух перевернутых запятых после первых двух имен столбцов](https://seatable.io/wp-content/uploads/2023/01/insert-and-22-22-to-the-formular.png)
...
![столбец Формула после подтверждения введенной формулы.](https://seatable.io/wp-content/uploads/2023/01/table-example-2-after-formular.png)
