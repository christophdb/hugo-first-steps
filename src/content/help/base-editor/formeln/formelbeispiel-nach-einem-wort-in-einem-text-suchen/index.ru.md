---
title: 'Пример формулы: Поиск слова в тексте - SeaTable'
date: 2023-01-28
lastmod: '2023-09-19'
categories:
    - 'formeln'
author: 'nsc2'
url: '/ru/help/formelbeispiel-nach-einem-wort-in-einem-text-suchen'
---

Формулы SeaTable предлагают различные способы работы с данными в таблицах. Одним из них является поиск **слов в тексте**. Введя соответствующую формулу, можно автоматически искать в [текстовом столбце](https://seatable.io/ru/docs/text-und-zahlen/die-spalten-text-und-formatierter-text/) какие-либо слова и получать подсказку - например, "слово найдено/не найдено" - в виде результата в столбце формул таблицы.

## Поиск слова в тексте

В конкретном примере задача заключается в поиске **слова** в текстовом столбце **"Запрос"** с помощью формулы.

![Пример таблицы для поиска слов в тексте с помощью формулы ](https://seatable.io/wp-content/uploads/2023/01/example-table-search-words-in-text.png)

Для этого сначала добавьте в таблицу **столбец формул**, в редактор которого затем можно вставить **формулу**.

![Ввод формулы в предназначенное для этого текстовое поле](https://seatable.io/wp-content/uploads/2023/01/input-formula-example-text.jpg)
...
![Добавьте в формулу функцию "if".](https://seatable.io/wp-content/uploads/2023/01/add-if-to-formular.jpg)
...
![Добавление текстовой функции "найти" в формулу](https://seatable.io/wp-content/uploads/2023/01/add-find-to-formula.jpg)
...
![Добавление искомого слова в текстовую колонку](https://seatable.io/wp-content/uploads/2023/01/add-the-word-searching-for.jpg)
...
![Добавьте имя столбца, который будет проверяться на наличие искомого слова.](https://seatable.io/wp-content/uploads/2023/01/add-reference-column.jpg)
...
![Добавление математического уравнения для завершения условия](https://seatable.io/wp-content/uploads/2023/01/add-.jpg)
...
![Добавьте значения, которые будут возвращены, если искомое слово присутствует или отсутствует в столбце формулы.  ](https://seatable.io/wp-content/uploads/2023/01/add-values.jpg)
...
![Завершение формулы закрытием скобки](https://seatable.io/wp-content/uploads/2023/01/finish-formula.jpg)
...
![Результат формулы автоматически появляется в столбце формул после подтверждения формулы.](https://seatable.io/wp-content/uploads/2023/01/table-after-formular-search-word.png)
