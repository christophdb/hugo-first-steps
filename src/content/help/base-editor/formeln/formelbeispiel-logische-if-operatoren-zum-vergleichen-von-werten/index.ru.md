...
seo:
    ...
    description: 'Используйте операторы IF в формулах SeaTable, чтобы автоматически заполнять значения по условиям, с примерами обращений и множественных проверок.'
---
