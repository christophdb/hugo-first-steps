---
title: 'Пример формулы: Логические операторы if для условного заполнения значений - SeaTable'
date: 2023-01-28
lastmod: '2023-09-19'
categories:
    - 'formeln'
...
![Добавление столбца формул и ввод формулы в редакторе](https://seatable.io/wp-content/uploads/2023/01/Hinzufuegen-der-Formel-Spalte-und-Eingabe-der-Formel-im-Editor.png)
...
![Добавление оператора If к формуле](https://seatable.io/wp-content/uploads/2023/01/add-if-operator.jpg)
...
![Ссылка на столбец, в котором должны выполняться заданные условия](https://seatable.io/wp-content/uploads/2023/01/Verweis-auf-die-Spalte-in-der-die-definierten-Bedingungen-eintreten-muessen.png)
