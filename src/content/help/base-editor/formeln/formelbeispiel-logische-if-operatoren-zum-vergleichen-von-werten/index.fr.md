...
seo:
    ...
    description: 'Utilisez les opérateurs IF dans les formules SeaTable pour remplir automatiquement selon les conditions, avec exemples d’appel, comparaison et tests multiples.'
---
