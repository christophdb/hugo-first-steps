---
title: 'Извлеките таблицы, строки и столбцы из мусора - SeaTable'
date: 2022-10-11
lastmod: '2023-01-11'
categories:
...
Можно ли также отменить последние записи?|||

Конечно, у вас есть возможность отменить последние изменения. Подробнее читайте в разделе " [Действия отмены](https://seatable.io/ru/docs/historie-und-versionen/aktionen-rueckgaengig-machen/)".

---

Создаются ли автоматические резервные копии моей базы?|||

Да, когда в базу вносятся изменения, ежедневно создается так называемый **снимок** базы, который затем можно восстановить. Для получения более подробной информации см. разделы [Сохранение текущей базы в виде моментального снимка](https://seatable.io/ru/docs/historie-und-versionen/speichern-der-aktuellen-base-als-snapshot/) и [Восстановление моментального снимка](https://seatable.io/ru/docs/historie-und-versionen/wiederherstellung-eines-snapshots/).

---

Можно ли также сделать полную резервную копию базы?|||

Да, это возможно и в SeaTable с помощью функции экспорта. Подробнее об этом читайте в разделе [Импорт и экспорт данных](https://seatable.io/ru/docs/seatable-nutzen/datenimport-und-export/).
