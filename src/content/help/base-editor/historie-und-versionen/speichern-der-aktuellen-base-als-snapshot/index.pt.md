...
Com o [SeaTable Cloud](https://seatable.io/pt/), a duração do armazenamento dos instantâneos depende da [subscrição da sua equipa](https://seatable.io/pt/preise/):
...
- [Opções de recuperação de dados com SeaTable](https://seatable.io/pt/docs/historie-und-versionen/moeglichkeiten-der-datenwiederherstellung/)
