---
title: 'Guardar la base actual como una instantánea - SeaTable'
date: 2022-10-11
lastmod: '2024-06-11'
categories:
...
Con [SeaTable Cloud](https://seatable.io/es/), la duración del almacenamiento de las instantáneas depende de [la suscripción de su equipo](https://seatable.io/es/preise/):
...
Si opera su propio [servidor SeaTable](https://seatable.io/es/on-premises), puede establecer individualmente la duración del almacenamiento de instantáneas.
