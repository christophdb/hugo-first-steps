---
title: 'Варианты восстановления данных с помощью SeaTable - SeaTable'
date: 2022-10-11
lastmod: '2023-01-11'
categories:
...
![Восстановление отдельных линий](https://seatable.io/wp-content/uploads/2021/10/Trash-Versionierung.png)

## 3\. отмена действий

Вы, вероятно, знаете комбинацию клавиш {{< keyboard "CTRL" >}} + {{< keyboard "Z" >}}чтобы отменить последнее действие. SeaTable также предлагает именно эту функцию. Кроме того, его можно выполнить щелчком мыши в раскрывающемся меню, показанном выше.
...
Для получения дополнительной информации см. статью [Отмена изменений через журналы](https://seatable.io/ru/docs/historie-und-versionen/aenderungen-ueber-die-logs-rueckgaengig-machen/).
