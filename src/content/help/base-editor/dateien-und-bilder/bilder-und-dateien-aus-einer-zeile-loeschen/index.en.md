...
SeaTable allows you to **delete** **files** and **images** in several ways. The following instructions apply to both [image](https://seatable.io/en/docs/dateien-und-bilder/die-bild-spalte/) and [file columns](https://seatable.io/en/docs/dateien-und-bilder/die-datei-spalte/).
