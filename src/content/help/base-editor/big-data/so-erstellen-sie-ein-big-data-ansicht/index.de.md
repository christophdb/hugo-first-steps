...
{{< warning  headline="Voraussetzung"  text="Sie können eine Big-Data-Ansicht nur dann erstellen, wenn Sie innerhalb der Base den [Big-Data-Speicher bereits aktiviert haben]({{< relref "help/base-editor/big-data/aktivieren-des-big-data-backends-in-einer-base" >}})." />}}
