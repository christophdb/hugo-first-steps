...
Si vous souhaitez par exemple **archiver d'anciennes entrées**, vous pouvez filtrer l'affichage au préalable avec les types de colonnes [Créé]({{< relref "help/base-editor/spalten/die-spalten-ersteller-und-erstelldatum" >}}) ou [Dernièrement modifié]({{< relref "help/base-editor/spalten/die-spalten-letzter-bearbeiter-und-bearbeitungsdatum" >}}).
