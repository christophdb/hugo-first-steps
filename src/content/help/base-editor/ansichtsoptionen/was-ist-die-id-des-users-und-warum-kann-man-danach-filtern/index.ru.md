---
title: 'Что такое идентификатор пользователя и как с его помощью можно фильтровать? - SeaTable'
date: 2023-04-25
lastmod: '2023-05-12'
categories:
    - 'ansichtsoptionen'
...
Альтернативой может быть фильтрация по столбцу " [Создатель"](https://seatable.io/ru/docs/datum-dauer-und-personen/die-spalten-ersteller-und-erstellt/) или " [Сотрудники"](https://seatable.io/ru/docs/datum-dauer-und-personen/die-spalte-mitarbeiter/), которые также предлагают динамические возможности фильтрации. Однако эти два столбца имеют следующие недостатки:
