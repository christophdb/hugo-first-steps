---
title: 'Comment personnaliser le type de colonne - SeaTable'
date: 2022-10-10
lastmod: '2024-03-15'
categories:
...
La **conversion** de certains types de colonnes entraîne généralement une **perte de données** indésirable. C'est par exemple le cas des [colonnes](https://seatable.io/fr/docs/dateien-und-bilder/die-bild-spalte/) [de fichiers](https://seatable.io/fr/docs/dateien-und-bilder/die-datei-spalte/) et [d'images](https://seatable.io/fr/docs/dateien-und-bilder/die-bild-spalte/) ou lorsque vous convertissez [des colonnes de texte](https://seatable.io/fr/docs/text-und-zahlen/die-spalten-text-und-formatierter-text/) en colonnes numériques. Dans ces cas, SeaTable affiche un **message d'avertissement** vous demandant si vous souhaitez vraiment changer le type de colonne.
