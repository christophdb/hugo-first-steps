---
title: 'Las características especiales de la primera columna - SeaTable'
date: 2022-10-13
lastmod: '2024-03-15'
categories:
...
- La primera columna sólo admite los **tipos de columna** [texto](https://seatable.io/es/docs/text-und-zahlen/die-spalten-text-und-formatierter-text/), [número](https://seatable.io/es/docs/text-und-zahlen/die-zahlen-spalte/), [fecha](https://seatable.io/es/docs/datum-dauer-und-personen/die-datum-spalte/), [selección única](https://seatable.io/es/docs/auswahlspalten/anlegen-einer-einfachauswahl-spalte/), [número automático](https://seatable.io/es/docs/text-und-zahlen/der-spaltentyp-automatische-nummer/) y [fórmula](https://seatable.io/es/docs/formeln/grundlagen-von-seatable-formeln/).
