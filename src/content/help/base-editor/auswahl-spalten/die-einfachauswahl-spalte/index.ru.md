...
Все функции, представленные в этом разделе, одинаково применимы и к [столбцу мультивыбора]({{< relref "help/base-editor/auswahl-spalten/die-mehrfachauswahl-spalte" >}}).
{{< /warning >}}
