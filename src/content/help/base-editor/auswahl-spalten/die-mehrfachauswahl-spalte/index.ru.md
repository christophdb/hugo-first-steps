...
Добавление параметров в колонку с несколькими вариантами выбора происходит так же, как и в **колонку с одним вариантом выбора**. Вы можете добавлять новые параметры несколькими способами. Узнайте об этом в отдельной статье [Добавление параметров в колонку с одним выбором]({{< relref "help/base-editor/auswahl-spalten/hinzufuegen-von-optionen-zu-einer-einfachauswahl-spalte" >}}).
