...
L'ajout d'options à une colonne de sélection multiple fonctionne **de la même manière que pour une colonne de sélection unique**. Vous pouvez ajouter de nouvelles options de plusieurs manières. Pour en savoir plus, consultez l'article [sur la colonne de sélection unique]({{< relref "help/base-editor/auswahl-spalten/die-einfachauswahl-spalte" >}}).
