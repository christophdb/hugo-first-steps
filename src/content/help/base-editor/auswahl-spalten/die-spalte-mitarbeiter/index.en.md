...
When sending notifications via [automations]({{< relref "help/base-editor/schaltflaechen/die-schaltflaeche" >}}), you can select all persons entered in the employee column as recipients of the message.
