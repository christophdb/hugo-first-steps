...
Beim Senden von Benachrichtigungen über [Automationen]({{< relref "help/base-editor/schaltflaechen/die-schaltflaeche" >}}) können Sie alle in der Mitarbeiter-Spalte eingetragenen Personen als Empfänger der Nachricht auswählen.
