...
При отправке уведомлений с помощью [автоматики]({{< relref "help/base-editor/schaltflaechen/die-schaltflaeche" >}}) вы можете выбрать в качестве получателей сообщения всех лиц, указанных в столбце "Сотрудники".
