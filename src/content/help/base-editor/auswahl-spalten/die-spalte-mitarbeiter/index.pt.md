...
Ao enviar notificações através de [automatismos]({{< relref "help/base-editor/schaltflaechen/die-schaltflaeche" >}}), é possível selecionar todas as pessoas introduzidas na coluna do empregado como destinatários da mensagem.
