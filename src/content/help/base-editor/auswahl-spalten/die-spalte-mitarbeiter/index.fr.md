...
Lorsque vous envoyez des notifications via [des automatismes]({{< relref "help/base-editor/schaltflaechen/die-schaltflaeche" >}}), vous pouvez sélectionner toutes les personnes inscrites dans la colonne des collaborateurs comme destinataires du message.
