...
![Campo de selección único en SeaTable.](images/single-select-column.png)
...
Puede añadir nuevas opciones a una columna de selección única de varias maneras. Apréndalo todo en el artículo [Añadir opciones a una columna de selección]({{< relref "help/base-editor/auswahl-spalten/hinzufuegen-von-optionen-zu-einer-einfachauswahl-spalte" >}}) única.
...
Al crear una columna de selección única, tiene la opción de establecer un **valor predeterminado** preestablecido. El valor por defecto se asigna **automáticamente** como opción a cada nueva fila.

![Valor por defecto para una sola columna de selección](images/default-value-single-select.png)

## ¿Selección única o columna de enlaces?

Si desea poder almacenar **información adicional** para cada opción de selección, debería considerar convertir la columna de selección única en una [columna de enlace]({{< relref "help/base-editor/tabellen/wie-man-tabellen-in-seatable-miteinander-verknuepft" >}}). A continuación, puede crear un registro completo para cada opción en una tabla independiente.
