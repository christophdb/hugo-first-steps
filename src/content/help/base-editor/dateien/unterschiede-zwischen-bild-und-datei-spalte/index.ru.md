...
Для записи **файлов** и **изображений** в SeaTable доступны два типа колонок с одинаковым названием. [Колонка изображений]({{< relref "help/base-editor/dateien/die-bild-spalte" >}}) - это [колонка файлов](https://seatable.io/ru/docs/datei-und-bildanhaenge/die-datei-spalte/) с ограниченным доступом, поскольку она принимает только специальные форматы файлов изображений. Это ограничение может быть очень практичным в некоторых приложениях.
