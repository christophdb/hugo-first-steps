...
url: '/ru/pomoshch'
seo:
    title: 'Справка SeaTable – поддержка, документация и руководства'
    description: 'Найдите ответы в Справке SeaTable: полная документация, видеоуроки, форум сообщества, руководства администратора и техническая поддержка.'
