...
![Шаблон SeaTable автоматически формирует коммерческое предложение и показывает предварительный просмотр документа](images/image-1741253045784.gif)
...
![Табличный обзор составляющих оферты с данными клиентов, позиций и сумм](images/image-1741191669169.png)
...
![Процесс в SeaTable: создать коммерческое предложение, сохранить как PDF и отправить по электронной почте](images/image-1741253450663.gif)
