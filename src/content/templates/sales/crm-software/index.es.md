...
sections:
    ...
    - name: "content-27"
      ...
      items:
        ...
        - icon: 'wand-magic-sparkles'
          ...
          text: "Con las automatizaciones asistidas por IA de SeaTable, puede crear procesos de negociación y análisis de ganancias/pérdidas, todo ello conforme al RGPD gracias a su propio servidor."
        - icon: 'chart-simple'
        ...
        - icon: 'lock'
          headline: 'Permisos'
          text: 'Gracias a los permisos ajustables individualmente, puede determinar quién puede ver o editar los procesos de negociación y la información específica de los clientes.' 
        - icon: 'pencil'
    ...
    - name: "content-9"
      ...
      - headline: 'Flujos de trabajo con indicaciones personalizadas'
        text: Con las indicaciones personalizadas, puede definir sus propias acciones, por ejemplo, generar alertas y recomendaciones basadas en el valor de la operación, el estado del proceso de ventas y el historial, lo que resulta perfecto para las previsiones de ventas.
        icon: wand-magic-sparkles
