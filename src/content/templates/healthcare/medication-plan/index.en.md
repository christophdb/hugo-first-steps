...
sections:
    ...
    - name: "content-9"
      ...
      description: 'With SeaTable, you benefit from powerful [AI features]({{< relref "pages/landing-pages/use-cases/ai-automations" >}}), that make your medication plan even safer and clearer. Analyze texts, evaluate documents, and reduce manual work—all in compliance with GDPR on German servers.'
      items:
