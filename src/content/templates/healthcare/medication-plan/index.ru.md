...
sections:
    ...
    - name: "content-9"
      ...
      description: 'С SeaTable вы получаете преимущества от мощных [функций искусственного интеллекта]({{< relref "posts/seatable-releases/seatable-release-6-0" >}}), которые сделают ваш план лечения еще более безопасным и понятным. Анализируйте тексты, оценивайте документы и сокращайте ручную работу – в соответствии с GDPR на немецких серверах.'
      items:
