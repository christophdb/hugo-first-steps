...
sections:
    ...
    - name: "content-9"
      ...
      description: 'Con SeaTable, tiene a su disposición [funciones de IA]({{< relref "pages/landing-pages/use-cases/ai-automations" >}}) que le ayudan en el análisis de su diario de alimentación. Analice textos, extraiga información de documentos y resuma hallazgos automáticamente.'
      items:
