...
![Таблица обзора автомобилей с данными о модели, номере, статусе и важных датах](images/image-1739373488166.png)
...
![Веб-форма бронирования автомобиля с контактами, выбором машины и указанием периода](images/vehicle-request.png)
...
![Представление таймлайна с забронированными машинами и цветными полосами занятых интервалов](images/Booked-vehicles.png)
