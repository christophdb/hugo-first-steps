...
![Приложение для сотрудников с веб-формами учёта рабочего времени, отпусков и больничных](images/Mitarbeiter-App.gif)
...
![HR‑дашборд в SeaTable со статистикой по переработкам, отпускам и больничным](images/Dashboard_4MB.gif)
