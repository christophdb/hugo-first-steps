...
sections:
    ...
    - name: "content-9"
      ...
      - headline: 'Reconhecimento de texto com OCR'
        text: 'Carregue capturas de ecrã ou imagens e utilize a função OCR para reconhecer automaticamente os textos nelas contidos. Desta forma, as informações relevantes, como mensagens de erro, IDs ou caminhos, ficam diretamente disponíveis no seu Bug Tracker para posterior análise.'
        icon: image
