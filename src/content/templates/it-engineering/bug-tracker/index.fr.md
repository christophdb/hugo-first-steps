...
sections:
    ...
    - name: "content-9"
      ...
      - headline: 'Reconnaissance de texte avec OCR'
        text: "Téléchargez des captures d'écran ou des images et utilisez la fonction OCR pour reconnaître automatiquement les textes qu'elles contiennent. Les informations pertinentes, telles que les messages d'erreur, les identifiants ou les chemins d'accès, sont ainsi directement disponibles dans votre outil de suivi des bogues pour une analyse plus approfondie."
        icon: image
